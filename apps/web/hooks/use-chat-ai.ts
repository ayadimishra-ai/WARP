import { useCreateAiChatUsageMutation } from "@warp/graphql/mutations/generated/create-aichat-usage";
import { useUpdateAiChatUsageMutation } from "@warp/graphql/mutations/generated/update-aichat-usage";
...
import { useGetConversationMessagesLazyQuery } from "@warp/graphql/queries/generated/get-conversation-messages";
import { useGetDocumentLogsQuery } from "@warp/graphql/queries/generated/get-document-logs";
import { useGetDocumentLogsPaginatedLazyQuery } from "@warp/graphql/queries/generated/get-document-logs-paginated";
import { useGetUserConversationsLazyQuery } from "@warp/graphql/queries/generated/get-user-conversations";
import { DATA_SOURCE_TYPES, DOCUMENT_FILTERS, QUERY_TYPES } from "@warp/shared/constants/ai.constants";
import {
  type ChatAIState,
  type ChatResponse,
  ...
  const notifyQuotaExceeded = useCallback(
    async (
      ...
      try {
        ...
        await fetch("/api/AI/ai-chat-subscription-notification", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },

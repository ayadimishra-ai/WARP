...
import { FormFieldInterfaces } from "@warp/client/features/form/constants";
import Spinner from "@warp/client/layouts/Spinner";
import { setSuggestionStoreValueFromPopup } from "@warp/client/services/platform-window-message.service";
import { useGetSourceDataByInvitationIdQuery } from "@warp/graphql/queries/generated/get-sourcedata-by-invitationId";
import { useGetSuggestionByInvitationAndFormFieldDetailsQuery } from "@warp/graphql/queries/generated/get-suggestion-by-invitationId-andformfieldid";
import {
  AICArouselData,

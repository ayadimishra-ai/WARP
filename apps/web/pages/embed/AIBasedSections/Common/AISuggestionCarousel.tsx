...
import { suggestionPopup } from "@warp/client/services/platform-window-message.service";
import {
  ...
  return (
    <Box ml="-4px">
      <Carousel
        id="carouselBlock"
        h="auto"
        slideSize={halfWidth ? "320px" : isTextArea ? "485px" : "270px"}
        breakpoints={[
          {
            maxWidth: 720,
            slideSize: "100%",
          ...
          {
            maxWidth: 1286,
            slideSize: halfWidth ? "270px" : isTextArea ? "380px" : isActivityDataCard ? "270px" : "202px",
          },
          {
            maxWidth: 1480,
            slideSize: halfWidth ? "270px" : isTextArea ? "410px" : isActivityDataCard ? "270px" : "202px",
          },
        ]}
        slideGap={11}
        align="start"
      ...
      >
        {cardData.map((item, index) => {
          ...
          if (isAdvancedInput && item?.HTMLSuggestion?.shortSummary) {
            ...
            newTitle = item.HTMLSuggestion.shortSummary;
          } else {
            newTitle = title;
          }
          return (

...
import DocumentRepoIcon from "@warp/client/icons/DocumentRepoIcon";
...
const DocumentRepositoryPopover: React.FC<DocumentRepositoryPopoverProps> = ({
  ...
  const documentSearchTimeoutRef = useRef<NodeJS.Timeout>();
  ...
  return (
    ...
    >
      ...
      <Popover.Dropdown p={10} pr={2} onMouseEnter={() => setIsScrollAreaHovered(true)} onMouseLeave={() => setIsScrollAreaHovered(false)}>
        <TextInput

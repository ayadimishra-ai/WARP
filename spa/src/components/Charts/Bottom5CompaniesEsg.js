...
class Bottom5CompaniesEsg extends Component {
  constructor(props) {
    super(props);
    this.state = {
      anchorEl: null,
  ...
  render() {
    ...
    // Assuming you want to display only the bottom 5 aggregated companies
    const bottom5AggregatedCompanies = aggregatedData.slice(0, 5);

    return (
      <div className='chart_table'>
        <ChatHeadingSubHeading title="Bottom 5 Companies ESG"></ChatHeadingSubHeading>
        <table>
          <thead>
            <tr>
              <th>Company</th>
...
export default Bottom5CompaniesEsg;

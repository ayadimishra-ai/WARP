...
class Bottom5CompaniesTheme extends Component {
  constructor(props) {
    super(props);
    this.state = {
      anchorEl: null,
  ...
  componentDidMount() {
    ...
    //   query: `query MyQuery {
    //   gettotalsectoresg(args: {parentcompanyid: "ce6c5fee-10ef-4cf7-af5b-1a6d6d83645b"}, order_by: {sector: asc}) {
    //     sector
    //     score
    //     section_name
    //     company_name
    ...
    //let sorted_data = orderBy(chartData, ['sector'], ['asc']);
    this.setState({ List: chartData }, () => {
      this.aggregateData();
    });
  }
  ...
  render() {
    ...
    return (
      <div className="chart_table">
        <ChatHeadingSubHeading title="Bottom 5 Companies(Themes)">
          <div>
            <span>Theme: </span>
            <Select
...
export default Bottom5CompaniesTheme;

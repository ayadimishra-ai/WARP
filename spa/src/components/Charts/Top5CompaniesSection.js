...
class Top5CompaniesSection extends Component {
  constructor(props) {
    super(props);
    this.state = {
      anchorEl: null,
  ...
  componentDidMount() {
    ...
    //   query: "query MyQuery{gettotalsectoresg(args:{parentcompanyid:\"ce6c5fee-10ef-4cf7-af5b-1a6d6d83645b\"},order_by:{sector:desc,score:desc}){company_name sector score}}",
    //   variables: {}
    // });
    ...
    //let sorted_data = orderBy(chartData, ['sector', 'score'], ['desc', 'desc']);
    this.setState({ List: chartData }, () => {
      this.aggregateData();
    });
  }
  ...
  render() {
    ...
    return (
      <div className="chart_table">
        <ChatHeadingSubHeading title="Top 5 Companies Section">
        <div>
            <span>ESG: </span>
            <Select
...
export default Top5CompaniesSection;

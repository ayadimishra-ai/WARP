...
let messageData = "";
class EnergyGridManualEntryActivityData extends Component {
  ...
  render() {
    return (
      <React.Fragment>
        <iframe
          title="Energy Grid Manual Activity Data"
          id="listIframe1"
          src={
            GetGHGEstimationUrl() +
...
export default withStyles()(EnergyGridManualEntryActivityData);

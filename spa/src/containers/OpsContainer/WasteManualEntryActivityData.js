...
class WasteManualEntryActivityData extends Component {
  ...
  render() {
    return (
      <React.Fragment>
        <iframe
          title="Waste Data Manual Activity Data"
          id="listIframe1"
          src={
            GetGHGEstimationUrl() +
            ...
            "/manual-entry-data/waste-data/"
          }
          style={{ width: "100%", height: this.state.iframeHeight, border: "none" }}
        />
      </React.Fragment>
    );
  }
}
export default withStyles()(WasteManualEntryActivityData);
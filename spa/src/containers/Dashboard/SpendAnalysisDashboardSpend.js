...
class SpendAnalysisDashboardSpend extends Component {
    getSpendsData() {
        let totalSpends = 0;
        let spendGrowth = 0;
        let spendArrow = null;
        ...
        switch (this.props.ActiveTimePeriod) {
            case "Yearly":
                ...
                if (this.props.RadioButtonFilterType === "Region") {
                    //for (let data of SpendAnalysisData) {
            ...
            case "Quarterly":
                ...
                if (this.props.RadioButtonFilterType === "Region") {
                    ...
                    if (FilteredSpendAnalysisData !== undefined) {
                        if (this.props.FilterType === "Region") {
                            if (this.props.ClickedParameterName === "All") {
                                totalSpends = FilteredSpendAnalysisData.filter(x => x.currentYearQuarter === this.props.SelectedTimeStamp)[0] !== undefined ? FilteredSpendAnalysisData.filter(x => x.currentYearQuarter === this.props.SelectedTimeStamp)[0].spendTotal : 0.0;
                                spendGrowth = FilteredSpendAnalysisData.length > 0 ? FilteredSpendAnalysisData.filter(x => x.currentYearQuarter === this.props.SelectedTimeStamp && x.spendTotalGrowth !== undefined)[0] === undefined ? 0 : FilteredSpendAnalysisData.filter(x => x.currentYearQuarter === this.props.SelectedTimeStamp && x.spendTotalGrowth !== undefined)[0].spendTotalGrowth : 0;
                            }
                            else {
            ...
            case "Monthly":
                ...
                if (this.props.RadioButtonFilterType === "Region") {
                    ...
                    if (FilteredSpendAnalysisData !== undefined) {
                        if (this.props.FilterType === "Region") {
                            if (this.props.ClickedParameterName === "All") {
                                totalSpends = FilteredSpendAnalysisData.filter(x => x.yearMonth === this.props.SelectedTimeStamp)[0] !== undefined ? FilteredSpendAnalysisData.filter(x => x.yearMonth === this.props.SelectedTimeStamp)[0].spendTotal : 0.0;
                                spendGrowth = FilteredSpendAnalysisData.length > 0 ? FilteredSpendAnalysisData.filter(x => x.yearMonth === this.props.SelectedTimeStamp && x.spendTotalGrowth !== undefined)[0] === undefined ? 0 : FilteredSpendAnalysisData.filter(x => x.yearMonth === this.props.SelectedTimeStamp && x.spendTotalGrowth !== undefined)[0].spendTotalGrowth : 0;
                            }
                            else {
                                FilteredSpendAnalysisData = FilteredSpendAnalysisData.filter(x => x.region !== undefined);
        ...
        totalSpends = totalSpends === undefined ? 0 : totalSpends.toFixed(this.props.DecimalPrecision)
...
export default SpendAnalysisDashboardSpend
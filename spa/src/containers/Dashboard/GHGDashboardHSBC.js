...
let params = "";
class GHGDashboardHSBC extends Component {
    constructor(props) {
        super(props)
        this.state = {
            dashboardUrls: [],
    ...
    componentDidMount = async () => {
        this.getPowerBIToken("HSBC GHG Dashboard v4", false);
        ...
        if (this.state.tokenExpiration !== undefined && this.state.tokenExpiration !== null && this.state.tokenExpiration !== "") {
            ...
            if (tokenExpiration !== undefined && tokenExpiration !== null) {
                ...
                this.interval = setInterval(() => {
                    ...
                    this.getPowerBIToken("HSBC GHG Dashboard v4", true);
            ...
            .then(response => {
                ...
                if (response.status === 200) {
                    if (response.data !== undefined) {
                        ...
                        let sectionUrls = ReportName === "HSBC GHG Dashboard v4" ? "" : JSON.parse(JSON.parse(JSON.stringify(sectionUrl)));
    ...
    render() {
        ...
        } else if (getUserPermision(permissions, PageKeys.ghgdashboardhsbc) === null) {
            return <Redirect to="/home" />;
        }

        return (
            <div className="HSBC_Dashboard">
                <PowerBiReportIframe
                    loader={this.state.loader}
                    embedConfig={this.state.reportConfig}
                    cssClassName="power-bi-ghg-v4-hsbc-report-class-new"
...
export default GHGDashboardHSBC;
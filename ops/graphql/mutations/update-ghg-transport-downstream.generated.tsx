...
export const UpdateGhgTransportDownstreamDocument = gql`
  ...
  update_GHGTransport_Downstream_many(updates: $GHGTransport_Downstream) {
    ...
    `;
export type UpdateGhgTransportDownstreamMutationFn = Apollo.MutationFunction<UpdateGhgTransportDownstreamMutation, UpdateGhgTransportDownstreamMutationVariables>;
 ...
 * });
 */
export function useUpdateGhgTransportDownstreamMutation(baseOptions?: Apollo.MutationHookOptions<UpdateGhgTransportDownstreamMutation, UpdateGhgTransportDownstreamMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateGhgTransportDownstreamMutation, UpdateGhgTransportDownstreamMutationVariables>(UpdateGhgTransportDownstreamDocument, options);
      }
export type UpdateGhgTransportDownstreamMutationHookResult = ReturnType<typeof useUpdateGhgTransportDownstreamMutation>;
export type UpdateGhgTransportDownstreamMutationResult = Apollo.MutationResult<UpdateGhgTransportDownstreamMutation>;
export type UpdateGhgTransportDownstreamMutationOptions = Apollo.BaseMutationOptions<UpdateGhgTransportDownstreamMutation, UpdateGhgTransportDownstreamMutationVariables>;
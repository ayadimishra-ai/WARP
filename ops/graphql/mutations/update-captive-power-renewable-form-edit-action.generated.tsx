...
export type UpdateCaptivePowerRenewableFormEditActionMutationVariables = Types.Exact<{
...
export const UpdateCaptivePowerRenewableFormEditActionDocument = gql`
  ...
  update_GHGEnergy_CaptivePower_Renewable(
    ...
    `;
export type UpdateCaptivePowerRenewableFormEditActionMutationFn = Apollo.MutationFunction<UpdateCaptivePowerRenewableFormEditActionMutation, UpdateCaptivePowerRenewableFormEditActionMutationVariables>;
 ...
 * });
 */
export function useUpdateCaptivePowerRenewableFormEditActionMutation(baseOptions?: Apollo.MutationHookOptions<UpdateCaptivePowerRenewableFormEditActionMutation, UpdateCaptivePowerRenewableFormEditActionMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateCaptivePowerRenewableFormEditActionMutation, UpdateCaptivePowerRenewableFormEditActionMutationVariables>(UpdateCaptivePowerRenewableFormEditActionDocument, options);
      }
export type UpdateCaptivePowerRenewableFormEditActionMutationHookResult = ReturnType<typeof useUpdateCaptivePowerRenewableFormEditActionMutation>;
export type UpdateCaptivePowerRenewableFormEditActionMutationResult = Apollo.MutationResult<UpdateCaptivePowerRenewableFormEditActionMutation>;
export type UpdateCaptivePowerRenewableFormEditActionMutationOptions = Apollo.BaseMutationOptions<UpdateCaptivePowerRenewableFormEditActionMutation, UpdateCaptivePowerRenewableFormEditActionMutationVariables>;
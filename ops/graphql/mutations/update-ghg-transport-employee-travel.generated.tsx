...
export const UpdateGhgTransportEmployeeTravelDocument = gql`
  ...
  update_GHGTransport_EmployeeTravel_many(updates: $GhgTransportEmployeeTravel) {
    ...
    `;
export type UpdateGhgTransportEmployeeTravelMutationFn = Apollo.MutationFunction<UpdateGhgTransportEmployeeTravelMutation, UpdateGhgTransportEmployeeTravelMutationVariables>;
 ...
 * });
 */
export function useUpdateGhgTransportEmployeeTravelMutation(baseOptions?: Apollo.MutationHookOptions<UpdateGhgTransportEmployeeTravelMutation, UpdateGhgTransportEmployeeTravelMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateGhgTransportEmployeeTravelMutation, UpdateGhgTransportEmployeeTravelMutationVariables>(UpdateGhgTransportEmployeeTravelDocument, options);
      }
export type UpdateGhgTransportEmployeeTravelMutationHookResult = ReturnType<typeof useUpdateGhgTransportEmployeeTravelMutation>;
export type UpdateGhgTransportEmployeeTravelMutationResult = Apollo.MutationResult<UpdateGhgTransportEmployeeTravelMutation>;
export type UpdateGhgTransportEmployeeTravelMutationOptions = Apollo.BaseMutationOptions<UpdateGhgTransportEmployeeTravelMutation, UpdateGhgTransportEmployeeTravelMutationVariables>;
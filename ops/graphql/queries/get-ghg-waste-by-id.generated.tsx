 ...
 * });
 */
export function useGetGhgWasteByIdQuery(baseOptions: Apollo.QueryHookOptions<GetGhgWasteByIdQuery, GetGhgWasteByIdQueryVariables> & ({ variables: GetGhgWasteByIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetGhgWasteByIdQuery, GetGhgWasteByIdQueryVariables>(GetGhgWasteByIdDocument, options);
      }
export function useGetGhgWasteByIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetGhgWasteByIdQuery, GetGhgWasteByIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetGhgWasteByIdQuery, GetGhgWasteByIdQueryVariables>(GetGhgWasteByIdDocument, options);
        }
export function useGetGhgWasteByIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetGhgWasteByIdQuery, GetGhgWasteByIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetGhgWasteByIdQuery, GetGhgWasteByIdQueryVariables>(GetGhgWasteByIdDocument, options);
        }
export type GetGhgWasteByIdQueryHookResult = ReturnType<typeof useGetGhgWasteByIdQuery>;
export type GetGhgWasteByIdLazyQueryHookResult = ReturnType<typeof useGetGhgWasteByIdLazyQuery>;
export type GetGhgWasteByIdSuspenseQueryHookResult = ReturnType<typeof useGetGhgWasteByIdSuspenseQuery>;
export type GetGhgWasteByIdQueryResult = Apollo.QueryResult<GetGhgWasteByIdQuery, GetGhgWasteByIdQueryVariables>;
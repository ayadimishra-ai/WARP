...
export type GetSupplierListQuery = { __typename?: 'query_root', OrgSupplierMaster: Array<{ __typename?: 'OrgSupplierMaster', id: any, client_master_id?: string | null, name: string, code?: string | null, category?: string | null }> };
 ...
 * });
 */
export function useGetSupplierListQuery(baseOptions: Apollo.QueryHookOptions<GetSupplierListQuery, GetSupplierListQueryVariables> & ({ variables: GetSupplierListQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
export function useGetSupplierListSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetSupplierListQuery, GetSupplierListQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetSupplierListQuery, GetSupplierListQueryVariables>(GetSupplierListDocument, options);
        }
...
export type GetSupplierListSuspenseQueryHookResult = ReturnType<typeof useGetSupplierListSuspenseQuery>;

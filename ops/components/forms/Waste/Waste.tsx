...
const schema = z.object({
  ...
  WaterRecycledReclaimed: z
    .string()
    .min(1, { message: "Select Water Recycled/Reclaimed" }),
...
const Water = () => {
  ...
  const onSubmitForm: SubmitHandler<FormSchemaType> = (data: any) => {
    // console.log("wasteForm", data);
  };
  return (
    <>
      <form onSubmit={handleSubmit(onSubmitForm)}>
        <Stack gap="md" px="md">
          <FormHeader header="Waste Details" text="" />
          <Grid>
              ...
              <Controller
                ...
                render={({ field }) => (
                  <SelectDropdown
                    ...
                    placeholder="Select Water Recycled/Reclaimed"
                    error={
              ...
              <Controller
                ...
                render={({ field }) => (
                  <TextInputField
                    ...
                    placeholder="Enter UoM Recycled"
              ...
              <Controller
                ...
                render={({ field }) => (
                  <SelectDropdown
                    ...
                    options={["STP", "Fresh water", "Harvested water", "NA"]}
                    value={field.value}
                    onChange={field.onChange}
                    register={register("SourceofWaterforIrrigation")}
                    placeholder="Select Source of Water for Irrigation"
                  />
                )}
              />
            </GridCol>

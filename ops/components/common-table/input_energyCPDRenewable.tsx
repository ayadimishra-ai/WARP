...
const data: ListOfCompaniesThatProvideGridPower[] = [
  {
    type_of_technology_used: "Solar",
    year_of_installation: 1999,
    unit_of_energy_generated: 1000000,
  },
  {
    type_of_technology_used: "Solar",
    year_of_installation: 1999,
...
const Input_EnergyCaptivePowerDetailsRenewable = () => {
...
export default Input_EnergyCaptivePowerDetailsRenewable;

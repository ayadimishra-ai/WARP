...
import { EmissioncalculationEnergyGrid } from "~/app/actions/emissioncalculation";
import { useDeleteMeterDataMutation } from "~/graphql/mutations/delete-meter-data.generated";
import { useInsertActivityTaskRequestMutation } from "~/graphql/mutations/insert-activity-task-request.generated";
import { useInsertMeterDataMutation } from "~/graphql/mutations/insert-ai-meterdata.generated";
import { useInsertMeterOrganizationAddressMappingDataMutation } from "~/graphql/mutations/insert-ai-meterorganizationaddressmapping.generated";
import { useInsertTaskRequestMutation } from "~/graphql/mutations/Insert-task-request.generated";
import { useAiFileActivityInsertTaskRequestMutation } from "~/graphql/mutations/insert_aIfile-activitytaskrequest.generated";
import { useUpdateAiFileDataMutation } from "~/graphql/mutations/update-ai-data.generated";
import { useUpdateAiFileUploadsMutation } from "~/graphql/mutations/update-ai-uploads-status.generated";
import { useUpdateMeterDataMutation } from "~/graphql/mutations/update-meterdata-by-filedataId.generated";
import { useUpsertGhgEnergy_GridPowerActivityMutation } from "~/graphql/mutations/upsert-energy-grid-power-data.generated";
import { useGetactivityTaskRequestDataQuery } from "~/graphql/queries/get-activity-task-request-data.generated";
import { useGetActivitybycodeQuery } from "~/graphql/queries/get-activitybycode.generated";
import { useGetAddressDetailQuery } from "~/graphql/queries/get-address-detail.generated";
import { useGetAiFiledatabydateQuery } from "~/graphql/queries/get-ai-filedata-by-date.generated";
import { useGetGhgEnergyGridPowerDataQuery } from "~/graphql/queries/get-ghg-energy-grid-power-data.generated";
import { useGetMeterDataByFileIdQuery } from "~/graphql/queries/get-meter-data.generated";
import { useGetMeterOrganizationAddressMappingQuery } from "~/graphql/queries/get-meterorganizationaddressmapping.generated";
import { useGetPowerConsumptionDetailsForAiQuery } from "~/graphql/queries/get-power-consumption-details-for-ai.generated";
import { useGettaskRequestQuery } from "~/graphql/queries/get-task-request.generated";
import {
...
import { AIFileUploadStatus, isUUID } from "~/shared/constants/ai-constant";
import { addressTypeAllowedActivity } from "~/shared/constants/input.constant";
import { AllMeterDetails } from "~/shared/types/ai-types";
import {

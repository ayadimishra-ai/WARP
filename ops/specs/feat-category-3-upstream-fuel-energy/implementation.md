...
import { GhgEnergyConsumption_FuelPurchased_General_Updates } from "~/graphql/shared/types";
import { emissionFactorUnits } from "~/shared/constants/input.constant";
...
Ensure `SQL_QUERY_GET_Category3_details` is imported from `~/shared/Queries/dashboardqueries`:

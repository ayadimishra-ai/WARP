...
import { carryForwardAssessmentData } from "@/modules/warp/packages/server/services/carry-forward-assessment-data/carry-forward.service";
...
async function handler(req: NextApiRequest, res: NextApiResponse) {
  try {
    ...
    const body = req.body;
    if (req.method === "POST") {
      const responseData = await carryForwardAssessmentData(body);

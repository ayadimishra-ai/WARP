...
import { reviewerReportingFormInvitationEmail } from "@/modules/warp/packages/server/services/notification.service";
import { NextApiHandler } from "next";

const handler: NextApiHandler = async (req, res) => {
    try {
        const response: any = await reviewerReportingFormInvitationEmail(
            req.body.id,
            req.body.type,
            req.body.companyId,
            req.body.formId,

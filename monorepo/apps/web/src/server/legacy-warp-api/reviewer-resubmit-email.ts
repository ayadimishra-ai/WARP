...
import { reviewerResubmitResponseEmail } from "@/modules/warp/packages/server/services/notification.service";
import { NextApiHandler } from "next";

const handler: NextApiHandler = async (req, res) => {
    try {
        const response: any = await reviewerResubmitResponseEmail(
            req.body.id,
            req.body.type,
            req.body.companyId,
            req.body.formId,

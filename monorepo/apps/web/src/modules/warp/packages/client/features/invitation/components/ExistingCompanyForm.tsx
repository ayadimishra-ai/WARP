...
import { useInsertIntoSubmissionTableMutation } from "@/modules/warp/packages/graphql/mutations/generated/insert-into-submission-table";
...
import { useGetCompanyByParentCompanyIdAndPlatformIdQuery } from "@/modules/warp/packages/graphql/queries/generated/get-company-by-parent-company-id-and-platform-id";
...
} from "@/modules/warp/packages/graphql/queries/generated/get-companydetail-by-id";
...
import { useGetLastInvitationAnswerDetailsLazyQuery } from "@/modules/warp/packages/graphql/queries/generated/get-last-invitation-answer-details";
        ...
        if (isError === false) {
          ...
          if (
            ...
            if (
              ...
              await fetch("/warp/api/carry-forward-assessment-data", {
                method: "POST",

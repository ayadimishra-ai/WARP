...
const SelectedMultipleDropdown: FormFieldControl<
...
SelectedMultipleDropdown.displayName = "SelectedMultipleDropdown";

const SimpleSelectedMultipleDropdown: FormFieldControl<
...
SimpleSelectedMultipleDropdown.displayName = "SimpleSelectedMultipleDropdown";

const SelectedMultipleDropdownWrapper: FormFieldControl = (props) =>
  props.isSimple ? (
    <SimpleSelectedMultipleDropdown {...(props as any)} />
  ) : (
    <SelectedMultipleDropdown {...(props as any)} />
  );

SelectedMultipleDropdownWrapper.displayName = "SelectedMultipleDropdownWrapper";

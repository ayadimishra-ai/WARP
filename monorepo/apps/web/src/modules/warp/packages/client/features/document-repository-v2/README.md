...
```typescript
// pages/documents.tsx
export { default, getServerSideProps } from '@/modules/warp/packages/client/features/document-repository-v2';
```
...
import { 
  ...
  DocumentCard,
  isDocumentExpired 
} from '@/modules/warp/packages/client/features/document-repository-v2';
```

...
const CreateNewUserFields = () => {
  ...
  const renderMessage = () => {
    ...
    if (existingEmailName) {
      return `${existingEmailName} already exists.`;
    }
    if (existingReviewerName) {
      return `Reviewer ${existingReviewerName} already exists.`;
    }
    if (duplicateEmail) {
      return `${duplicateEmail} is used multiple times.`;
    }
    return null;
  };
          ...
          return (
            <Stack gap={0} key={item.id}>
                ...
                <Flex align="center">
                  ...
                  {index > 0 && (
                    <Group mb={0} justify="flex-end" style={{ gap: 0 }}>
                      ...
                      <ActionIcon color="#B72F31" className="ActionIconStyles" variant="transparent">
                        <IconMinus
              ...
              {/* {dynamicCompanyForm.length > 1 && (
                <Group mb={10} justify="flex-end" gap="sm">

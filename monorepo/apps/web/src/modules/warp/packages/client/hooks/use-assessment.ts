...
import { useGetAssessmentListLazyQuery } from "@/modules/warp/packages/graphql/queries/generated/get-assessment-list.query";
import { useGetAssessmentListingDetailsQuery } from "@/modules/warp/packages/graphql/queries/generated/get-assessment-listing-details";
import { useGetAssessorConsultantMappingByConsultantCompanyIdQuery } from "@/modules/warp/packages/graphql/queries/generated/get-assessor-consultant-mapping-by-consultant-company-id";
import { useGetConsultantAssessmentListLazyQuery } from "@/modules/warp/packages/graphql/queries/generated/get-consultant-assessment-list";
import { useGetConsultantFormWithDetailsQuery } from "@/modules/warp/packages/graphql/queries/generated/get-consultant-form-with-details";
...
import { useGetGlobalMasterByTypeLazyQuery } from "@/modules/warp/packages/graphql/queries/generated/get-global-master-by-type";
import {
  AIProcessingTypes,
  AppRoles,
  AtherCompanyid,
...
export function useAssessment(companyId?: string, userRole?: string) {
  ...
  const statesFilter: StatesFilterType = React.useMemo(
    () => ({
      ...
      hasOPSToIQCuration: () => {
        return data.some((r) =>
          r.metadata?.AIData?.allowedAICuration?.includes(
            AIProcessingTypes.OPSToIQCuration
          )
        );
      },
      getRowsCountByStatus: (

...
// @ts-ignore
export function useGetCompanyDetailByNameSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetCompanyDetailByNameQuery, Types.GetCompanyDetailByNameQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetCompanyDetailByNameQuery, Types.GetCompanyDetailByNameQueryVariables>;
export function useGetCompanyDetailByNameSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetCompanyDetailByNameQuery, Types.GetCompanyDetailByNameQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetCompanyDetailByNameQuery | undefined, Types.GetCompanyDetailByNameQueryVariables>;
export function useGetCompanyDetailByNameSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetCompanyDetailByNameQuery, Types.GetCompanyDetailByNameQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetCompanyDetailByNameQuery, Types.GetCompanyDetailByNameQueryVariables>(GetCompanyDetailByNameDocument, options);
        }
...
export type GetCompanyDetailByNameSuspenseQueryHookResult = ReturnType<typeof useGetCompanyDetailByNameSuspenseQuery>;

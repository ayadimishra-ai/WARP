 ...
 * });
 */
export function useGetDeclinedQuestionsCountQuery(baseOptions: Apollo.QueryHookOptions<Types.GetDeclinedQuestionsCountQuery, Types.GetDeclinedQuestionsCountQueryVariables> & ({ variables: Types.GetDeclinedQuestionsCountQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetDeclinedQuestionsCountSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetDeclinedQuestionsCountQuery, Types.GetDeclinedQuestionsCountQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetDeclinedQuestionsCountQuery, Types.GetDeclinedQuestionsCountQueryVariables>;
export function useGetDeclinedQuestionsCountSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetDeclinedQuestionsCountQuery, Types.GetDeclinedQuestionsCountQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetDeclinedQuestionsCountQuery | undefined, Types.GetDeclinedQuestionsCountQueryVariables>;
export function useGetDeclinedQuestionsCountSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetDeclinedQuestionsCountQuery, Types.GetDeclinedQuestionsCountQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetDeclinedQuestionsCountQuery, Types.GetDeclinedQuestionsCountQueryVariables>(GetDeclinedQuestionsCountDocument, options);
        }
...
export type GetDeclinedQuestionsCountSuspenseQueryHookResult = ReturnType<typeof useGetDeclinedQuestionsCountSuspenseQuery>;

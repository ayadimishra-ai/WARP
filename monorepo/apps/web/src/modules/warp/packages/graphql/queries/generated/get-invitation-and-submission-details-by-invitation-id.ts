 ...
 * });
 */
export function useGetInvitationAndSubmissionDetailsByInvitationIdQuery(baseOptions: Apollo.QueryHookOptions<Types.GetInvitationAndSubmissionDetailsByInvitationIdQuery, Types.GetInvitationAndSubmissionDetailsByInvitationIdQueryVariables> & ({ variables: Types.GetInvitationAndSubmissionDetailsByInvitationIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetInvitationAndSubmissionDetailsByInvitationIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetInvitationAndSubmissionDetailsByInvitationIdQuery, Types.GetInvitationAndSubmissionDetailsByInvitationIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetInvitationAndSubmissionDetailsByInvitationIdQuery, Types.GetInvitationAndSubmissionDetailsByInvitationIdQueryVariables>;
export function useGetInvitationAndSubmissionDetailsByInvitationIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetInvitationAndSubmissionDetailsByInvitationIdQuery, Types.GetInvitationAndSubmissionDetailsByInvitationIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetInvitationAndSubmissionDetailsByInvitationIdQuery | undefined, Types.GetInvitationAndSubmissionDetailsByInvitationIdQueryVariables>;
export function useGetInvitationAndSubmissionDetailsByInvitationIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetInvitationAndSubmissionDetailsByInvitationIdQuery, Types.GetInvitationAndSubmissionDetailsByInvitationIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetInvitationAndSubmissionDetailsByInvitationIdQuery, Types.GetInvitationAndSubmissionDetailsByInvitationIdQueryVariables>(GetInvitationAndSubmissionDetailsByInvitationIdDocument, options);
        }
...
export type GetInvitationAndSubmissionDetailsByInvitationIdSuspenseQueryHookResult = ReturnType<typeof useGetInvitationAndSubmissionDetailsByInvitationIdSuspenseQuery>;

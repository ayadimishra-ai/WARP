...
// @ts-ignore
export function useGetDocumentLogsWithAiSuggestedDocumentsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetDocumentLogsWithAiSuggestedDocumentsQuery, Types.GetDocumentLogsWithAiSuggestedDocumentsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetDocumentLogsWithAiSuggestedDocumentsQuery, Types.GetDocumentLogsWithAiSuggestedDocumentsQueryVariables>;
export function useGetDocumentLogsWithAiSuggestedDocumentsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetDocumentLogsWithAiSuggestedDocumentsQuery, Types.GetDocumentLogsWithAiSuggestedDocumentsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetDocumentLogsWithAiSuggestedDocumentsQuery | undefined, Types.GetDocumentLogsWithAiSuggestedDocumentsQueryVariables>;
export function useGetDocumentLogsWithAiSuggestedDocumentsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetDocumentLogsWithAiSuggestedDocumentsQuery, Types.GetDocumentLogsWithAiSuggestedDocumentsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetDocumentLogsWithAiSuggestedDocumentsQuery, Types.GetDocumentLogsWithAiSuggestedDocumentsQueryVariables>(GetDocumentLogsWithAiSuggestedDocumentsDocument, options);
        }
...
export type GetDocumentLogsWithAiSuggestedDocumentsSuspenseQueryHookResult = ReturnType<typeof useGetDocumentLogsWithAiSuggestedDocumentsSuspenseQuery>;

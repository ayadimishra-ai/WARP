 ...
 * });
 */
export function useGetDocumentLogsPaginatedQuery(baseOptions: Apollo.QueryHookOptions<Types.GetDocumentLogsPaginatedQuery, Types.GetDocumentLogsPaginatedQueryVariables> & ({ variables: Types.GetDocumentLogsPaginatedQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetDocumentLogsPaginatedSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetDocumentLogsPaginatedQuery, Types.GetDocumentLogsPaginatedQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetDocumentLogsPaginatedQuery, Types.GetDocumentLogsPaginatedQueryVariables>;
export function useGetDocumentLogsPaginatedSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetDocumentLogsPaginatedQuery, Types.GetDocumentLogsPaginatedQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetDocumentLogsPaginatedQuery | undefined, Types.GetDocumentLogsPaginatedQueryVariables>;
export function useGetDocumentLogsPaginatedSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetDocumentLogsPaginatedQuery, Types.GetDocumentLogsPaginatedQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetDocumentLogsPaginatedQuery, Types.GetDocumentLogsPaginatedQueryVariables>(GetDocumentLogsPaginatedDocument, options);
        }
...
export type GetDocumentLogsPaginatedSuspenseQueryHookResult = ReturnType<typeof useGetDocumentLogsPaginatedSuspenseQuery>;

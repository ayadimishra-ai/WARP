 ...
 * });
 */
export function useGetLastSubmittedInvitationQuery(baseOptions: Apollo.QueryHookOptions<Types.GetLastSubmittedInvitationQuery, Types.GetLastSubmittedInvitationQueryVariables> & ({ variables: Types.GetLastSubmittedInvitationQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetLastSubmittedInvitationSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetLastSubmittedInvitationQuery, Types.GetLastSubmittedInvitationQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetLastSubmittedInvitationQuery, Types.GetLastSubmittedInvitationQueryVariables>;
export function useGetLastSubmittedInvitationSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetLastSubmittedInvitationQuery, Types.GetLastSubmittedInvitationQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetLastSubmittedInvitationQuery | undefined, Types.GetLastSubmittedInvitationQueryVariables>;
export function useGetLastSubmittedInvitationSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetLastSubmittedInvitationQuery, Types.GetLastSubmittedInvitationQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetLastSubmittedInvitationQuery, Types.GetLastSubmittedInvitationQueryVariables>(GetLastSubmittedInvitationDocument, options);
        }
...
export type GetLastSubmittedInvitationSuspenseQueryHookResult = ReturnType<typeof useGetLastSubmittedInvitationSuspenseQuery>;

 ...
 * });
 */
export function useGetInvitationDetailsQuery(baseOptions: Apollo.QueryHookOptions<Types.GetInvitationDetailsQuery, Types.GetInvitationDetailsQueryVariables> & ({ variables: Types.GetInvitationDetailsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetInvitationDetailsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetInvitationDetailsQuery, Types.GetInvitationDetailsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetInvitationDetailsQuery, Types.GetInvitationDetailsQueryVariables>;
export function useGetInvitationDetailsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetInvitationDetailsQuery, Types.GetInvitationDetailsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetInvitationDetailsQuery | undefined, Types.GetInvitationDetailsQueryVariables>;
export function useGetInvitationDetailsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetInvitationDetailsQuery, Types.GetInvitationDetailsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetInvitationDetailsQuery, Types.GetInvitationDetailsQueryVariables>(GetInvitationDetailsDocument, options);
        }
...
export type GetInvitationDetailsSuspenseQueryHookResult = ReturnType<typeof useGetInvitationDetailsSuspenseQuery>;

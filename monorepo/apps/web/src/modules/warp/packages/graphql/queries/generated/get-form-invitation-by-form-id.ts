 ...
 * });
 */
export function useGetFormInvitationByFormIdQuery(baseOptions: Apollo.QueryHookOptions<Types.GetFormInvitationByFormIdQuery, Types.GetFormInvitationByFormIdQueryVariables> & ({ variables: Types.GetFormInvitationByFormIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetFormInvitationByFormIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetFormInvitationByFormIdQuery, Types.GetFormInvitationByFormIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetFormInvitationByFormIdQuery, Types.GetFormInvitationByFormIdQueryVariables>;
export function useGetFormInvitationByFormIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetFormInvitationByFormIdQuery, Types.GetFormInvitationByFormIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetFormInvitationByFormIdQuery | undefined, Types.GetFormInvitationByFormIdQueryVariables>;
export function useGetFormInvitationByFormIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetFormInvitationByFormIdQuery, Types.GetFormInvitationByFormIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetFormInvitationByFormIdQuery, Types.GetFormInvitationByFormIdQueryVariables>(GetFormInvitationByFormIdDocument, options);
        }
...
export type GetFormInvitationByFormIdSuspenseQueryHookResult = ReturnType<typeof useGetFormInvitationByFormIdSuspenseQuery>;

...
// @ts-ignore
export function useGetSuggestionsDataByInvitationIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetSuggestionsDataByInvitationIdQuery, Types.GetSuggestionsDataByInvitationIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetSuggestionsDataByInvitationIdQuery, Types.GetSuggestionsDataByInvitationIdQueryVariables>;
export function useGetSuggestionsDataByInvitationIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetSuggestionsDataByInvitationIdQuery, Types.GetSuggestionsDataByInvitationIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetSuggestionsDataByInvitationIdQuery | undefined, Types.GetSuggestionsDataByInvitationIdQueryVariables>;
export function useGetSuggestionsDataByInvitationIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetSuggestionsDataByInvitationIdQuery, Types.GetSuggestionsDataByInvitationIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetSuggestionsDataByInvitationIdQuery, Types.GetSuggestionsDataByInvitationIdQueryVariables>(GetSuggestionsDataByInvitationIdDocument, options);
        }
...
export type GetSuggestionsDataByInvitationIdSuspenseQueryHookResult = ReturnType<typeof useGetSuggestionsDataByInvitationIdSuspenseQuery>;

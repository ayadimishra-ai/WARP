...
// @ts-ignore
export function useGetinvitationcommentSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetinvitationcommentQuery, Types.GetinvitationcommentQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetinvitationcommentQuery, Types.GetinvitationcommentQueryVariables>;
export function useGetinvitationcommentSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetinvitationcommentQuery, Types.GetinvitationcommentQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetinvitationcommentQuery | undefined, Types.GetinvitationcommentQueryVariables>;
export function useGetinvitationcommentSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetinvitationcommentQuery, Types.GetinvitationcommentQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetinvitationcommentQuery, Types.GetinvitationcommentQueryVariables>(GetinvitationcommentDocument, options);
        }
...
export type GetinvitationcommentSuspenseQueryHookResult = ReturnType<typeof useGetinvitationcommentSuspenseQuery>;

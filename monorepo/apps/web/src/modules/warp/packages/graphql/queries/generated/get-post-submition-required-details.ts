 ...
 * });
 */
export function useGetPostSubmissionRequiredDetailsQuery(baseOptions: Apollo.QueryHookOptions<Types.GetPostSubmissionRequiredDetailsQuery, Types.GetPostSubmissionRequiredDetailsQueryVariables> & ({ variables: Types.GetPostSubmissionRequiredDetailsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetPostSubmissionRequiredDetailsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetPostSubmissionRequiredDetailsQuery, Types.GetPostSubmissionRequiredDetailsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetPostSubmissionRequiredDetailsQuery, Types.GetPostSubmissionRequiredDetailsQueryVariables>;
export function useGetPostSubmissionRequiredDetailsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetPostSubmissionRequiredDetailsQuery, Types.GetPostSubmissionRequiredDetailsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetPostSubmissionRequiredDetailsQuery | undefined, Types.GetPostSubmissionRequiredDetailsQueryVariables>;
export function useGetPostSubmissionRequiredDetailsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetPostSubmissionRequiredDetailsQuery, Types.GetPostSubmissionRequiredDetailsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetPostSubmissionRequiredDetailsQuery, Types.GetPostSubmissionRequiredDetailsQueryVariables>(GetPostSubmissionRequiredDetailsDocument, options);
        }
...
export type GetPostSubmissionRequiredDetailsSuspenseQueryHookResult = ReturnType<typeof useGetPostSubmissionRequiredDetailsSuspenseQuery>;

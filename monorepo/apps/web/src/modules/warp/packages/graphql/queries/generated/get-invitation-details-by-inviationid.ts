...
// @ts-ignore
export function useGetInvitationDetailsByInviationIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetInvitationDetailsByInviationIdQuery, Types.GetInvitationDetailsByInviationIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetInvitationDetailsByInviationIdQuery, Types.GetInvitationDetailsByInviationIdQueryVariables>;
export function useGetInvitationDetailsByInviationIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetInvitationDetailsByInviationIdQuery, Types.GetInvitationDetailsByInviationIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetInvitationDetailsByInviationIdQuery | undefined, Types.GetInvitationDetailsByInviationIdQueryVariables>;
export function useGetInvitationDetailsByInviationIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetInvitationDetailsByInviationIdQuery, Types.GetInvitationDetailsByInviationIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetInvitationDetailsByInviationIdQuery, Types.GetInvitationDetailsByInviationIdQueryVariables>(GetInvitationDetailsByInviationIdDocument, options);
        }
...
export type GetInvitationDetailsByInviationIdSuspenseQueryHookResult = ReturnType<typeof useGetInvitationDetailsByInviationIdSuspenseQuery>;

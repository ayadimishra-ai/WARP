...
// @ts-ignore
export function useGetInvitationDetailsByIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetInvitationDetailsByIdQuery, Types.GetInvitationDetailsByIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetInvitationDetailsByIdQuery, Types.GetInvitationDetailsByIdQueryVariables>;
export function useGetInvitationDetailsByIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetInvitationDetailsByIdQuery, Types.GetInvitationDetailsByIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetInvitationDetailsByIdQuery | undefined, Types.GetInvitationDetailsByIdQueryVariables>;
export function useGetInvitationDetailsByIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetInvitationDetailsByIdQuery, Types.GetInvitationDetailsByIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetInvitationDetailsByIdQuery, Types.GetInvitationDetailsByIdQueryVariables>(GetInvitationDetailsByIdDocument, options);
        }
...
export type GetInvitationDetailsByIdSuspenseQueryHookResult = ReturnType<typeof useGetInvitationDetailsByIdSuspenseQuery>;

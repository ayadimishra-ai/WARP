...
// @ts-ignore
export function useGetFormFieldsByQuestionIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetFormFieldsByQuestionIdQuery, Types.GetFormFieldsByQuestionIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetFormFieldsByQuestionIdQuery, Types.GetFormFieldsByQuestionIdQueryVariables>;
export function useGetFormFieldsByQuestionIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetFormFieldsByQuestionIdQuery, Types.GetFormFieldsByQuestionIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetFormFieldsByQuestionIdQuery | undefined, Types.GetFormFieldsByQuestionIdQueryVariables>;
export function useGetFormFieldsByQuestionIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetFormFieldsByQuestionIdQuery, Types.GetFormFieldsByQuestionIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetFormFieldsByQuestionIdQuery, Types.GetFormFieldsByQuestionIdQueryVariables>(GetFormFieldsByQuestionIdDocument, options);
        }
...
export type GetFormFieldsByQuestionIdSuspenseQueryHookResult = ReturnType<typeof useGetFormFieldsByQuestionIdSuspenseQuery>;

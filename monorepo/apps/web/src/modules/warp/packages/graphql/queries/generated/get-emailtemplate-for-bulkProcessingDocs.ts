 ...
 * });
 */
export function useGetEmailtemplateForBulkProcessingDocsQuery(baseOptions: Apollo.QueryHookOptions<Types.GetEmailtemplateForBulkProcessingDocsQuery, Types.GetEmailtemplateForBulkProcessingDocsQueryVariables> & ({ variables: Types.GetEmailtemplateForBulkProcessingDocsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetEmailtemplateForBulkProcessingDocsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetEmailtemplateForBulkProcessingDocsQuery, Types.GetEmailtemplateForBulkProcessingDocsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetEmailtemplateForBulkProcessingDocsQuery, Types.GetEmailtemplateForBulkProcessingDocsQueryVariables>;
export function useGetEmailtemplateForBulkProcessingDocsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetEmailtemplateForBulkProcessingDocsQuery, Types.GetEmailtemplateForBulkProcessingDocsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetEmailtemplateForBulkProcessingDocsQuery | undefined, Types.GetEmailtemplateForBulkProcessingDocsQueryVariables>;
export function useGetEmailtemplateForBulkProcessingDocsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetEmailtemplateForBulkProcessingDocsQuery, Types.GetEmailtemplateForBulkProcessingDocsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetEmailtemplateForBulkProcessingDocsQuery, Types.GetEmailtemplateForBulkProcessingDocsQueryVariables>(GetEmailtemplateForBulkProcessingDocsDocument, options);
        }
...
export type GetEmailtemplateForBulkProcessingDocsSuspenseQueryHookResult = ReturnType<typeof useGetEmailtemplateForBulkProcessingDocsSuspenseQuery>;

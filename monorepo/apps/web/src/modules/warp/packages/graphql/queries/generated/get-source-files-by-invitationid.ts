...
// @ts-ignore
export function useGetSourceFilesByInvitationIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetSourceFilesByInvitationIdQuery, Types.GetSourceFilesByInvitationIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetSourceFilesByInvitationIdQuery, Types.GetSourceFilesByInvitationIdQueryVariables>;
export function useGetSourceFilesByInvitationIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetSourceFilesByInvitationIdQuery, Types.GetSourceFilesByInvitationIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetSourceFilesByInvitationIdQuery | undefined, Types.GetSourceFilesByInvitationIdQueryVariables>;
export function useGetSourceFilesByInvitationIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetSourceFilesByInvitationIdQuery, Types.GetSourceFilesByInvitationIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetSourceFilesByInvitationIdQuery, Types.GetSourceFilesByInvitationIdQueryVariables>(GetSourceFilesByInvitationIdDocument, options);
        }
...
export type GetSourceFilesByInvitationIdSuspenseQueryHookResult = ReturnType<typeof useGetSourceFilesByInvitationIdSuspenseQuery>;

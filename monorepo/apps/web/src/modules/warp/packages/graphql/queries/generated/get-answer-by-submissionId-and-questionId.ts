...
// @ts-ignore
export function useGetAnswerBySubmissionIdAndquestionIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetAnswerBySubmissionIdAndquestionIdQuery, Types.GetAnswerBySubmissionIdAndquestionIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetAnswerBySubmissionIdAndquestionIdQuery, Types.GetAnswerBySubmissionIdAndquestionIdQueryVariables>;
export function useGetAnswerBySubmissionIdAndquestionIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetAnswerBySubmissionIdAndquestionIdQuery, Types.GetAnswerBySubmissionIdAndquestionIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetAnswerBySubmissionIdAndquestionIdQuery | undefined, Types.GetAnswerBySubmissionIdAndquestionIdQueryVariables>;
export function useGetAnswerBySubmissionIdAndquestionIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetAnswerBySubmissionIdAndquestionIdQuery, Types.GetAnswerBySubmissionIdAndquestionIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetAnswerBySubmissionIdAndquestionIdQuery, Types.GetAnswerBySubmissionIdAndquestionIdQueryVariables>(GetAnswerBySubmissionIdAndquestionIdDocument, options);
        }
...
export type GetAnswerBySubmissionIdAndquestionIdSuspenseQueryHookResult = ReturnType<typeof useGetAnswerBySubmissionIdAndquestionIdSuspenseQuery>;

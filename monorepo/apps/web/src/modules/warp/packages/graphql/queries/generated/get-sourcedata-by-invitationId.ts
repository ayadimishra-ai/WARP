 ...
 * });
 */
export function useGetSourceDataByInvitationIdQuery(baseOptions: Apollo.QueryHookOptions<Types.GetSourceDataByInvitationIdQuery, Types.GetSourceDataByInvitationIdQueryVariables> & ({ variables: Types.GetSourceDataByInvitationIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetSourceDataByInvitationIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetSourceDataByInvitationIdQuery, Types.GetSourceDataByInvitationIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetSourceDataByInvitationIdQuery, Types.GetSourceDataByInvitationIdQueryVariables>;
export function useGetSourceDataByInvitationIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetSourceDataByInvitationIdQuery, Types.GetSourceDataByInvitationIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetSourceDataByInvitationIdQuery | undefined, Types.GetSourceDataByInvitationIdQueryVariables>;
export function useGetSourceDataByInvitationIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetSourceDataByInvitationIdQuery, Types.GetSourceDataByInvitationIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetSourceDataByInvitationIdQuery, Types.GetSourceDataByInvitationIdQueryVariables>(GetSourceDataByInvitationIdDocument, options);
        }
...
export type GetSourceDataByInvitationIdSuspenseQueryHookResult = ReturnType<typeof useGetSourceDataByInvitationIdSuspenseQuery>;

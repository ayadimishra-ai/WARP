...
// @ts-ignore
export function useGetGlobalMasterByInternalRequestCompanySuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetGlobalMasterByInternalRequestCompanyQuery, Types.GetGlobalMasterByInternalRequestCompanyQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetGlobalMasterByInternalRequestCompanyQuery, Types.GetGlobalMasterByInternalRequestCompanyQueryVariables>;
export function useGetGlobalMasterByInternalRequestCompanySuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetGlobalMasterByInternalRequestCompanyQuery, Types.GetGlobalMasterByInternalRequestCompanyQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetGlobalMasterByInternalRequestCompanyQuery | undefined, Types.GetGlobalMasterByInternalRequestCompanyQueryVariables>;
export function useGetGlobalMasterByInternalRequestCompanySuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetGlobalMasterByInternalRequestCompanyQuery, Types.GetGlobalMasterByInternalRequestCompanyQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetGlobalMasterByInternalRequestCompanyQuery, Types.GetGlobalMasterByInternalRequestCompanyQueryVariables>(GetGlobalMasterByInternalRequestCompanyDocument, options);
        }
...
export type GetGlobalMasterByInternalRequestCompanySuspenseQueryHookResult = ReturnType<typeof useGetGlobalMasterByInternalRequestCompanySuspenseQuery>;

 ...
 * });
 */
export function useGetParentCompanyByUserAndAddressIdQuery(baseOptions: Apollo.QueryHookOptions<Types.GetParentCompanyByUserAndAddressIdQuery, Types.GetParentCompanyByUserAndAddressIdQueryVariables> & ({ variables: Types.GetParentCompanyByUserAndAddressIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetParentCompanyByUserAndAddressIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetParentCompanyByUserAndAddressIdQuery, Types.GetParentCompanyByUserAndAddressIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetParentCompanyByUserAndAddressIdQuery, Types.GetParentCompanyByUserAndAddressIdQueryVariables>;
export function useGetParentCompanyByUserAndAddressIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetParentCompanyByUserAndAddressIdQuery, Types.GetParentCompanyByUserAndAddressIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetParentCompanyByUserAndAddressIdQuery | undefined, Types.GetParentCompanyByUserAndAddressIdQueryVariables>;
export function useGetParentCompanyByUserAndAddressIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetParentCompanyByUserAndAddressIdQuery, Types.GetParentCompanyByUserAndAddressIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetParentCompanyByUserAndAddressIdQuery, Types.GetParentCompanyByUserAndAddressIdQueryVariables>(GetParentCompanyByUserAndAddressIdDocument, options);
        }
...
export type GetParentCompanyByUserAndAddressIdSuspenseQueryHookResult = ReturnType<typeof useGetParentCompanyByUserAndAddressIdSuspenseQuery>;

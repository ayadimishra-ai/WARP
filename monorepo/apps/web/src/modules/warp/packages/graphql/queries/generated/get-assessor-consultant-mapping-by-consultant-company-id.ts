...
// @ts-ignore
export function useGetAssessorConsultantMappingByConsultantCompanyIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetAssessorConsultantMappingByConsultantCompanyIdQuery, Types.GetAssessorConsultantMappingByConsultantCompanyIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetAssessorConsultantMappingByConsultantCompanyIdQuery, Types.GetAssessorConsultantMappingByConsultantCompanyIdQueryVariables>;
export function useGetAssessorConsultantMappingByConsultantCompanyIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetAssessorConsultantMappingByConsultantCompanyIdQuery, Types.GetAssessorConsultantMappingByConsultantCompanyIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetAssessorConsultantMappingByConsultantCompanyIdQuery | undefined, Types.GetAssessorConsultantMappingByConsultantCompanyIdQueryVariables>;
export function useGetAssessorConsultantMappingByConsultantCompanyIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetAssessorConsultantMappingByConsultantCompanyIdQuery, Types.GetAssessorConsultantMappingByConsultantCompanyIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetAssessorConsultantMappingByConsultantCompanyIdQuery, Types.GetAssessorConsultantMappingByConsultantCompanyIdQueryVariables>(GetAssessorConsultantMappingByConsultantCompanyIdDocument, options);
        }
...
export type GetAssessorConsultantMappingByConsultantCompanyIdSuspenseQueryHookResult = ReturnType<typeof useGetAssessorConsultantMappingByConsultantCompanyIdSuspenseQuery>;

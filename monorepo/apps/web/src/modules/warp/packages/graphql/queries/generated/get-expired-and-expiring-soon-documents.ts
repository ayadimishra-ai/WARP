 ...
 * });
 */
export function useGetDocumentsForExpiryQuery(baseOptions: Apollo.QueryHookOptions<Types.GetDocumentsForExpiryQuery, Types.GetDocumentsForExpiryQueryVariables> & ({ variables: Types.GetDocumentsForExpiryQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetDocumentsForExpirySuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetDocumentsForExpiryQuery, Types.GetDocumentsForExpiryQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetDocumentsForExpiryQuery, Types.GetDocumentsForExpiryQueryVariables>;
export function useGetDocumentsForExpirySuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetDocumentsForExpiryQuery, Types.GetDocumentsForExpiryQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetDocumentsForExpiryQuery | undefined, Types.GetDocumentsForExpiryQueryVariables>;
export function useGetDocumentsForExpirySuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetDocumentsForExpiryQuery, Types.GetDocumentsForExpiryQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetDocumentsForExpiryQuery, Types.GetDocumentsForExpiryQueryVariables>(GetDocumentsForExpiryDocument, options);
        }
...
export type GetDocumentsForExpirySuspenseQueryHookResult = ReturnType<typeof useGetDocumentsForExpirySuspenseQuery>;

 ...
 * });
 */
export function useGetParentCompanyByCompanyAndParentCompanyIdQuery(baseOptions: Apollo.QueryHookOptions<Types.GetParentCompanyByCompanyAndParentCompanyIdQuery, Types.GetParentCompanyByCompanyAndParentCompanyIdQueryVariables> & ({ variables: Types.GetParentCompanyByCompanyAndParentCompanyIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetParentCompanyByCompanyAndParentCompanyIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetParentCompanyByCompanyAndParentCompanyIdQuery, Types.GetParentCompanyByCompanyAndParentCompanyIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetParentCompanyByCompanyAndParentCompanyIdQuery, Types.GetParentCompanyByCompanyAndParentCompanyIdQueryVariables>;
export function useGetParentCompanyByCompanyAndParentCompanyIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetParentCompanyByCompanyAndParentCompanyIdQuery, Types.GetParentCompanyByCompanyAndParentCompanyIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetParentCompanyByCompanyAndParentCompanyIdQuery | undefined, Types.GetParentCompanyByCompanyAndParentCompanyIdQueryVariables>;
export function useGetParentCompanyByCompanyAndParentCompanyIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetParentCompanyByCompanyAndParentCompanyIdQuery, Types.GetParentCompanyByCompanyAndParentCompanyIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetParentCompanyByCompanyAndParentCompanyIdQuery, Types.GetParentCompanyByCompanyAndParentCompanyIdQueryVariables>(GetParentCompanyByCompanyAndParentCompanyIdDocument, options);
        }
...
export type GetParentCompanyByCompanyAndParentCompanyIdSuspenseQueryHookResult = ReturnType<typeof useGetParentCompanyByCompanyAndParentCompanyIdSuspenseQuery>;

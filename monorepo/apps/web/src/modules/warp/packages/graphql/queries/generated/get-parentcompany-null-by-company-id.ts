...
// @ts-ignore
export function useGetParentCompanyByCompanyIdNullSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetParentCompanyByCompanyIdNullQuery, Types.GetParentCompanyByCompanyIdNullQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetParentCompanyByCompanyIdNullQuery, Types.GetParentCompanyByCompanyIdNullQueryVariables>;
export function useGetParentCompanyByCompanyIdNullSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetParentCompanyByCompanyIdNullQuery, Types.GetParentCompanyByCompanyIdNullQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetParentCompanyByCompanyIdNullQuery | undefined, Types.GetParentCompanyByCompanyIdNullQueryVariables>;
export function useGetParentCompanyByCompanyIdNullSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetParentCompanyByCompanyIdNullQuery, Types.GetParentCompanyByCompanyIdNullQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetParentCompanyByCompanyIdNullQuery, Types.GetParentCompanyByCompanyIdNullQueryVariables>(GetParentCompanyByCompanyIdNullDocument, options);
        }
...
export type GetParentCompanyByCompanyIdNullSuspenseQueryHookResult = ReturnType<typeof useGetParentCompanyByCompanyIdNullSuspenseQuery>;

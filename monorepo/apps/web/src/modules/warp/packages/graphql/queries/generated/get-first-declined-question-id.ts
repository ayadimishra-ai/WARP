 ...
 * });
 */
export function useGetFirstDeclinedQuestionIdQuery(baseOptions: Apollo.QueryHookOptions<Types.GetFirstDeclinedQuestionIdQuery, Types.GetFirstDeclinedQuestionIdQueryVariables> & ({ variables: Types.GetFirstDeclinedQuestionIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetFirstDeclinedQuestionIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetFirstDeclinedQuestionIdQuery, Types.GetFirstDeclinedQuestionIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetFirstDeclinedQuestionIdQuery, Types.GetFirstDeclinedQuestionIdQueryVariables>;
export function useGetFirstDeclinedQuestionIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetFirstDeclinedQuestionIdQuery, Types.GetFirstDeclinedQuestionIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetFirstDeclinedQuestionIdQuery | undefined, Types.GetFirstDeclinedQuestionIdQueryVariables>;
export function useGetFirstDeclinedQuestionIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetFirstDeclinedQuestionIdQuery, Types.GetFirstDeclinedQuestionIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetFirstDeclinedQuestionIdQuery, Types.GetFirstDeclinedQuestionIdQueryVariables>(GetFirstDeclinedQuestionIdDocument, options);
        }
...
export type GetFirstDeclinedQuestionIdSuspenseQueryHookResult = ReturnType<typeof useGetFirstDeclinedQuestionIdSuspenseQuery>;

 ...
 * });
 */
export function useGetFormsQuery(baseOptions: Apollo.QueryHookOptions<Types.GetFormsQuery, Types.GetFormsQueryVariables> & ({ variables: Types.GetFormsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetFormsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetFormsQuery, Types.GetFormsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetFormsQuery, Types.GetFormsQueryVariables>;
export function useGetFormsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetFormsQuery, Types.GetFormsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetFormsQuery | undefined, Types.GetFormsQueryVariables>;
export function useGetFormsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetFormsQuery, Types.GetFormsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetFormsQuery, Types.GetFormsQueryVariables>(GetFormsDocument, options);
        }

 ...
 * });
 */
export function useGetUserConversationsQuery(baseOptions: Apollo.QueryHookOptions<Types.GetUserConversationsQuery, Types.GetUserConversationsQueryVariables> & ({ variables: Types.GetUserConversationsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetUserConversationsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetUserConversationsQuery, Types.GetUserConversationsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetUserConversationsQuery, Types.GetUserConversationsQueryVariables>;
export function useGetUserConversationsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetUserConversationsQuery, Types.GetUserConversationsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetUserConversationsQuery | undefined, Types.GetUserConversationsQueryVariables>;
export function useGetUserConversationsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetUserConversationsQuery, Types.GetUserConversationsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetUserConversationsQuery, Types.GetUserConversationsQueryVariables>(GetUserConversationsDocument, options);
        }

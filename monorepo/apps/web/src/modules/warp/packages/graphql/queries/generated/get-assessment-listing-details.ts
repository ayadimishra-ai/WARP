 ...
 * });
 */
export function useGetAssessmentListingDetailsQuery(baseOptions: Apollo.QueryHookOptions<Types.GetAssessmentListingDetailsQuery, Types.GetAssessmentListingDetailsQueryVariables> & ({ variables: Types.GetAssessmentListingDetailsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetAssessmentListingDetailsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetAssessmentListingDetailsQuery, Types.GetAssessmentListingDetailsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetAssessmentListingDetailsQuery, Types.GetAssessmentListingDetailsQueryVariables>;
export function useGetAssessmentListingDetailsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetAssessmentListingDetailsQuery, Types.GetAssessmentListingDetailsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetAssessmentListingDetailsQuery | undefined, Types.GetAssessmentListingDetailsQueryVariables>;
export function useGetAssessmentListingDetailsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetAssessmentListingDetailsQuery, Types.GetAssessmentListingDetailsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetAssessmentListingDetailsQuery, Types.GetAssessmentListingDetailsQueryVariables>(GetAssessmentListingDetailsDocument, options);
        }
...
export type GetAssessmentListingDetailsSuspenseQueryHookResult = ReturnType<typeof useGetAssessmentListingDetailsSuspenseQuery>;

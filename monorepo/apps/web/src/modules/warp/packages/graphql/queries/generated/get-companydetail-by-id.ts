...
// @ts-ignore
export function useGetCompanyDetailByIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetCompanyDetailByIdQuery, Types.GetCompanyDetailByIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetCompanyDetailByIdQuery, Types.GetCompanyDetailByIdQueryVariables>;
export function useGetCompanyDetailByIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetCompanyDetailByIdQuery, Types.GetCompanyDetailByIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetCompanyDetailByIdQuery | undefined, Types.GetCompanyDetailByIdQueryVariables>;
export function useGetCompanyDetailByIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetCompanyDetailByIdQuery, Types.GetCompanyDetailByIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetCompanyDetailByIdQuery, Types.GetCompanyDetailByIdQueryVariables>(GetCompanyDetailByIdDocument, options);
        }
...
export type GetCompanyDetailByIdSuspenseQueryHookResult = ReturnType<typeof useGetCompanyDetailByIdSuspenseQuery>;

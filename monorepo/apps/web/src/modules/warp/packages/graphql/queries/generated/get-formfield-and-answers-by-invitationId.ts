 ...
 * });
 */
export function useGetFormfieldAndAnswersByinvitationIdQuery(baseOptions: Apollo.QueryHookOptions<Types.GetFormfieldAndAnswersByinvitationIdQuery, Types.GetFormfieldAndAnswersByinvitationIdQueryVariables> & ({ variables: Types.GetFormfieldAndAnswersByinvitationIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetFormfieldAndAnswersByinvitationIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetFormfieldAndAnswersByinvitationIdQuery, Types.GetFormfieldAndAnswersByinvitationIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetFormfieldAndAnswersByinvitationIdQuery, Types.GetFormfieldAndAnswersByinvitationIdQueryVariables>;
export function useGetFormfieldAndAnswersByinvitationIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetFormfieldAndAnswersByinvitationIdQuery, Types.GetFormfieldAndAnswersByinvitationIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetFormfieldAndAnswersByinvitationIdQuery | undefined, Types.GetFormfieldAndAnswersByinvitationIdQueryVariables>;
export function useGetFormfieldAndAnswersByinvitationIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetFormfieldAndAnswersByinvitationIdQuery, Types.GetFormfieldAndAnswersByinvitationIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetFormfieldAndAnswersByinvitationIdQuery, Types.GetFormfieldAndAnswersByinvitationIdQueryVariables>(GetFormfieldAndAnswersByinvitationIdDocument, options);
        }
...
export type GetFormfieldAndAnswersByinvitationIdSuspenseQueryHookResult = ReturnType<typeof useGetFormfieldAndAnswersByinvitationIdSuspenseQuery>;

 ...
 * });
 */
export function useGetConsultantAssessmentListQuery(baseOptions: Apollo.QueryHookOptions<Types.GetConsultantAssessmentListQuery, Types.GetConsultantAssessmentListQueryVariables> & ({ variables: Types.GetConsultantAssessmentListQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetConsultantAssessmentListSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetConsultantAssessmentListQuery, Types.GetConsultantAssessmentListQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetConsultantAssessmentListQuery, Types.GetConsultantAssessmentListQueryVariables>;
export function useGetConsultantAssessmentListSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetConsultantAssessmentListQuery, Types.GetConsultantAssessmentListQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetConsultantAssessmentListQuery | undefined, Types.GetConsultantAssessmentListQueryVariables>;
export function useGetConsultantAssessmentListSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetConsultantAssessmentListQuery, Types.GetConsultantAssessmentListQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetConsultantAssessmentListQuery, Types.GetConsultantAssessmentListQueryVariables>(GetConsultantAssessmentListDocument, options);
        }
...
export type GetConsultantAssessmentListSuspenseQueryHookResult = ReturnType<typeof useGetConsultantAssessmentListSuspenseQuery>;

 ...
 * });
 */
export function useGetSubscriptionByIdQuery(baseOptions: Apollo.QueryHookOptions<Types.GetSubscriptionByIdQuery, Types.GetSubscriptionByIdQueryVariables> & ({ variables: Types.GetSubscriptionByIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetSubscriptionByIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetSubscriptionByIdQuery, Types.GetSubscriptionByIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetSubscriptionByIdQuery, Types.GetSubscriptionByIdQueryVariables>;
export function useGetSubscriptionByIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetSubscriptionByIdQuery, Types.GetSubscriptionByIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetSubscriptionByIdQuery | undefined, Types.GetSubscriptionByIdQueryVariables>;
export function useGetSubscriptionByIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetSubscriptionByIdQuery, Types.GetSubscriptionByIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetSubscriptionByIdQuery, Types.GetSubscriptionByIdQueryVariables>(GetSubscriptionByIdDocument, options);
        }

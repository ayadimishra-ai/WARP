...
// @ts-ignore
export function useGetCompanyWithFormInvitationAndEmailTemplatesSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetCompanyWithFormInvitationAndEmailTemplatesQuery, Types.GetCompanyWithFormInvitationAndEmailTemplatesQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetCompanyWithFormInvitationAndEmailTemplatesQuery, Types.GetCompanyWithFormInvitationAndEmailTemplatesQueryVariables>;
export function useGetCompanyWithFormInvitationAndEmailTemplatesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetCompanyWithFormInvitationAndEmailTemplatesQuery, Types.GetCompanyWithFormInvitationAndEmailTemplatesQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetCompanyWithFormInvitationAndEmailTemplatesQuery | undefined, Types.GetCompanyWithFormInvitationAndEmailTemplatesQueryVariables>;
export function useGetCompanyWithFormInvitationAndEmailTemplatesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetCompanyWithFormInvitationAndEmailTemplatesQuery, Types.GetCompanyWithFormInvitationAndEmailTemplatesQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetCompanyWithFormInvitationAndEmailTemplatesQuery, Types.GetCompanyWithFormInvitationAndEmailTemplatesQueryVariables>(GetCompanyWithFormInvitationAndEmailTemplatesDocument, options);
        }
...
export type GetCompanyWithFormInvitationAndEmailTemplatesSuspenseQueryHookResult = ReturnType<typeof useGetCompanyWithFormInvitationAndEmailTemplatesSuspenseQuery>;

 ...
 * });
 */
export function useGetInvitationStatusCountsQuery(baseOptions: Apollo.QueryHookOptions<Types.GetInvitationStatusCountsQuery, Types.GetInvitationStatusCountsQueryVariables> & ({ variables: Types.GetInvitationStatusCountsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetInvitationStatusCountsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetInvitationStatusCountsQuery, Types.GetInvitationStatusCountsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetInvitationStatusCountsQuery, Types.GetInvitationStatusCountsQueryVariables>;
export function useGetInvitationStatusCountsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetInvitationStatusCountsQuery, Types.GetInvitationStatusCountsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetInvitationStatusCountsQuery | undefined, Types.GetInvitationStatusCountsQueryVariables>;
export function useGetInvitationStatusCountsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetInvitationStatusCountsQuery, Types.GetInvitationStatusCountsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetInvitationStatusCountsQuery, Types.GetInvitationStatusCountsQueryVariables>(GetInvitationStatusCountsDocument, options);
        }
...
export type GetInvitationStatusCountsSuspenseQueryHookResult = ReturnType<typeof useGetInvitationStatusCountsSuspenseQuery>;

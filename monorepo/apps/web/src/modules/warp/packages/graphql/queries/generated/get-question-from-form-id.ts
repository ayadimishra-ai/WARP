 ...
 * });
 */
export function useGetQuestionsFromFormIdQuery(baseOptions: Apollo.QueryHookOptions<Types.GetQuestionsFromFormIdQuery, Types.GetQuestionsFromFormIdQueryVariables> & ({ variables: Types.GetQuestionsFromFormIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetQuestionsFromFormIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetQuestionsFromFormIdQuery, Types.GetQuestionsFromFormIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetQuestionsFromFormIdQuery, Types.GetQuestionsFromFormIdQueryVariables>;
export function useGetQuestionsFromFormIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetQuestionsFromFormIdQuery, Types.GetQuestionsFromFormIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetQuestionsFromFormIdQuery | undefined, Types.GetQuestionsFromFormIdQueryVariables>;
export function useGetQuestionsFromFormIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetQuestionsFromFormIdQuery, Types.GetQuestionsFromFormIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetQuestionsFromFormIdQuery, Types.GetQuestionsFromFormIdQueryVariables>(GetQuestionsFromFormIdDocument, options);
        }
...
export type GetQuestionsFromFormIdSuspenseQueryHookResult = ReturnType<typeof useGetQuestionsFromFormIdSuspenseQuery>;

 ...
 * });
 */
export function useRaraCompanyAccessQuery(baseOptions: Apollo.QueryHookOptions<Types.RaraCompanyAccessQuery, Types.RaraCompanyAccessQueryVariables> & ({ variables: Types.RaraCompanyAccessQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useRaraCompanyAccessSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.RaraCompanyAccessQuery, Types.RaraCompanyAccessQueryVariables>): Apollo.UseSuspenseQueryResult<Types.RaraCompanyAccessQuery, Types.RaraCompanyAccessQueryVariables>;
export function useRaraCompanyAccessSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.RaraCompanyAccessQuery, Types.RaraCompanyAccessQueryVariables>): Apollo.UseSuspenseQueryResult<Types.RaraCompanyAccessQuery | undefined, Types.RaraCompanyAccessQueryVariables>;
export function useRaraCompanyAccessSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.RaraCompanyAccessQuery, Types.RaraCompanyAccessQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.RaraCompanyAccessQuery, Types.RaraCompanyAccessQueryVariables>(RaraCompanyAccessDocument, options);
        }
...
export type RaraCompanyAccessSuspenseQueryHookResult = ReturnType<typeof useRaraCompanyAccessSuspenseQuery>;

 ...
 * });
 */
export function useGetformInvitationdatabycustomwhereQuery(baseOptions: Apollo.QueryHookOptions<Types.GetformInvitationdatabycustomwhereQuery, Types.GetformInvitationdatabycustomwhereQueryVariables> & ({ variables: Types.GetformInvitationdatabycustomwhereQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetformInvitationdatabycustomwhereSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetformInvitationdatabycustomwhereQuery, Types.GetformInvitationdatabycustomwhereQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetformInvitationdatabycustomwhereQuery, Types.GetformInvitationdatabycustomwhereQueryVariables>;
export function useGetformInvitationdatabycustomwhereSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetformInvitationdatabycustomwhereQuery, Types.GetformInvitationdatabycustomwhereQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetformInvitationdatabycustomwhereQuery | undefined, Types.GetformInvitationdatabycustomwhereQueryVariables>;
export function useGetformInvitationdatabycustomwhereSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetformInvitationdatabycustomwhereQuery, Types.GetformInvitationdatabycustomwhereQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetformInvitationdatabycustomwhereQuery, Types.GetformInvitationdatabycustomwhereQueryVariables>(GetformInvitationdatabycustomwhereDocument, options);
        }
...
export type GetformInvitationdatabycustomwhereSuspenseQueryHookResult = ReturnType<typeof useGetformInvitationdatabycustomwhereSuspenseQuery>;

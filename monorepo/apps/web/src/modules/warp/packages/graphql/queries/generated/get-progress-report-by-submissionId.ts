...
// @ts-ignore
export function useGetProgressReportbySubmissionIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetProgressReportbySubmissionIdQuery, Types.GetProgressReportbySubmissionIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetProgressReportbySubmissionIdQuery, Types.GetProgressReportbySubmissionIdQueryVariables>;
export function useGetProgressReportbySubmissionIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetProgressReportbySubmissionIdQuery, Types.GetProgressReportbySubmissionIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetProgressReportbySubmissionIdQuery | undefined, Types.GetProgressReportbySubmissionIdQueryVariables>;
export function useGetProgressReportbySubmissionIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetProgressReportbySubmissionIdQuery, Types.GetProgressReportbySubmissionIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetProgressReportbySubmissionIdQuery, Types.GetProgressReportbySubmissionIdQueryVariables>(GetProgressReportbySubmissionIdDocument, options);
        }
...
export type GetProgressReportbySubmissionIdSuspenseQueryHookResult = ReturnType<typeof useGetProgressReportbySubmissionIdSuspenseQuery>;

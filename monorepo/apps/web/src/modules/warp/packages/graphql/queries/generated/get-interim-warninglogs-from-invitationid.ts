 ...
 * });
 */
export function useGetinterimwarninglogsbyInvitationIdQuery(baseOptions: Apollo.QueryHookOptions<Types.GetinterimwarninglogsbyInvitationIdQuery, Types.GetinterimwarninglogsbyInvitationIdQueryVariables> & ({ variables: Types.GetinterimwarninglogsbyInvitationIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetinterimwarninglogsbyInvitationIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetinterimwarninglogsbyInvitationIdQuery, Types.GetinterimwarninglogsbyInvitationIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetinterimwarninglogsbyInvitationIdQuery, Types.GetinterimwarninglogsbyInvitationIdQueryVariables>;
export function useGetinterimwarninglogsbyInvitationIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetinterimwarninglogsbyInvitationIdQuery, Types.GetinterimwarninglogsbyInvitationIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetinterimwarninglogsbyInvitationIdQuery | undefined, Types.GetinterimwarninglogsbyInvitationIdQueryVariables>;
export function useGetinterimwarninglogsbyInvitationIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetinterimwarninglogsbyInvitationIdQuery, Types.GetinterimwarninglogsbyInvitationIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetinterimwarninglogsbyInvitationIdQuery, Types.GetinterimwarninglogsbyInvitationIdQueryVariables>(GetinterimwarninglogsbyInvitationIdDocument, options);
        }
...
export type GetinterimwarninglogsbyInvitationIdSuspenseQueryHookResult = ReturnType<typeof useGetinterimwarninglogsbyInvitationIdSuspenseQuery>;

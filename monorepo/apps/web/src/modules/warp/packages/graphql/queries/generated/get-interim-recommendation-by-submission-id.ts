...
// @ts-ignore
export function useGetInterimRecommendationBySubmissionIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetInterimRecommendationBySubmissionIdQuery, Types.GetInterimRecommendationBySubmissionIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetInterimRecommendationBySubmissionIdQuery, Types.GetInterimRecommendationBySubmissionIdQueryVariables>;
export function useGetInterimRecommendationBySubmissionIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetInterimRecommendationBySubmissionIdQuery, Types.GetInterimRecommendationBySubmissionIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetInterimRecommendationBySubmissionIdQuery | undefined, Types.GetInterimRecommendationBySubmissionIdQueryVariables>;
export function useGetInterimRecommendationBySubmissionIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetInterimRecommendationBySubmissionIdQuery, Types.GetInterimRecommendationBySubmissionIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetInterimRecommendationBySubmissionIdQuery, Types.GetInterimRecommendationBySubmissionIdQueryVariables>(GetInterimRecommendationBySubmissionIdDocument, options);
        }
...
export type GetInterimRecommendationBySubmissionIdSuspenseQueryHookResult = ReturnType<typeof useGetInterimRecommendationBySubmissionIdSuspenseQuery>;

 ...
 * });
 */
export function useGetSuggestionsAndFormFieldDataByInvitationIdQuery(baseOptions: Apollo.QueryHookOptions<Types.GetSuggestionsAndFormFieldDataByInvitationIdQuery, Types.GetSuggestionsAndFormFieldDataByInvitationIdQueryVariables> & ({ variables: Types.GetSuggestionsAndFormFieldDataByInvitationIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetSuggestionsAndFormFieldDataByInvitationIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetSuggestionsAndFormFieldDataByInvitationIdQuery, Types.GetSuggestionsAndFormFieldDataByInvitationIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetSuggestionsAndFormFieldDataByInvitationIdQuery, Types.GetSuggestionsAndFormFieldDataByInvitationIdQueryVariables>;
export function useGetSuggestionsAndFormFieldDataByInvitationIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetSuggestionsAndFormFieldDataByInvitationIdQuery, Types.GetSuggestionsAndFormFieldDataByInvitationIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetSuggestionsAndFormFieldDataByInvitationIdQuery | undefined, Types.GetSuggestionsAndFormFieldDataByInvitationIdQueryVariables>;
export function useGetSuggestionsAndFormFieldDataByInvitationIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetSuggestionsAndFormFieldDataByInvitationIdQuery, Types.GetSuggestionsAndFormFieldDataByInvitationIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetSuggestionsAndFormFieldDataByInvitationIdQuery, Types.GetSuggestionsAndFormFieldDataByInvitationIdQueryVariables>(GetSuggestionsAndFormFieldDataByInvitationIdDocument, options);
        }
...
export type GetSuggestionsAndFormFieldDataByInvitationIdSuspenseQueryHookResult = ReturnType<typeof useGetSuggestionsAndFormFieldDataByInvitationIdSuspenseQuery>;

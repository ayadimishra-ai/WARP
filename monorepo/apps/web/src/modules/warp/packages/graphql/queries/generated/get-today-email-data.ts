...
// @ts-ignore
export function useGetTodayEmailDataSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetTodayEmailDataQuery, Types.GetTodayEmailDataQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetTodayEmailDataQuery, Types.GetTodayEmailDataQueryVariables>;
export function useGetTodayEmailDataSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetTodayEmailDataQuery, Types.GetTodayEmailDataQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetTodayEmailDataQuery | undefined, Types.GetTodayEmailDataQueryVariables>;
export function useGetTodayEmailDataSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetTodayEmailDataQuery, Types.GetTodayEmailDataQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetTodayEmailDataQuery, Types.GetTodayEmailDataQueryVariables>(GetTodayEmailDataDocument, options);
        }
...
export type GetTodayEmailDataSuspenseQueryHookResult = ReturnType<typeof useGetTodayEmailDataSuspenseQuery>;

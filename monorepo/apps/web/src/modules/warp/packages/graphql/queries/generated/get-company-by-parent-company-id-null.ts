...
// @ts-ignore
export function useGetCompanyByParentCompanyIdNullSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetCompanyByParentCompanyIdNullQuery, Types.GetCompanyByParentCompanyIdNullQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetCompanyByParentCompanyIdNullQuery, Types.GetCompanyByParentCompanyIdNullQueryVariables>;
export function useGetCompanyByParentCompanyIdNullSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetCompanyByParentCompanyIdNullQuery, Types.GetCompanyByParentCompanyIdNullQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetCompanyByParentCompanyIdNullQuery | undefined, Types.GetCompanyByParentCompanyIdNullQueryVariables>;
export function useGetCompanyByParentCompanyIdNullSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetCompanyByParentCompanyIdNullQuery, Types.GetCompanyByParentCompanyIdNullQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetCompanyByParentCompanyIdNullQuery, Types.GetCompanyByParentCompanyIdNullQueryVariables>(GetCompanyByParentCompanyIdNullDocument, options);
        }
...
export type GetCompanyByParentCompanyIdNullSuspenseQueryHookResult = ReturnType<typeof useGetCompanyByParentCompanyIdNullSuspenseQuery>;

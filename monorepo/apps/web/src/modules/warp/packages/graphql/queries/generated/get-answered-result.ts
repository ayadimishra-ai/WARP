...
// @ts-ignore
export function useGetAnsweredResultSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetAnsweredResultQuery, Types.GetAnsweredResultQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetAnsweredResultQuery, Types.GetAnsweredResultQueryVariables>;
export function useGetAnsweredResultSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetAnsweredResultQuery, Types.GetAnsweredResultQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetAnsweredResultQuery | undefined, Types.GetAnsweredResultQueryVariables>;
export function useGetAnsweredResultSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetAnsweredResultQuery, Types.GetAnsweredResultQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetAnsweredResultQuery, Types.GetAnsweredResultQueryVariables>(GetAnsweredResultDocument, options);
        }
...
export type GetAnsweredResultSuspenseQueryHookResult = ReturnType<typeof useGetAnsweredResultSuspenseQuery>;

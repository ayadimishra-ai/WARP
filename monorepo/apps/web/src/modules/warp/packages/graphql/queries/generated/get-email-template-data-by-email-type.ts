...
// @ts-ignore
export function useGetEmailTemplateDataByEmailtypeSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetEmailTemplateDataByEmailtypeQuery, Types.GetEmailTemplateDataByEmailtypeQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetEmailTemplateDataByEmailtypeQuery, Types.GetEmailTemplateDataByEmailtypeQueryVariables>;
export function useGetEmailTemplateDataByEmailtypeSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetEmailTemplateDataByEmailtypeQuery, Types.GetEmailTemplateDataByEmailtypeQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetEmailTemplateDataByEmailtypeQuery | undefined, Types.GetEmailTemplateDataByEmailtypeQueryVariables>;
export function useGetEmailTemplateDataByEmailtypeSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetEmailTemplateDataByEmailtypeQuery, Types.GetEmailTemplateDataByEmailtypeQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetEmailTemplateDataByEmailtypeQuery, Types.GetEmailTemplateDataByEmailtypeQueryVariables>(GetEmailTemplateDataByEmailtypeDocument, options);
        }
...
export type GetEmailTemplateDataByEmailtypeSuspenseQueryHookResult = ReturnType<typeof useGetEmailTemplateDataByEmailtypeSuspenseQuery>;

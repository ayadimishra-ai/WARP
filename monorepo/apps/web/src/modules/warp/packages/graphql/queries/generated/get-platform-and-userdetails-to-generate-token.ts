 ...
 * });
 */
export function useGetPlatformAndUserDetailsToGenerateTokenQuery(baseOptions: Apollo.QueryHookOptions<Types.GetPlatformAndUserDetailsToGenerateTokenQuery, Types.GetPlatformAndUserDetailsToGenerateTokenQueryVariables> & ({ variables: Types.GetPlatformAndUserDetailsToGenerateTokenQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetPlatformAndUserDetailsToGenerateTokenSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetPlatformAndUserDetailsToGenerateTokenQuery, Types.GetPlatformAndUserDetailsToGenerateTokenQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetPlatformAndUserDetailsToGenerateTokenQuery, Types.GetPlatformAndUserDetailsToGenerateTokenQueryVariables>;
export function useGetPlatformAndUserDetailsToGenerateTokenSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetPlatformAndUserDetailsToGenerateTokenQuery, Types.GetPlatformAndUserDetailsToGenerateTokenQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetPlatformAndUserDetailsToGenerateTokenQuery | undefined, Types.GetPlatformAndUserDetailsToGenerateTokenQueryVariables>;
export function useGetPlatformAndUserDetailsToGenerateTokenSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetPlatformAndUserDetailsToGenerateTokenQuery, Types.GetPlatformAndUserDetailsToGenerateTokenQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetPlatformAndUserDetailsToGenerateTokenQuery, Types.GetPlatformAndUserDetailsToGenerateTokenQueryVariables>(GetPlatformAndUserDetailsToGenerateTokenDocument, options);
        }
...
export type GetPlatformAndUserDetailsToGenerateTokenSuspenseQueryHookResult = ReturnType<typeof useGetPlatformAndUserDetailsToGenerateTokenSuspenseQuery>;

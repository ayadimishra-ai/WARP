 ...
 * });
 */
export function useGetInvitaionListByFormIdQuery(baseOptions: Apollo.QueryHookOptions<Types.GetInvitaionListByFormIdQuery, Types.GetInvitaionListByFormIdQueryVariables> & ({ variables: Types.GetInvitaionListByFormIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetInvitaionListByFormIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetInvitaionListByFormIdQuery, Types.GetInvitaionListByFormIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetInvitaionListByFormIdQuery, Types.GetInvitaionListByFormIdQueryVariables>;
export function useGetInvitaionListByFormIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetInvitaionListByFormIdQuery, Types.GetInvitaionListByFormIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetInvitaionListByFormIdQuery | undefined, Types.GetInvitaionListByFormIdQueryVariables>;
export function useGetInvitaionListByFormIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetInvitaionListByFormIdQuery, Types.GetInvitaionListByFormIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetInvitaionListByFormIdQuery, Types.GetInvitaionListByFormIdQueryVariables>(GetInvitaionListByFormIdDocument, options);
        }
...
export type GetInvitaionListByFormIdSuspenseQueryHookResult = ReturnType<typeof useGetInvitaionListByFormIdSuspenseQuery>;

...
// @ts-ignore
export function useGetEmailTemplateDataByinvitationIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetEmailTemplateDataByinvitationIdQuery, Types.GetEmailTemplateDataByinvitationIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetEmailTemplateDataByinvitationIdQuery, Types.GetEmailTemplateDataByinvitationIdQueryVariables>;
export function useGetEmailTemplateDataByinvitationIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetEmailTemplateDataByinvitationIdQuery, Types.GetEmailTemplateDataByinvitationIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetEmailTemplateDataByinvitationIdQuery | undefined, Types.GetEmailTemplateDataByinvitationIdQueryVariables>;
export function useGetEmailTemplateDataByinvitationIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetEmailTemplateDataByinvitationIdQuery, Types.GetEmailTemplateDataByinvitationIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetEmailTemplateDataByinvitationIdQuery, Types.GetEmailTemplateDataByinvitationIdQueryVariables>(GetEmailTemplateDataByinvitationIdDocument, options);
        }
...
export type GetEmailTemplateDataByinvitationIdSuspenseQueryHookResult = ReturnType<typeof useGetEmailTemplateDataByinvitationIdSuspenseQuery>;

...
// @ts-ignore
export function useGetGlobalMasterByBrsrTemplateSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetGlobalMasterByBrsrTemplateQuery, Types.GetGlobalMasterByBrsrTemplateQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetGlobalMasterByBrsrTemplateQuery, Types.GetGlobalMasterByBrsrTemplateQueryVariables>;
export function useGetGlobalMasterByBrsrTemplateSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetGlobalMasterByBrsrTemplateQuery, Types.GetGlobalMasterByBrsrTemplateQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetGlobalMasterByBrsrTemplateQuery | undefined, Types.GetGlobalMasterByBrsrTemplateQueryVariables>;
export function useGetGlobalMasterByBrsrTemplateSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetGlobalMasterByBrsrTemplateQuery, Types.GetGlobalMasterByBrsrTemplateQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetGlobalMasterByBrsrTemplateQuery, Types.GetGlobalMasterByBrsrTemplateQueryVariables>(GetGlobalMasterByBrsrTemplateDocument, options);
        }
...
export type GetGlobalMasterByBrsrTemplateSuspenseQueryHookResult = ReturnType<typeof useGetGlobalMasterByBrsrTemplateSuspenseQuery>;

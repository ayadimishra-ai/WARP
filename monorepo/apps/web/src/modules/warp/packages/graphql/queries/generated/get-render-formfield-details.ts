 ...
 * });
 */
export function useGetRenderFormFieldDetailsQuery(baseOptions: Apollo.QueryHookOptions<Types.GetRenderFormFieldDetailsQuery, Types.GetRenderFormFieldDetailsQueryVariables> & ({ variables: Types.GetRenderFormFieldDetailsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetRenderFormFieldDetailsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetRenderFormFieldDetailsQuery, Types.GetRenderFormFieldDetailsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetRenderFormFieldDetailsQuery, Types.GetRenderFormFieldDetailsQueryVariables>;
export function useGetRenderFormFieldDetailsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetRenderFormFieldDetailsQuery, Types.GetRenderFormFieldDetailsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetRenderFormFieldDetailsQuery | undefined, Types.GetRenderFormFieldDetailsQueryVariables>;
export function useGetRenderFormFieldDetailsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetRenderFormFieldDetailsQuery, Types.GetRenderFormFieldDetailsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetRenderFormFieldDetailsQuery, Types.GetRenderFormFieldDetailsQueryVariables>(GetRenderFormFieldDetailsDocument, options);
        }
...
export type GetRenderFormFieldDetailsSuspenseQueryHookResult = ReturnType<typeof useGetRenderFormFieldDetailsSuspenseQuery>;

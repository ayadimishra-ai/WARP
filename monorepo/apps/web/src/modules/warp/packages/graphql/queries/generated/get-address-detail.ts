...
// @ts-ignore
export function useGetAddressDetailSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetAddressDetailQuery, Types.GetAddressDetailQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetAddressDetailQuery, Types.GetAddressDetailQueryVariables>;
export function useGetAddressDetailSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetAddressDetailQuery, Types.GetAddressDetailQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetAddressDetailQuery | undefined, Types.GetAddressDetailQueryVariables>;
export function useGetAddressDetailSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetAddressDetailQuery, Types.GetAddressDetailQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetAddressDetailQuery, Types.GetAddressDetailQueryVariables>(GetAddressDetailDocument, options);
        }

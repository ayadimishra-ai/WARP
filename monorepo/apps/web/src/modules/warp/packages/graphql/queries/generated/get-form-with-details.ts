...
// @ts-ignore
export function useGetFormWithDetailsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetFormWithDetailsQuery, Types.GetFormWithDetailsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetFormWithDetailsQuery, Types.GetFormWithDetailsQueryVariables>;
export function useGetFormWithDetailsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetFormWithDetailsQuery, Types.GetFormWithDetailsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetFormWithDetailsQuery | undefined, Types.GetFormWithDetailsQueryVariables>;
export function useGetFormWithDetailsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetFormWithDetailsQuery, Types.GetFormWithDetailsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetFormWithDetailsQuery, Types.GetFormWithDetailsQueryVariables>(GetFormWithDetailsDocument, options);
        }
...
export type GetFormWithDetailsSuspenseQueryHookResult = ReturnType<typeof useGetFormWithDetailsSuspenseQuery>;

 ...
 * });
 */
export function useGetUserDetailsByInvitationIdQuery(baseOptions: Apollo.QueryHookOptions<Types.GetUserDetailsByInvitationIdQuery, Types.GetUserDetailsByInvitationIdQueryVariables> & ({ variables: Types.GetUserDetailsByInvitationIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetUserDetailsByInvitationIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetUserDetailsByInvitationIdQuery, Types.GetUserDetailsByInvitationIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetUserDetailsByInvitationIdQuery, Types.GetUserDetailsByInvitationIdQueryVariables>;
export function useGetUserDetailsByInvitationIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetUserDetailsByInvitationIdQuery, Types.GetUserDetailsByInvitationIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetUserDetailsByInvitationIdQuery | undefined, Types.GetUserDetailsByInvitationIdQueryVariables>;
export function useGetUserDetailsByInvitationIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetUserDetailsByInvitationIdQuery, Types.GetUserDetailsByInvitationIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetUserDetailsByInvitationIdQuery, Types.GetUserDetailsByInvitationIdQueryVariables>(GetUserDetailsByInvitationIdDocument, options);
        }
...
export type GetUserDetailsByInvitationIdSuspenseQueryHookResult = ReturnType<typeof useGetUserDetailsByInvitationIdSuspenseQuery>;

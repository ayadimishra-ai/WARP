...
// @ts-ignore
export function useGetLatestAssignedQuestionIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetLatestAssignedQuestionIdQuery, Types.GetLatestAssignedQuestionIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetLatestAssignedQuestionIdQuery, Types.GetLatestAssignedQuestionIdQueryVariables>;
export function useGetLatestAssignedQuestionIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetLatestAssignedQuestionIdQuery, Types.GetLatestAssignedQuestionIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetLatestAssignedQuestionIdQuery | undefined, Types.GetLatestAssignedQuestionIdQueryVariables>;
export function useGetLatestAssignedQuestionIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetLatestAssignedQuestionIdQuery, Types.GetLatestAssignedQuestionIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetLatestAssignedQuestionIdQuery, Types.GetLatestAssignedQuestionIdQueryVariables>(GetLatestAssignedQuestionIdDocument, options);
        }
...
export type GetLatestAssignedQuestionIdSuspenseQueryHookResult = ReturnType<typeof useGetLatestAssignedQuestionIdSuspenseQuery>;

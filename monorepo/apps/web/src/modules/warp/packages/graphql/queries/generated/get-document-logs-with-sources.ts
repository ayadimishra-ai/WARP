 ...
 * });
 */
export function useGetDocumentLogsWithSourcesQuery(baseOptions: Apollo.QueryHookOptions<Types.GetDocumentLogsWithSourcesQuery, Types.GetDocumentLogsWithSourcesQueryVariables> & ({ variables: Types.GetDocumentLogsWithSourcesQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetDocumentLogsWithSourcesSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetDocumentLogsWithSourcesQuery, Types.GetDocumentLogsWithSourcesQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetDocumentLogsWithSourcesQuery, Types.GetDocumentLogsWithSourcesQueryVariables>;
export function useGetDocumentLogsWithSourcesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetDocumentLogsWithSourcesQuery, Types.GetDocumentLogsWithSourcesQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetDocumentLogsWithSourcesQuery | undefined, Types.GetDocumentLogsWithSourcesQueryVariables>;
export function useGetDocumentLogsWithSourcesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetDocumentLogsWithSourcesQuery, Types.GetDocumentLogsWithSourcesQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetDocumentLogsWithSourcesQuery, Types.GetDocumentLogsWithSourcesQueryVariables>(GetDocumentLogsWithSourcesDocument, options);
        }
...
export type GetDocumentLogsWithSourcesSuspenseQueryHookResult = ReturnType<typeof useGetDocumentLogsWithSourcesSuspenseQuery>;

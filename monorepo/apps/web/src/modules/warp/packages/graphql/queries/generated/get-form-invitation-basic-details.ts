 ...
 * });
 */
export function useGetFormInvitationbasicDetailsQuery(baseOptions: Apollo.QueryHookOptions<Types.GetFormInvitationbasicDetailsQuery, Types.GetFormInvitationbasicDetailsQueryVariables> & ({ variables: Types.GetFormInvitationbasicDetailsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetFormInvitationbasicDetailsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetFormInvitationbasicDetailsQuery, Types.GetFormInvitationbasicDetailsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetFormInvitationbasicDetailsQuery, Types.GetFormInvitationbasicDetailsQueryVariables>;
export function useGetFormInvitationbasicDetailsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetFormInvitationbasicDetailsQuery, Types.GetFormInvitationbasicDetailsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetFormInvitationbasicDetailsQuery | undefined, Types.GetFormInvitationbasicDetailsQueryVariables>;
export function useGetFormInvitationbasicDetailsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetFormInvitationbasicDetailsQuery, Types.GetFormInvitationbasicDetailsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetFormInvitationbasicDetailsQuery, Types.GetFormInvitationbasicDetailsQueryVariables>(GetFormInvitationbasicDetailsDocument, options);
        }
...
export type GetFormInvitationbasicDetailsSuspenseQueryHookResult = ReturnType<typeof useGetFormInvitationbasicDetailsSuspenseQuery>;

...
// @ts-ignore
export function useGetConsultantFormWithDetailsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetConsultantFormWithDetailsQuery, Types.GetConsultantFormWithDetailsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetConsultantFormWithDetailsQuery, Types.GetConsultantFormWithDetailsQueryVariables>;
export function useGetConsultantFormWithDetailsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetConsultantFormWithDetailsQuery, Types.GetConsultantFormWithDetailsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetConsultantFormWithDetailsQuery | undefined, Types.GetConsultantFormWithDetailsQueryVariables>;
export function useGetConsultantFormWithDetailsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetConsultantFormWithDetailsQuery, Types.GetConsultantFormWithDetailsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetConsultantFormWithDetailsQuery, Types.GetConsultantFormWithDetailsQueryVariables>(GetConsultantFormWithDetailsDocument, options);
        }
...
export type GetConsultantFormWithDetailsSuspenseQueryHookResult = ReturnType<typeof useGetConsultantFormWithDetailsSuspenseQuery>;

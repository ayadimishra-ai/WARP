...
// @ts-ignore
export function useGetExistingCompaniesNameWithUsersEmailSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetExistingCompaniesNameWithUsersEmailQuery, Types.GetExistingCompaniesNameWithUsersEmailQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetExistingCompaniesNameWithUsersEmailQuery, Types.GetExistingCompaniesNameWithUsersEmailQueryVariables>;
export function useGetExistingCompaniesNameWithUsersEmailSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetExistingCompaniesNameWithUsersEmailQuery, Types.GetExistingCompaniesNameWithUsersEmailQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetExistingCompaniesNameWithUsersEmailQuery | undefined, Types.GetExistingCompaniesNameWithUsersEmailQueryVariables>;
export function useGetExistingCompaniesNameWithUsersEmailSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetExistingCompaniesNameWithUsersEmailQuery, Types.GetExistingCompaniesNameWithUsersEmailQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetExistingCompaniesNameWithUsersEmailQuery, Types.GetExistingCompaniesNameWithUsersEmailQueryVariables>(GetExistingCompaniesNameWithUsersEmailDocument, options);
        }
...
export type GetExistingCompaniesNameWithUsersEmailSuspenseQueryHookResult = ReturnType<typeof useGetExistingCompaniesNameWithUsersEmailSuspenseQuery>;

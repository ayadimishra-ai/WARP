...
// @ts-ignore
export function useGetAllUsersByQuestionIdAndInvitationIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetAllUsersByQuestionIdAndInvitationIdQuery, Types.GetAllUsersByQuestionIdAndInvitationIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetAllUsersByQuestionIdAndInvitationIdQuery, Types.GetAllUsersByQuestionIdAndInvitationIdQueryVariables>;
export function useGetAllUsersByQuestionIdAndInvitationIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetAllUsersByQuestionIdAndInvitationIdQuery, Types.GetAllUsersByQuestionIdAndInvitationIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetAllUsersByQuestionIdAndInvitationIdQuery | undefined, Types.GetAllUsersByQuestionIdAndInvitationIdQueryVariables>;
export function useGetAllUsersByQuestionIdAndInvitationIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetAllUsersByQuestionIdAndInvitationIdQuery, Types.GetAllUsersByQuestionIdAndInvitationIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetAllUsersByQuestionIdAndInvitationIdQuery, Types.GetAllUsersByQuestionIdAndInvitationIdQueryVariables>(GetAllUsersByQuestionIdAndInvitationIdDocument, options);
        }
...
export type GetAllUsersByQuestionIdAndInvitationIdSuspenseQueryHookResult = ReturnType<typeof useGetAllUsersByQuestionIdAndInvitationIdSuspenseQuery>;

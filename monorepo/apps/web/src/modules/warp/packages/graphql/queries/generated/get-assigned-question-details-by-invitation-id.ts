...
// @ts-ignore
export function useGetAssignedQuestionDetailsByInvitationIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetAssignedQuestionDetailsByInvitationIdQuery, Types.GetAssignedQuestionDetailsByInvitationIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetAssignedQuestionDetailsByInvitationIdQuery, Types.GetAssignedQuestionDetailsByInvitationIdQueryVariables>;
export function useGetAssignedQuestionDetailsByInvitationIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetAssignedQuestionDetailsByInvitationIdQuery, Types.GetAssignedQuestionDetailsByInvitationIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetAssignedQuestionDetailsByInvitationIdQuery | undefined, Types.GetAssignedQuestionDetailsByInvitationIdQueryVariables>;
export function useGetAssignedQuestionDetailsByInvitationIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetAssignedQuestionDetailsByInvitationIdQuery, Types.GetAssignedQuestionDetailsByInvitationIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetAssignedQuestionDetailsByInvitationIdQuery, Types.GetAssignedQuestionDetailsByInvitationIdQueryVariables>(GetAssignedQuestionDetailsByInvitationIdDocument, options);
        }
...
export type GetAssignedQuestionDetailsByInvitationIdSuspenseQueryHookResult = ReturnType<typeof useGetAssignedQuestionDetailsByInvitationIdSuspenseQuery>;

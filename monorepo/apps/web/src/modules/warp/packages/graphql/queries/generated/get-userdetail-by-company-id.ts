...
// @ts-ignore
export function useGetUserDetailByCompanyIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetUserDetailByCompanyIdQuery, Types.GetUserDetailByCompanyIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetUserDetailByCompanyIdQuery, Types.GetUserDetailByCompanyIdQueryVariables>;
export function useGetUserDetailByCompanyIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetUserDetailByCompanyIdQuery, Types.GetUserDetailByCompanyIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetUserDetailByCompanyIdQuery | undefined, Types.GetUserDetailByCompanyIdQueryVariables>;
export function useGetUserDetailByCompanyIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetUserDetailByCompanyIdQuery, Types.GetUserDetailByCompanyIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetUserDetailByCompanyIdQuery, Types.GetUserDetailByCompanyIdQueryVariables>(GetUserDetailByCompanyIdDocument, options);
        }
...
export type GetUserDetailByCompanyIdSuspenseQueryHookResult = ReturnType<typeof useGetUserDetailByCompanyIdSuspenseQuery>;

...
// @ts-ignore
export function useGetFormDetailByBulkFormIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetFormDetailByBulkFormIdQuery, Types.GetFormDetailByBulkFormIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetFormDetailByBulkFormIdQuery, Types.GetFormDetailByBulkFormIdQueryVariables>;
export function useGetFormDetailByBulkFormIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetFormDetailByBulkFormIdQuery, Types.GetFormDetailByBulkFormIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetFormDetailByBulkFormIdQuery | undefined, Types.GetFormDetailByBulkFormIdQueryVariables>;
export function useGetFormDetailByBulkFormIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetFormDetailByBulkFormIdQuery, Types.GetFormDetailByBulkFormIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetFormDetailByBulkFormIdQuery, Types.GetFormDetailByBulkFormIdQueryVariables>(GetFormDetailByBulkFormIdDocument, options);
        }
...
export type GetFormDetailByBulkFormIdSuspenseQueryHookResult = ReturnType<typeof useGetFormDetailByBulkFormIdSuspenseQuery>;

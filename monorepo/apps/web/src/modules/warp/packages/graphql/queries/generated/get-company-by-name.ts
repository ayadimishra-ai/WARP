...
// @ts-ignore
export function useGetCompanyByNameSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetCompanyByNameQuery, Types.GetCompanyByNameQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetCompanyByNameQuery, Types.GetCompanyByNameQueryVariables>;
export function useGetCompanyByNameSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetCompanyByNameQuery, Types.GetCompanyByNameQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetCompanyByNameQuery | undefined, Types.GetCompanyByNameQueryVariables>;
export function useGetCompanyByNameSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetCompanyByNameQuery, Types.GetCompanyByNameQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetCompanyByNameQuery, Types.GetCompanyByNameQueryVariables>(GetCompanyByNameDocument, options);
        }
...
export type GetCompanyByNameSuspenseQueryHookResult = ReturnType<typeof useGetCompanyByNameSuspenseQuery>;

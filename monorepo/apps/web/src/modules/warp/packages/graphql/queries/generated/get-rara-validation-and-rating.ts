 ...
 * });
 */
export function useGetvalidationandratingQuery(baseOptions: Apollo.QueryHookOptions<Types.GetvalidationandratingQuery, Types.GetvalidationandratingQueryVariables> & ({ variables: Types.GetvalidationandratingQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetvalidationandratingSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetvalidationandratingQuery, Types.GetvalidationandratingQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetvalidationandratingQuery, Types.GetvalidationandratingQueryVariables>;
export function useGetvalidationandratingSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetvalidationandratingQuery, Types.GetvalidationandratingQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetvalidationandratingQuery | undefined, Types.GetvalidationandratingQueryVariables>;
export function useGetvalidationandratingSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetvalidationandratingQuery, Types.GetvalidationandratingQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetvalidationandratingQuery, Types.GetvalidationandratingQueryVariables>(GetvalidationandratingDocument, options);
        }
...
export type GetvalidationandratingSuspenseQueryHookResult = ReturnType<typeof useGetvalidationandratingSuspenseQuery>;

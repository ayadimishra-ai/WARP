 ...
 * });
 */
export function useGetSuggestionByInvitationAndFormFieldDetailsQuery(baseOptions: Apollo.QueryHookOptions<Types.GetSuggestionByInvitationAndFormFieldDetailsQuery, Types.GetSuggestionByInvitationAndFormFieldDetailsQueryVariables> & ({ variables: Types.GetSuggestionByInvitationAndFormFieldDetailsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetSuggestionByInvitationAndFormFieldDetailsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetSuggestionByInvitationAndFormFieldDetailsQuery, Types.GetSuggestionByInvitationAndFormFieldDetailsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetSuggestionByInvitationAndFormFieldDetailsQuery, Types.GetSuggestionByInvitationAndFormFieldDetailsQueryVariables>;
export function useGetSuggestionByInvitationAndFormFieldDetailsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetSuggestionByInvitationAndFormFieldDetailsQuery, Types.GetSuggestionByInvitationAndFormFieldDetailsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetSuggestionByInvitationAndFormFieldDetailsQuery | undefined, Types.GetSuggestionByInvitationAndFormFieldDetailsQueryVariables>;
export function useGetSuggestionByInvitationAndFormFieldDetailsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetSuggestionByInvitationAndFormFieldDetailsQuery, Types.GetSuggestionByInvitationAndFormFieldDetailsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetSuggestionByInvitationAndFormFieldDetailsQuery, Types.GetSuggestionByInvitationAndFormFieldDetailsQueryVariables>(GetSuggestionByInvitationAndFormFieldDetailsDocument, options);
        }
...
export type GetSuggestionByInvitationAndFormFieldDetailsSuspenseQueryHookResult = ReturnType<typeof useGetSuggestionByInvitationAndFormFieldDetailsSuspenseQuery>;

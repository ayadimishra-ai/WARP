...
// @ts-ignore
export function useGetCompanyByParentCompanyIdAndPlatformIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetCompanyByParentCompanyIdAndPlatformIdQuery, Types.GetCompanyByParentCompanyIdAndPlatformIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetCompanyByParentCompanyIdAndPlatformIdQuery, Types.GetCompanyByParentCompanyIdAndPlatformIdQueryVariables>;
export function useGetCompanyByParentCompanyIdAndPlatformIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetCompanyByParentCompanyIdAndPlatformIdQuery, Types.GetCompanyByParentCompanyIdAndPlatformIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetCompanyByParentCompanyIdAndPlatformIdQuery | undefined, Types.GetCompanyByParentCompanyIdAndPlatformIdQueryVariables>;
export function useGetCompanyByParentCompanyIdAndPlatformIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetCompanyByParentCompanyIdAndPlatformIdQuery, Types.GetCompanyByParentCompanyIdAndPlatformIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetCompanyByParentCompanyIdAndPlatformIdQuery, Types.GetCompanyByParentCompanyIdAndPlatformIdQueryVariables>(GetCompanyByParentCompanyIdAndPlatformIdDocument, options);
        }
...
export type GetCompanyByParentCompanyIdAndPlatformIdSuspenseQueryHookResult = ReturnType<typeof useGetCompanyByParentCompanyIdAndPlatformIdSuspenseQuery>;

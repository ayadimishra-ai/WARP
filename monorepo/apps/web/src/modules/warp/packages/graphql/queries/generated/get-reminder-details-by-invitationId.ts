 ...
 * });
 */
export function useGetReminderDetailsByInvitationIdQuery(baseOptions: Apollo.QueryHookOptions<Types.GetReminderDetailsByInvitationIdQuery, Types.GetReminderDetailsByInvitationIdQueryVariables> & ({ variables: Types.GetReminderDetailsByInvitationIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetReminderDetailsByInvitationIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetReminderDetailsByInvitationIdQuery, Types.GetReminderDetailsByInvitationIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetReminderDetailsByInvitationIdQuery, Types.GetReminderDetailsByInvitationIdQueryVariables>;
export function useGetReminderDetailsByInvitationIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetReminderDetailsByInvitationIdQuery, Types.GetReminderDetailsByInvitationIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetReminderDetailsByInvitationIdQuery | undefined, Types.GetReminderDetailsByInvitationIdQueryVariables>;
export function useGetReminderDetailsByInvitationIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetReminderDetailsByInvitationIdQuery, Types.GetReminderDetailsByInvitationIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetReminderDetailsByInvitationIdQuery, Types.GetReminderDetailsByInvitationIdQueryVariables>(GetReminderDetailsByInvitationIdDocument, options);
        }
...
export type GetReminderDetailsByInvitationIdSuspenseQueryHookResult = ReturnType<typeof useGetReminderDetailsByInvitationIdSuspenseQuery>;

...
// @ts-ignore
export function useGetParentCompanyMappingByAddressIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetParentCompanyMappingByAddressIdQuery, Types.GetParentCompanyMappingByAddressIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetParentCompanyMappingByAddressIdQuery, Types.GetParentCompanyMappingByAddressIdQueryVariables>;
export function useGetParentCompanyMappingByAddressIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetParentCompanyMappingByAddressIdQuery, Types.GetParentCompanyMappingByAddressIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetParentCompanyMappingByAddressIdQuery | undefined, Types.GetParentCompanyMappingByAddressIdQueryVariables>;
export function useGetParentCompanyMappingByAddressIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetParentCompanyMappingByAddressIdQuery, Types.GetParentCompanyMappingByAddressIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetParentCompanyMappingByAddressIdQuery, Types.GetParentCompanyMappingByAddressIdQueryVariables>(GetParentCompanyMappingByAddressIdDocument, options);
        }
...
export type GetParentCompanyMappingByAddressIdSuspenseQueryHookResult = ReturnType<typeof useGetParentCompanyMappingByAddressIdSuspenseQuery>;

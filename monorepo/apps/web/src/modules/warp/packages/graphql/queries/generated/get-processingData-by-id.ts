 ...
 * });
 */
export function useGetProcessingDataByIdQuery(baseOptions: Apollo.QueryHookOptions<Types.GetProcessingDataByIdQuery, Types.GetProcessingDataByIdQueryVariables> & ({ variables: Types.GetProcessingDataByIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetProcessingDataByIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetProcessingDataByIdQuery, Types.GetProcessingDataByIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetProcessingDataByIdQuery, Types.GetProcessingDataByIdQueryVariables>;
export function useGetProcessingDataByIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetProcessingDataByIdQuery, Types.GetProcessingDataByIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetProcessingDataByIdQuery | undefined, Types.GetProcessingDataByIdQueryVariables>;
export function useGetProcessingDataByIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetProcessingDataByIdQuery, Types.GetProcessingDataByIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetProcessingDataByIdQuery, Types.GetProcessingDataByIdQueryVariables>(GetProcessingDataByIdDocument, options);
        }
...
export type GetProcessingDataByIdSuspenseQueryHookResult = ReturnType<typeof useGetProcessingDataByIdSuspenseQuery>;

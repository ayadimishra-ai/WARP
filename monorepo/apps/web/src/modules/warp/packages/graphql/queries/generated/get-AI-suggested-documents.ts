...
// @ts-ignore
export function useGetAiSuggestedDocumentsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetAiSuggestedDocumentsQuery, Types.GetAiSuggestedDocumentsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetAiSuggestedDocumentsQuery, Types.GetAiSuggestedDocumentsQueryVariables>;
export function useGetAiSuggestedDocumentsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetAiSuggestedDocumentsQuery, Types.GetAiSuggestedDocumentsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetAiSuggestedDocumentsQuery | undefined, Types.GetAiSuggestedDocumentsQueryVariables>;
export function useGetAiSuggestedDocumentsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetAiSuggestedDocumentsQuery, Types.GetAiSuggestedDocumentsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetAiSuggestedDocumentsQuery, Types.GetAiSuggestedDocumentsQueryVariables>(GetAiSuggestedDocumentsDocument, options);
        }
...
export type GetAiSuggestedDocumentsSuspenseQueryHookResult = ReturnType<typeof useGetAiSuggestedDocumentsSuspenseQuery>;

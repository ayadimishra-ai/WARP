...
// @ts-ignore
export function useGetGlobalMasterFormIconsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetGlobalMasterFormIconsQuery, Types.GetGlobalMasterFormIconsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetGlobalMasterFormIconsQuery, Types.GetGlobalMasterFormIconsQueryVariables>;
export function useGetGlobalMasterFormIconsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetGlobalMasterFormIconsQuery, Types.GetGlobalMasterFormIconsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetGlobalMasterFormIconsQuery | undefined, Types.GetGlobalMasterFormIconsQueryVariables>;
export function useGetGlobalMasterFormIconsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetGlobalMasterFormIconsQuery, Types.GetGlobalMasterFormIconsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetGlobalMasterFormIconsQuery, Types.GetGlobalMasterFormIconsQueryVariables>(GetGlobalMasterFormIconsDocument, options);
        }
...
export type GetGlobalMasterFormIconsSuspenseQueryHookResult = ReturnType<typeof useGetGlobalMasterFormIconsSuspenseQuery>;

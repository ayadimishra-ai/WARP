...
// @ts-ignore
export function useGetInvitationDetailsByCompanyIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetInvitationDetailsByCompanyIdQuery, Types.GetInvitationDetailsByCompanyIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetInvitationDetailsByCompanyIdQuery, Types.GetInvitationDetailsByCompanyIdQueryVariables>;
export function useGetInvitationDetailsByCompanyIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetInvitationDetailsByCompanyIdQuery, Types.GetInvitationDetailsByCompanyIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetInvitationDetailsByCompanyIdQuery | undefined, Types.GetInvitationDetailsByCompanyIdQueryVariables>;
export function useGetInvitationDetailsByCompanyIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetInvitationDetailsByCompanyIdQuery, Types.GetInvitationDetailsByCompanyIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetInvitationDetailsByCompanyIdQuery, Types.GetInvitationDetailsByCompanyIdQueryVariables>(GetInvitationDetailsByCompanyIdDocument, options);
        }
...
export type GetInvitationDetailsByCompanyIdSuspenseQueryHookResult = ReturnType<typeof useGetInvitationDetailsByCompanyIdSuspenseQuery>;

 ...
 * });
 */
export function useGetSuggestedDocumentsQuery(baseOptions: Apollo.QueryHookOptions<Types.GetSuggestedDocumentsQuery, Types.GetSuggestedDocumentsQueryVariables> & ({ variables: Types.GetSuggestedDocumentsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetSuggestedDocumentsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetSuggestedDocumentsQuery, Types.GetSuggestedDocumentsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetSuggestedDocumentsQuery, Types.GetSuggestedDocumentsQueryVariables>;
export function useGetSuggestedDocumentsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetSuggestedDocumentsQuery, Types.GetSuggestedDocumentsQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetSuggestedDocumentsQuery | undefined, Types.GetSuggestedDocumentsQueryVariables>;
export function useGetSuggestedDocumentsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetSuggestedDocumentsQuery, Types.GetSuggestedDocumentsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetSuggestedDocumentsQuery, Types.GetSuggestedDocumentsQueryVariables>(GetSuggestedDocumentsDocument, options);
        }
...
export type GetSuggestedDocumentsSuspenseQueryHookResult = ReturnType<typeof useGetSuggestedDocumentsSuspenseQuery>;

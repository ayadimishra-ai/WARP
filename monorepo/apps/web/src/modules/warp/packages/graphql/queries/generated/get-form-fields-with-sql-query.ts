 ...
 * });
 */
export function useGetFormFieldsWithSqlQueryQuery(baseOptions: Apollo.QueryHookOptions<Types.GetFormFieldsWithSqlQueryQuery, Types.GetFormFieldsWithSqlQueryQueryVariables> & ({ variables: Types.GetFormFieldsWithSqlQueryQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetFormFieldsWithSqlQuerySuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetFormFieldsWithSqlQueryQuery, Types.GetFormFieldsWithSqlQueryQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetFormFieldsWithSqlQueryQuery, Types.GetFormFieldsWithSqlQueryQueryVariables>;
export function useGetFormFieldsWithSqlQuerySuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetFormFieldsWithSqlQueryQuery, Types.GetFormFieldsWithSqlQueryQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetFormFieldsWithSqlQueryQuery | undefined, Types.GetFormFieldsWithSqlQueryQueryVariables>;
export function useGetFormFieldsWithSqlQuerySuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetFormFieldsWithSqlQueryQuery, Types.GetFormFieldsWithSqlQueryQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetFormFieldsWithSqlQueryQuery, Types.GetFormFieldsWithSqlQueryQueryVariables>(GetFormFieldsWithSqlQueryDocument, options);
        }
...
export type GetFormFieldsWithSqlQuerySuspenseQueryHookResult = ReturnType<typeof useGetFormFieldsWithSqlQuerySuspenseQuery>;

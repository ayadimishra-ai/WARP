 ...
 * });
 */
export function useGetConsultantDataByFormIdQuery(baseOptions: Apollo.QueryHookOptions<Types.GetConsultantDataByFormIdQuery, Types.GetConsultantDataByFormIdQueryVariables> & ({ variables: Types.GetConsultantDataByFormIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
// @ts-ignore
export function useGetConsultantDataByFormIdSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetConsultantDataByFormIdQuery, Types.GetConsultantDataByFormIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetConsultantDataByFormIdQuery, Types.GetConsultantDataByFormIdQueryVariables>;
export function useGetConsultantDataByFormIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetConsultantDataByFormIdQuery, Types.GetConsultantDataByFormIdQueryVariables>): Apollo.UseSuspenseQueryResult<Types.GetConsultantDataByFormIdQuery | undefined, Types.GetConsultantDataByFormIdQueryVariables>;
export function useGetConsultantDataByFormIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetConsultantDataByFormIdQuery, Types.GetConsultantDataByFormIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetConsultantDataByFormIdQuery, Types.GetConsultantDataByFormIdQueryVariables>(GetConsultantDataByFormIdDocument, options);
        }
...
export type GetConsultantDataByFormIdSuspenseQueryHookResult = ReturnType<typeof useGetConsultantDataByFormIdSuspenseQuery>;

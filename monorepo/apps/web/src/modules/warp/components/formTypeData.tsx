...
const SelectedMultipleDropdownData = {
  fieldOptions: {
    required: false,
    enable: true,
    readonly: false,
...
export {
  ...
  DividerData,
  FileData,
  FixedQuestionTableData,
  GroupDetailsData,
  GroupGridRowData,
  GroupWizardData,
  GroupWizardData2,
  InputAutoCompleteData,
  InputAutoCompleteDataApi,
  InputRichTextData,
  inputTextData,
  LinksData,
  MultiLineData,
  ...
  RadioData,
  SelectDropdownData,
  SelectedMultipleDropdownData,
  SelectMultipleDropdownData,
  SliderData,
  TagsData,
  ToggleData,
};

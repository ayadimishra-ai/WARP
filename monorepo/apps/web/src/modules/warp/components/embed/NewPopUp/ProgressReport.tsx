...
import { RecommendationListionPageMessage } from "@/modules/warp/packages/client/services/platform-window-message.service";
import { useGetProgressReportbySubmissionIdQuery } from "@/modules/warp/packages/graphql/queries/generated/get-progress-report-by-submissionId";
import { RecommendationStatus } from "@/modules/warp/packages/shared/constants/app.constants";
...
const Chart = dynamic(
  () => import("@/modules/warp/packages/client/components/charts/ProgressReportChart"),
  {
    ssr: false, // Optional: Disable server-side rendering
    // loading: () => (
    //   <Flex h="250px" justify="center" align="center">
  ...
  return isLoading === true ? (
    ...
    <Stack>
      <Flex gap="sm" align="center">
        <Text fz={14} c="#444444" fw={400} lh="17.75px">
          Requested{" "}
      ...
      >
        <Flex align="center" gap={4}>
          <Text fz={16} fw={400} c="#122f47" lh={"20.29px"}>
            Recommendations -
          </Text>
          <Text fz={16} fw={600} c="#122f47" lh={"20.29px"}>
            {
              listingData?.filter(

...
import { isURLValid } from "@/modules/warp/packages/client/features/form/common-functions";
import AlertIcon from "@/modules/warp/packages/client/icons/AlertIcon";
import AlertInfoIcon from "@/modules/warp/packages/client/icons/AlertInfoIcon";
import DropzoneUploadIcon from "@/modules/warp/packages/client/icons/DropzoneUploadIcon";
import SparkleDropzoneIcon from "@/modules/warp/packages/client/icons/SparkleDropzoneIcon";
...
import { formatFileSize } from "@/modules/warp/packages/shared/utils/custom-error.util";
...
const CustomDropzone: React.FC<DropzoneCardProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Box px={18}>
          ...
          >
            ...
            {raraResponse && (
              <Box pos="absolute" top={131} style={{ cursor: "pointer" }}>
                <RatingSummaryBlock
            ...
            {!!files && files.length > 0 ? (
              <Box pos="absolute" top={160} left={0} right={0}>
                {rejectionMessage &&
                uploadStatus !== DropzoneStatus.ProcessingError ? (
                  <Text
                    style={{
                ...
                {(!rejectionMessage ||
                  uploadStatus === DropzoneStatus.ProcessingError) && (
                  <Text c="#838B8F" fz="12px" lh="18px" ta="center">
                  ...
                  uploadStatus !== DropzoneStatus.ProcessingError ? (
                    ...
                    >
                      <Tooltip
                        ...
                        closeDelay={50}
                      >
                        <Text c="#FC4E4E" fz="12px" lh="18px" ta="center" py={5}>
                          {errorTitle}
      ...
      {/* <Center pos="absolute" right={0} bottom="83px" left={0}>
        {!!files && files.length > 0 && (
          <>
            {raraMessage && (
              <InfoItem
      ...
      <Center pos="absolute" left={0} right={0} top={208} h={36}>
        ...
        {isChatSubscriptionActive &&
          ...
          !isSystemGenerated && (
            <Button
              color="aiGradientBtn"
              leftSection={<SparkleGradientIcon />}

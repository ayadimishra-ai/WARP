...
import { InsertRecommendationMutationVariables } from "@/modules/warp/packages/graphql/generated/types";
import { useInsertRecommendationMutation } from "@/modules/warp/packages/graphql/mutations/generated/insert-recommendation";
import { useUpdateFormInvitationInterimCheckByIdMutation } from "@/modules/warp/packages/graphql/mutations/generated/update-formInvitation-interimCheck-byId";
import { useGetFormInvitationDetailsbyIdQuery } from "@/modules/warp/packages/graphql/queries/generated/get-form-invitation-details-by-id";
      ...
      if (resultInterimAnswer) {
        ...
        if (
          ...
          const newRecommendationEmailResponse = await fetch(
            "/warp/api/recommendation/email-on-manually-raising-the-recommendations",
            {
              method: "POST",
              headers: {

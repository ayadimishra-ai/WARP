...
import SendPaperPlaneIcon from "@/modules/warp/packages/client/icons/SendPaperPlaneIcon";
import {
  AI_DATA_SOURCES,
  type AIDataSource
...
const ChatInputSection: React.FC<ChatInputSectionProps> = ({
  ...
  return (
    <Box mx={30} style={{ position: "relative" }}>
      {/* Error Alert */}
      {error && (
        <Alert
          color="red"
      ...
      <Box style={{ position: "relative" }} className="aiChatInputSection">
        <Card
          bg="#fff"
          px={0}
          ...
          >
            ...
            {(availableDataSources?.length ?? 0) > 0 && (
              <Flex align="center" gap={5} mt={4}>
                <Text fz={smallScreen ? 12 : 14} c="#626262" fw={500}>
                  Data Source:
                </Text>
            ...
            <Flex gap={15} align="center">
              <Flex align="center" gap="sm">
                ...
                <Switch
                  ...
                  styles={{
                    track: {
                      background: graphicalToggleState.checked
                        ? "#003b52"
                        : undefined
                    },
                    thumb: {

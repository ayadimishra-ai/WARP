...
import { getUserContext } from "@/modules/warp/packages/client/features/form/common-functions";
...
import { useChatAI } from "@/modules/warp/hooks/use-chat-ai";
import {
  clearActiveConversationId,
  getActiveConversationId,
  setActiveConversationId,
} from "@/modules/warp/utils/session-storage.utils";
  ...
  return (
    <Flex direction="column" className="aiChatModuleClass" h="100vh">
      ...
      {isMainLoading ? (
        ...
        <Flex h="calc(100vh - 68px)" style={{ flex: 1, zIndex: 4 }}>
          {/* Side Panel */}
          <Box
            pos="relative"
          ...
          >
            ...
            <Box p="0 30px" style={{ flex: 1, overflow: "hidden" }}>

...
import { isDocumentExpired } from "@/modules/warp/packages/client/features/form/common-functions";
import {
  useUploadFilesPopup,
  type TableData
} from "@/modules/warp/packages/client/hooks/useUploadFilesPopup";
import UploadIcon from "@/modules/warp/packages/client/icons/UploadIcon";
...
const UploadFilesPopup = () => {
  ...
  const table = useMantineReactTable({
    ...
    renderEmptyRowsFallback: () => (
      <tr className="no-records" style={{ backgroundColor: "#ffffff" }}>
        <td colSpan={columns.length} style={{ backgroundColor: "#ffffff" }}>
          <Center p="md" h="200px">
            <Text c="dimmed" fz="sm">

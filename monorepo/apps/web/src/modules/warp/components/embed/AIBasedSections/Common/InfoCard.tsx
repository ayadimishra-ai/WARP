...
const InfoCard = ({
  ...
  return (
    <SimpleGrid
      ...
      spacing={{ base: "xl", md: gridSpacing }}
      verticalSpacing={{ base: "xl", md: gridSpacing }}
    >
      {!!data && data.length > 0 ? (
        data.map((card, index) => (
          <Card
          ...
          >
            <InfoItem
              ...
              whiteSpace
            />
            <Text c="#444444" fz="36px" lh="45.65px" fw="500" ta="center">
              {card.value}
            </Text>
            <Text c="#444444" fz="10px" lh="12.68px" fw="700" ta="center">

...
import { capitalize } from "@/modules/warp/packages/client/features/form/common-functions";
import ExportButtonIcon from "@/modules/warp/packages/client/icons/ExportButtonIcon";
import LinkIcon from "@/modules/warp/packages/client/icons/LinkIcon";
import {
  DOCUMENT_TYPE_COLORS,
  getDocumentTypeLabel,
  getSourceColor,
} from "@/modules/warp/packages/shared/constants/ai.constants";
import { AI_DATA_SOURCES } from "@/modules/warp/packages/shared/constants/app.constants";
import {
  AIResponseProps,
  DocumentType,
    ...
    >
      {hasActualResponse && (
        <Flex align="center" justify="space-between" mb="xs" pl={5}>
          ...
          >
            <Menu.Target>
              <Button color="solidBtn" leftSection={<ExportButtonIcon />}>
                Export
              </Button>
            </Menu.Target>
            <Menu.Dropdown>
        ...
        sources.length > 0 && (
          <Box>
            <Flex align="center" gap={20} mb={10}>
              <Text fz={smallScreen ? 14 : 16} fw={400} c="#003B52">
                Source References
              </Text>

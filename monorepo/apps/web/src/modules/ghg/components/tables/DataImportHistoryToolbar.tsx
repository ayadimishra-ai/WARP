...
import CheckboxMultiSelect from "@/app/ghg//[organizationId]/embed/v1/[accessToken]/data-log-summary/CheckboxMultiSelect";
import {
  getUserRoleFromToken,
  ROLE_ORGANIZATION_ADMIN,
} from "@/modules/ghg/utils/jwt/getUserDataFromToken";
import {
  opRedirectToProductshareTemplate,
  postParentMessage,
          ...
          >
            <ActionIcon
              ...
              onClick={
                !initialActivityCode
                  ? undefined
                  : initialActivityCode === "product_share_allocation"
                  ? () => postParentMessage(opRedirectToProductshareTemplate())
                  : onDownloadTemplate
              }

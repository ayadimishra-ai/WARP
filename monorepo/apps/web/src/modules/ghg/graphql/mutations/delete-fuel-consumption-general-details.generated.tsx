...
`;
export type DeleteFuelConsumptionGeneralDetailsMutationFn =
  Apollo.MutationFunction<
    DeleteFuelConsumptionGeneralDetailsMutation,
    DeleteFuelConsumptionGeneralDetailsMutationVariables
  >;
 ...
 * });
 */
export function useDeleteFuelConsumptionGeneralDetailsMutation(
  ...
  return Apollo.useMutation<
    DeleteFuelConsumptionGeneralDetailsMutation,
    DeleteFuelConsumptionGeneralDetailsMutationVariables
  >(DeleteFuelConsumptionGeneralDetailsDocument, options);
}
export type DeleteFuelConsumptionGeneralDetailsMutationHookResult = ReturnType<
  typeof useDeleteFuelConsumptionGeneralDetailsMutation
>;
export type DeleteFuelConsumptionGeneralDetailsMutationResult =
  Apollo.MutationResult<DeleteFuelConsumptionGeneralDetailsMutation>;
export type DeleteFuelConsumptionGeneralDetailsMutationOptions =

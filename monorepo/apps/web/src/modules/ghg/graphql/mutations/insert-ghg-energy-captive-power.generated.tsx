...
export type InsertGhgEnergyCaptivePowerMutationVariables = Types.Exact<{
  insertData:
    | Array<Types.GhgEnergy_CaptivePower_Insert_Input>
    | Types.GhgEnergy_CaptivePower_Insert_Input;
}>;

export type InsertGhgEnergyCaptivePowerMutation = {
...
export const InsertGhgEnergyCaptivePowerDocument = gql`
  mutation insertGHGEnergyCaptivePower(
    $insertData: [GHGEnergy_CaptivePower_insert_input!]!
  ) {
    insert_GHGEnergy_CaptivePower(
      objects: $insertData
...
`;
export type InsertGhgEnergyCaptivePowerMutationFn = Apollo.MutationFunction<
  InsertGhgEnergyCaptivePowerMutation,
  InsertGhgEnergyCaptivePowerMutationVariables
>;
 ...
 * });
 */
export function useInsertGhgEnergyCaptivePowerMutation(
  ...
  return Apollo.useMutation<
    InsertGhgEnergyCaptivePowerMutation,
    InsertGhgEnergyCaptivePowerMutationVariables
  >(InsertGhgEnergyCaptivePowerDocument, options);
}
export type InsertGhgEnergyCaptivePowerMutationHookResult = ReturnType<
  typeof useInsertGhgEnergyCaptivePowerMutation
>;
export type InsertGhgEnergyCaptivePowerMutationResult =
  Apollo.MutationResult<InsertGhgEnergyCaptivePowerMutation>;
export type InsertGhgEnergyCaptivePowerMutationOptions =

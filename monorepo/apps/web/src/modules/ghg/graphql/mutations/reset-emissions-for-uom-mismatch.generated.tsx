...
export type ResetEmissionsForUoMMismatchMutation = {
  __typename?: "mutation_root";
  resetCapitalGoods?: Array<{
    __typename?: "GHGCapital_Goods_mutation_response";
    returning: Array<{
      __typename?: "GHGCapital_Goods";
      id: any;
      Material_Code?: string | null;
      kpi_em_EmissionBy_CapitalGoods?: any | null;
      kpi_emf_EmissionBy_CapitalGoods?: any | null;
      updated_at: any;
    }>;
  } | null> | null;
  resetMaterialProcurement?: Array<{
...
export const ResetEmissionsForUoMMismatchDocument = gql`
  mutation resetEmissionsForUoMMismatch(
    ...
    resetCapitalGoods: update_GHGCapital_Goods_many(
      updates: $capitalGoodsUpdates
    ) {
      returning {
        id
        Material_Code
...
`;
export type ResetEmissionsForUoMMismatchMutationFn = Apollo.MutationFunction<
  ResetEmissionsForUoMMismatchMutation,
  ResetEmissionsForUoMMismatchMutationVariables
>;
 ...
 * });
 */
export function useResetEmissionsForUoMMismatchMutation(
  ...
  return Apollo.useMutation<
    ResetEmissionsForUoMMismatchMutation,
    ResetEmissionsForUoMMismatchMutationVariables
  >(ResetEmissionsForUoMMismatchDocument, options);
}
export type ResetEmissionsForUoMMismatchMutationHookResult = ReturnType<
  typeof useResetEmissionsForUoMMismatchMutation
>;
export type ResetEmissionsForUoMMismatchMutationResult =
  Apollo.MutationResult<ResetEmissionsForUoMMismatchMutation>;
export type ResetEmissionsForUoMMismatchMutationOptions =

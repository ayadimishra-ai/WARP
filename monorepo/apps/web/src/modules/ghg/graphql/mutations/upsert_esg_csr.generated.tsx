...
export type UpsertEsg_Csr_ActivityMutation = {
  __typename?: "mutation_root";
  delete_ESGCSR?: {
    __typename?: "ESGCSR_mutation_response";
    returning: Array<{
      __typename?: "ESGCSR";
      id: any;
      task_request_id: any;
      ...
      number_of_beneficiaries_impact_created?: any | null;
      target_beneficiary_group_impact_category?: string | null;
      related_sdgs?: string | null;
      annual_spend_on_the_project?: any | null;
      target_specified_in_terms_of_impact_beneficiaries?: any | null;
      funds_earmarked_for_the_project_for_the_year?: number | null;
...
export const UpsertEsg_Csr_ActivityDocument = gql`
  mutation upsertESG_CSR_Activity(
    $where: ESGCSR_bool_exp!
    $esgcsr: [ESGCSR_insert_input!]!
  ) {
...
`;
export type UpsertEsg_Csr_ActivityMutationFn = Apollo.MutationFunction<
  UpsertEsg_Csr_ActivityMutation,
  UpsertEsg_Csr_ActivityMutationVariables
>;
 ...
 * });
 */
export function useUpsertEsg_Csr_ActivityMutation(
  ...
  return Apollo.useMutation<
    UpsertEsg_Csr_ActivityMutation,
    UpsertEsg_Csr_ActivityMutationVariables
  >(UpsertEsg_Csr_ActivityDocument, options);
}
export type UpsertEsg_Csr_ActivityMutationHookResult = ReturnType<
  typeof useUpsertEsg_Csr_ActivityMutation
>;
export type UpsertEsg_Csr_ActivityMutationResult =
  Apollo.MutationResult<UpsertEsg_Csr_ActivityMutation>;
export type UpsertEsg_Csr_ActivityMutationOptions = Apollo.BaseMutationOptions<
  UpsertEsg_Csr_ActivityMutation,
  UpsertEsg_Csr_ActivityMutationVariables
>;

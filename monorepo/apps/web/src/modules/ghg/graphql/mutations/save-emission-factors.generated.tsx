...
export type SaveemissonFactorDataMutationVariables = Types.Exact<{
  ...
  updateData:
    | Array<Types.Co2EmissionFactorMaster_Updates>
    | Types.Co2EmissionFactorMaster_Updates;
}>;

export type SaveemissonFactorDataMutation = {
  ...
  update_CO2EmissionFactorMaster_many?: Array<{
    __typename?: "CO2EmissionFactorMaster_mutation_response";
    returning: Array<{
      __typename?: "CO2EmissionFactorMaster";
      id: any;
...
export const SaveemissonFactorDataDocument = gql`
  mutation saveemissonFactorData(
    $insertData: [CO2EmissionFactorMaster_insert_input!]!
    $updateData: [CO2EmissionFactorMaster_updates!]!
  ) {
    insert_CO2EmissionFactorMaster(
...
`;
export type SaveemissonFactorDataMutationFn = Apollo.MutationFunction<
  SaveemissonFactorDataMutation,
  SaveemissonFactorDataMutationVariables
>;
 ...
 * });
 */
export function useSaveemissonFactorDataMutation(
  ...
  return Apollo.useMutation<
    SaveemissonFactorDataMutation,
    SaveemissonFactorDataMutationVariables
  >(SaveemissonFactorDataDocument, options);
}
export type SaveemissonFactorDataMutationHookResult = ReturnType<
  typeof useSaveemissonFactorDataMutation
>;
export type SaveemissonFactorDataMutationResult =
  Apollo.MutationResult<SaveemissonFactorDataMutation>;
export type SaveemissonFactorDataMutationOptions = Apollo.BaseMutationOptions<
  SaveemissonFactorDataMutation,
  SaveemissonFactorDataMutationVariables
>;

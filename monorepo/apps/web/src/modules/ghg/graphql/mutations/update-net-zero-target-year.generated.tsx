...
export type UpdateNetZeroTargetYearMutation = {
...
`;
export type UpdateNetZeroTargetYearMutationFn = Apollo.MutationFunction<
  UpdateNetZeroTargetYearMutation,
  UpdateNetZeroTargetYearMutationVariables
>;
 ...
 * });
 */
export function useUpdateNetZeroTargetYearMutation(
  ...
  return Apollo.useMutation<
    UpdateNetZeroTargetYearMutation,
    UpdateNetZeroTargetYearMutationVariables
  >(UpdateNetZeroTargetYearDocument, options);
}
export type UpdateNetZeroTargetYearMutationHookResult = ReturnType<
  typeof useUpdateNetZeroTargetYearMutation
>;
export type UpdateNetZeroTargetYearMutationResult =
  Apollo.MutationResult<UpdateNetZeroTargetYearMutation>;
export type UpdateNetZeroTargetYearMutationOptions = Apollo.BaseMutationOptions<
  UpdateNetZeroTargetYearMutation,
  UpdateNetZeroTargetYearMutationVariables
>;

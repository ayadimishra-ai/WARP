...
export type InsertAddressesMutation = {
...
`;
export type InsertAddressesMutationFn = Apollo.MutationFunction<
  InsertAddressesMutation,
  InsertAddressesMutationVariables
>;
 ...
 * });
 */
export function useInsertAddressesMutation(
  ...
  return Apollo.useMutation<
    InsertAddressesMutation,
    InsertAddressesMutationVariables
  >(InsertAddressesDocument, options);
}
export type InsertAddressesMutationHookResult = ReturnType<
  typeof useInsertAddressesMutation
>;
export type InsertAddressesMutationResult =
  Apollo.MutationResult<InsertAddressesMutation>;
export type InsertAddressesMutationOptions = Apollo.BaseMutationOptions<
  InsertAddressesMutation,
  InsertAddressesMutationVariables
>;

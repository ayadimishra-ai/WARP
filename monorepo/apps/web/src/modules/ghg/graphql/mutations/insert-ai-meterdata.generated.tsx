...
export type InsertMeterDataMutation = {
...
`;
export type InsertMeterDataMutationFn = Apollo.MutationFunction<
  InsertMeterDataMutation,
  InsertMeterDataMutationVariables
>;
 ...
 * });
 */
export function useInsertMeterDataMutation(
  ...
  return Apollo.useMutation<
    InsertMeterDataMutation,
    InsertMeterDataMutationVariables
  >(InsertMeterDataDocument, options);
}
export type InsertMeterDataMutationHookResult = ReturnType<
  typeof useInsertMeterDataMutation
>;
export type InsertMeterDataMutationResult =
  Apollo.MutationResult<InsertMeterDataMutation>;
export type InsertMeterDataMutationOptions = Apollo.BaseMutationOptions<
  InsertMeterDataMutation,
  InsertMeterDataMutationVariables
>;

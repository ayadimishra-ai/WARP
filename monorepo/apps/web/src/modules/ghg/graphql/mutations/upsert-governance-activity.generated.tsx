...
export type UpsertEsgGovernanceActivityMutationVariables = Types.Exact<{
  ...
  esgGovernanceData:
    | Array<Types.EsgGovernance_Insert_Input>
    | Types.EsgGovernance_Insert_Input;
}>;

export type UpsertEsgGovernanceActivityMutation = {
  __typename?: "mutation_root";
  delete_ESGGovernance?: {
    __typename?: "ESGGovernance_mutation_response";
    returning: Array<{
      __typename?: "ESGGovernance";
      id: any;
      task_request_id: any;
      ...
      total_number_of_issues?: number | null;
...
export const UpsertEsgGovernanceActivityDocument = gql`
  mutation upsertESGGovernanceActivity(
    $where: ESGGovernance_bool_exp!
    $esgGovernanceData: [ESGGovernance_insert_input!]!
  ) {
...
`;
export type UpsertEsgGovernanceActivityMutationFn = Apollo.MutationFunction<
  UpsertEsgGovernanceActivityMutation,
  UpsertEsgGovernanceActivityMutationVariables
>;
 ...
 * });
 */
export function useUpsertEsgGovernanceActivityMutation(
  ...
  return Apollo.useMutation<
    UpsertEsgGovernanceActivityMutation,
    UpsertEsgGovernanceActivityMutationVariables
  >(UpsertEsgGovernanceActivityDocument, options);
}
export type UpsertEsgGovernanceActivityMutationHookResult = ReturnType<
  typeof useUpsertEsgGovernanceActivityMutation
>;
export type UpsertEsgGovernanceActivityMutationResult =
  Apollo.MutationResult<UpsertEsgGovernanceActivityMutation>;
export type UpsertEsgGovernanceActivityMutationOptions =

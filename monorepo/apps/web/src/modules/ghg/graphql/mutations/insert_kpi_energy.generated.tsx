...
export type InsertKpiEnergyMutationVariables = Types.Exact<{
  kpienergydata:
    | Array<Types.KpiEnergy_Insert_Input>
    | Types.KpiEnergy_Insert_Input;
  deletekpienergydata: Types.KpiEnergy_Bool_Exp;
}>;

export type InsertKpiEnergyMutation = {
...
export const InsertKpiEnergyDocument = gql`
  mutation insertKPIEnergy(
    $kpienergydata: [KPIEnergy_insert_input!]!
    $deletekpienergydata: KPIEnergy_bool_exp!
  ) {
...
`;
export type InsertKpiEnergyMutationFn = Apollo.MutationFunction<
  InsertKpiEnergyMutation,
  InsertKpiEnergyMutationVariables
>;
 ...
 * });
 */
export function useInsertKpiEnergyMutation(
  ...
  return Apollo.useMutation<
    InsertKpiEnergyMutation,
    InsertKpiEnergyMutationVariables
  >(InsertKpiEnergyDocument, options);
}
export type InsertKpiEnergyMutationHookResult = ReturnType<
  typeof useInsertKpiEnergyMutation
>;
export type InsertKpiEnergyMutationResult =
  Apollo.MutationResult<InsertKpiEnergyMutation>;
export type InsertKpiEnergyMutationOptions = Apollo.BaseMutationOptions<
  InsertKpiEnergyMutation,
  InsertKpiEnergyMutationVariables
>;

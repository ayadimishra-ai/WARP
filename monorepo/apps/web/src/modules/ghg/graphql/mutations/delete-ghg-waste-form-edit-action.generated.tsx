...
export type DeleteGhgWasteFormEditActionMutation = {
...
`;
export type DeleteGhgWasteFormEditActionMutationFn = Apollo.MutationFunction<
  DeleteGhgWasteFormEditActionMutation,
  DeleteGhgWasteFormEditActionMutationVariables
>;
 ...
 * });
 */
export function useDeleteGhgWasteFormEditActionMutation(
  ...
  return Apollo.useMutation<
    DeleteGhgWasteFormEditActionMutation,
    DeleteGhgWasteFormEditActionMutationVariables
  >(DeleteGhgWasteFormEditActionDocument, options);
}
export type DeleteGhgWasteFormEditActionMutationHookResult = ReturnType<
  typeof useDeleteGhgWasteFormEditActionMutation
>;
export type DeleteGhgWasteFormEditActionMutationResult =
  Apollo.MutationResult<DeleteGhgWasteFormEditActionMutation>;
export type DeleteGhgWasteFormEditActionMutationOptions =

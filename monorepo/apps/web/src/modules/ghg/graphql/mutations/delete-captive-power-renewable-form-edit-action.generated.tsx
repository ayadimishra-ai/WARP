...
export type DeleteCaptivePowerRenewableFormEditActionMutationVariables =
  Types.Exact<{
...
`;
export type DeleteCaptivePowerRenewableFormEditActionMutationFn =
  Apollo.MutationFunction<
    DeleteCaptivePowerRenewableFormEditActionMutation,
    DeleteCaptivePowerRenewableFormEditActionMutationVariables
  >;
 ...
 * });
 */
export function useDeleteCaptivePowerRenewableFormEditActionMutation(
  ...
  return Apollo.useMutation<
    DeleteCaptivePowerRenewableFormEditActionMutation,
    DeleteCaptivePowerRenewableFormEditActionMutationVariables
  >(DeleteCaptivePowerRenewableFormEditActionDocument, options);
}
export type DeleteCaptivePowerRenewableFormEditActionMutationHookResult =
  ReturnType<typeof useDeleteCaptivePowerRenewableFormEditActionMutation>;
export type DeleteCaptivePowerRenewableFormEditActionMutationResult =
  Apollo.MutationResult<DeleteCaptivePowerRenewableFormEditActionMutation>;
export type DeleteCaptivePowerRenewableFormEditActionMutationOptions =

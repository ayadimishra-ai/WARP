...
export type UpsertGhgWasteWaterActivityMutationVariables = Types.Exact<{
  ...
  ghgWasteWaterData:
    | Array<Types.GhgWasteWater_Insert_Input>
    | Types.GhgWasteWater_Insert_Input;
}>;

export type UpsertGhgWasteWaterActivityMutation = {
  __typename?: "mutation_root";
  delete_GHGWasteWater?: {
    __typename?: "GHGWasteWater_mutation_response";
    returning: Array<{
      __typename?: "GHGWasteWater";
      id: any;
      ...
      created_by?: any | null;
      updated_by?: any | null;
      total_treated_effluent_reused_for_domestic_use?: any | null;
      total_treated_effluent_reused_for_industrial_use?: any | null;
      total_treated_effluent_reused_for_landscaping?: any | null;
      total_treated_effluent_used_for_miscellaneous_uses?: any | null;
...
export const UpsertGhgWasteWaterActivityDocument = gql`
  mutation upsertGHGWasteWaterActivity(
    $where: GHGWasteWater_bool_exp!
    $ghgWasteWaterData: [GHGWasteWater_insert_input!]!
  ) {
...
`;
export type UpsertGhgWasteWaterActivityMutationFn = Apollo.MutationFunction<
  UpsertGhgWasteWaterActivityMutation,
  UpsertGhgWasteWaterActivityMutationVariables
>;
 ...
 * });
 */
export function useUpsertGhgWasteWaterActivityMutation(
  ...
  return Apollo.useMutation<
    UpsertGhgWasteWaterActivityMutation,
    UpsertGhgWasteWaterActivityMutationVariables
  >(UpsertGhgWasteWaterActivityDocument, options);
}
export type UpsertGhgWasteWaterActivityMutationHookResult = ReturnType<
  typeof useUpsertGhgWasteWaterActivityMutation
>;
export type UpsertGhgWasteWaterActivityMutationResult =
  Apollo.MutationResult<UpsertGhgWasteWaterActivityMutation>;
export type UpsertGhgWasteWaterActivityMutationOptions =

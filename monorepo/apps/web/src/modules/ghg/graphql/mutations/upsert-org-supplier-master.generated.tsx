...
export type UpsertOrgSupplierMasterMutationVariables = Types.Exact<{
  ...
  updates:
    | Array<Types.OrgSupplierMaster_Updates>
    | Types.OrgSupplierMaster_Updates;
}>;

export type UpsertOrgSupplierMasterMutation = {
  ...
  insert_OrgSupplierMaster?: {
    ...
    returning: Array<{
      ...
      onboarding_date?: any | null;
      supplier_gst_or_license_number?: string | null;
      metadata?: any | null;
    }>;
  } | null;
  update_OrgSupplierMaster_many?: Array<{
    __typename?: "OrgSupplierMaster_mutation_response";
    returning: Array<{
      __typename?: "OrgSupplierMaster";
      id: any;
...
`;
export type UpsertOrgSupplierMasterMutationFn = Apollo.MutationFunction<
  UpsertOrgSupplierMasterMutation,
  UpsertOrgSupplierMasterMutationVariables
>;
 ...
 * });
 */
export function useUpsertOrgSupplierMasterMutation(
  ...
  return Apollo.useMutation<
    UpsertOrgSupplierMasterMutation,
    UpsertOrgSupplierMasterMutationVariables
  >(UpsertOrgSupplierMasterDocument, options);
}
export type UpsertOrgSupplierMasterMutationHookResult = ReturnType<
  typeof useUpsertOrgSupplierMasterMutation
>;
export type UpsertOrgSupplierMasterMutationResult =
  Apollo.MutationResult<UpsertOrgSupplierMasterMutation>;
export type UpsertOrgSupplierMasterMutationOptions = Apollo.BaseMutationOptions<
  UpsertOrgSupplierMasterMutation,
  UpsertOrgSupplierMasterMutationVariables
>;

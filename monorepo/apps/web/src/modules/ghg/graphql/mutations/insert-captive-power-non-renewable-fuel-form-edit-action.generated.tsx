...
export type InsertCaptivePowerNonRenewableFuelFormEditActionMutationVariables =
  Types.Exact<{
...
export const InsertCaptivePowerNonRenewableFuelFormEditActionDocument = gql`
  mutation insertCaptivePowerNonRenewableFuelFormEditAction(
    $insertData: GHGEnergy_CaptivePower_NonRenewable_insert_input!
  ) {
    insert_GHGEnergy_CaptivePower_NonRenewable_one(
      object: $insertData
      on_conflict: {
        constraint: GHGEnergy_CaptivePower_NonRenewable_pkey
        update_columns: [
          Type_of_Fuel_Used
...
`;
export type InsertCaptivePowerNonRenewableFuelFormEditActionMutationFn =
  Apollo.MutationFunction<
    InsertCaptivePowerNonRenewableFuelFormEditActionMutation,
    InsertCaptivePowerNonRenewableFuelFormEditActionMutationVariables
  >;
 ...
 * });
 */
export function useInsertCaptivePowerNonRenewableFuelFormEditActionMutation(
  ...
  return Apollo.useMutation<
    InsertCaptivePowerNonRenewableFuelFormEditActionMutation,
    InsertCaptivePowerNonRenewableFuelFormEditActionMutationVariables
  >(InsertCaptivePowerNonRenewableFuelFormEditActionDocument, options);
}
export type InsertCaptivePowerNonRenewableFuelFormEditActionMutationHookResult =
  ReturnType<
    typeof useInsertCaptivePowerNonRenewableFuelFormEditActionMutation
  >;
export type InsertCaptivePowerNonRenewableFuelFormEditActionMutationResult =
  Apollo.MutationResult<InsertCaptivePowerNonRenewableFuelFormEditActionMutation>;
export type InsertCaptivePowerNonRenewableFuelFormEditActionMutationOptions =

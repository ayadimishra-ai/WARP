...
export type InsertGhgTransportUpstreamDetailsMutationVariables = Types.Exact<{
  ...
  input:
    | Array<Types.GhgTransport_Upstream_Insert_Input>
    | Types.GhgTransport_Upstream_Insert_Input;
  addressInput:
    | Array<Types.TravelDistance_Insert_Input>
    | Types.TravelDistance_Insert_Input;
}>;

export type InsertGhgTransportUpstreamDetailsMutation = {
...
export const InsertGhgTransportUpstreamDetailsDocument = gql`
  mutation insertGHGTransportUpstreamDetails(
    $where: GHGTransport_Upstream_bool_exp!
    $input: [GHGTransport_Upstream_insert_input!]!
...
`;
export type InsertGhgTransportUpstreamDetailsMutationFn =
  Apollo.MutationFunction<
    InsertGhgTransportUpstreamDetailsMutation,
    InsertGhgTransportUpstreamDetailsMutationVariables
  >;
 ...
 * });
 */
export function useInsertGhgTransportUpstreamDetailsMutation(
  ...
  return Apollo.useMutation<
    InsertGhgTransportUpstreamDetailsMutation,
    InsertGhgTransportUpstreamDetailsMutationVariables
  >(InsertGhgTransportUpstreamDetailsDocument, options);
}
export type InsertGhgTransportUpstreamDetailsMutationHookResult = ReturnType<
  typeof useInsertGhgTransportUpstreamDetailsMutation
>;
export type InsertGhgTransportUpstreamDetailsMutationResult =
  Apollo.MutationResult<InsertGhgTransportUpstreamDetailsMutation>;
export type InsertGhgTransportUpstreamDetailsMutationOptions =

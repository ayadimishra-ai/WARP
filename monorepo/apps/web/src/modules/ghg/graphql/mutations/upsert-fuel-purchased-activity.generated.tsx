...
export type UpsertFuelPurchasedActivityMutationVariables = Types.Exact<{
  ...
  GHGEnergyConsumption_FuelPurchased_HeatingWater__id:
    ...
    | Types.Scalars["uuid"]["input"];
  Auxdata:
    | Array<Types.GhgEnergyConsumption_FuelPurchased_Auxiliary_Insert_Input>
    | Types.GhgEnergyConsumption_FuelPurchased_Auxiliary_Insert_Input;
  Generaldata:
    | Array<Types.GhgEnergyConsumption_FuelPurchased_General_Insert_Input>
    | Types.GhgEnergyConsumption_FuelPurchased_General_Insert_Input;
  HeatingWaterdata:
    | Array<Types.GhgEnergyConsumption_FuelPurchased_HeatingWater_Insert_Input>
    | Types.GhgEnergyConsumption_FuelPurchased_HeatingWater_Insert_Input;
}>;

export type UpsertFuelPurchasedActivityMutation = {
...
export const UpsertFuelPurchasedActivityDocument = gql`
  mutation upsertFuelPurchasedActivity(
    $GHGEnergyConsumption_FuelPurchased_General_id: [uuid!]!
    $GHGEnergyConsumption_FuelPurchased_Auxiliary_id: [uuid!]!
    $GHGEnergyConsumption_FuelPurchased_HeatingWater__id: [uuid!]!
    $Auxdata: [GHGEnergyConsumption_FuelPurchased_Auxiliary_insert_input!]!
    $Generaldata: [GHGEnergyConsumption_FuelPurchased_General_insert_input!]!
    $HeatingWaterdata: [GHGEnergyConsumption_FuelPurchased_HeatingWater_insert_input!]!
  ) {
    delete_GHGEnergyConsumption_FuelPurchased_General(
      where: {
        GHGEnergyConsumption_FuelPurchased_id: {
          _in: $GHGEnergyConsumption_FuelPurchased_General_id
        }
      }
    ) {
      returning {
    ...
    delete_GHGEnergyConsumption_FuelPurchased_HeatingWater(
      where: {
        GHGEnergyConsumption_FuelPurchased_id: {
          _in: $GHGEnergyConsumption_FuelPurchased_HeatingWater__id
        }
      }
    ) {
      returning {
    ...
    delete_GHGEnergyConsumption_FuelPurchased_Auxiliary(
      where: {
        GHGEnergyConsumption_FuelPurchased_id: {
          _in: $GHGEnergyConsumption_FuelPurchased_Auxiliary_id
        }
      }
    ) {
      returning {
    ...
    insert_GHGEnergyConsumption_FuelPurchased_Auxiliary(
      objects: $Auxdata
      on_conflict: {
        constraint: GHGEnergyConsumption_FuelPurchased_Auxiliary_pkey
      }
    ) {
      returning {
        id
    ...
    insert_GHGEnergyConsumption_FuelPurchased_General(
      objects: $Generaldata
      on_conflict: {
        constraint: GHGEnergyConsumption_FuelPurchased_General_pkey
      }
    ) {
      returning {
        id
    ...
    insert_GHGEnergyConsumption_FuelPurchased_HeatingWater(
      ...
      on_conflict: {
        constraint: GHGEnergyConsumption_FuelPurchased_HeatingWater_pkey
      }
    ) {
      returning {
        id
...
`;
export type UpsertFuelPurchasedActivityMutationFn = Apollo.MutationFunction<
  UpsertFuelPurchasedActivityMutation,
  UpsertFuelPurchasedActivityMutationVariables
>;
 ...
 * });
 */
export function useUpsertFuelPurchasedActivityMutation(
  ...
  return Apollo.useMutation<
    UpsertFuelPurchasedActivityMutation,
    UpsertFuelPurchasedActivityMutationVariables
  >(UpsertFuelPurchasedActivityDocument, options);
}
export type UpsertFuelPurchasedActivityMutationHookResult = ReturnType<
  typeof useUpsertFuelPurchasedActivityMutation
>;
export type UpsertFuelPurchasedActivityMutationResult =
  Apollo.MutationResult<UpsertFuelPurchasedActivityMutation>;
export type UpsertFuelPurchasedActivityMutationOptions =

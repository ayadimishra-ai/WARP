...
export type InsertkpiEmissionDashboardDataMutationVariables = Types.Exact<{
  kpiemissionbyfuelconsumptiondata:
    | Array<Types.KpiEmissionByFuelConsumption_Insert_Input>
    | Types.KpiEmissionByFuelConsumption_Insert_Input;
  kpiemissionbymaterialconsumptiondata:
    | Array<Types.KpiEmissionByMaterialConsumption_Insert_Input>
    | Types.KpiEmissionByMaterialConsumption_Insert_Input;
  kpiemissionbypowerconsumptiondata:
    | Array<Types.KpiEmissionByPowerConsumption_Insert_Input>
    | Types.KpiEmissionByPowerConsumption_Insert_Input;
  kpiemissionbytransportationdata:
    | Array<Types.KpiEmissionByTransportation_Insert_Input>
    | Types.KpiEmissionByTransportation_Insert_Input;
  kpiemissionbywastegenerationdata:
    | Array<Types.KpiEmissionByWasteGeneration_Insert_Input>
    | Types.KpiEmissionByWasteGeneration_Insert_Input;
  kpiemissionbyproducts:
    | Array<Types.KpiEmissionByProducts_Insert_Input>
    | Types.KpiEmissionByProducts_Insert_Input;
  kpiemissionbymaterialconsumptionsuppliers:
    | Array<Types.KpiEmissionByMaterialConsumption_Suppliers_Insert_Input>
    | Types.KpiEmissionByMaterialConsumption_Suppliers_Insert_Input;
  kpiemissionbypowerconsumptionvendors:
    | Array<Types.KpiEmissionByPowerConsumption_Vendors_Insert_Input>
    | Types.KpiEmissionByPowerConsumption_Vendors_Insert_Input;
  kpiEnergy: Array<Types.KpiEnergy_Insert_Input> | Types.KpiEnergy_Insert_Input;
  kpiWaterConsumption:
    | Array<Types.KpiWaterConsumption_Insert_Input>
    | Types.KpiWaterConsumption_Insert_Input;
  kpiFugitiveData:
    | Array<Types.KpiFugitiveGases_Insert_Input>
    | Types.KpiFugitiveGases_Insert_Input;
  kpiEmissionByCapitalGoodsSuppliers:
    | Array<Types.KpiEmissionByCapitalGoods_Suppliers_Insert_Input>
    | Types.KpiEmissionByCapitalGoods_Suppliers_Insert_Input;
  ...
  kpiEmissionByScope3:
    | Array<Types.KpiEmissionByScope3_Insert_Input>
    | Types.KpiEmissionByScope3_Insert_Input;
  ...
  kpiEmissionLifetimeSoldProductCategory11:
    | Array<Types.KpiEmissionLifetimeSoldProductCategory11_Insert_Input>
    | Types.KpiEmissionLifetimeSoldProductCategory11_Insert_Input;
}>;

export type InsertkpiEmissionDashboardDataMutation = {
  ...
  delete_KPIEmissionByFuelConsumption?: {
    ...
    returning: Array<{ __typename?: "KPIEmissionByFuelConsumption"; id: any }>;
  } | null;
  ...
  delete_KPIEmissionByMaterialConsumption?: {
    __typename?: "KPIEmissionByMaterialConsumption_mutation_response";
    returning: Array<{
  ...
  delete_KPIEmissionByPowerConsumption?: {
    __typename?: "KPIEmissionByPowerConsumption_mutation_response";
    returning: Array<{ __typename?: "KPIEmissionByPowerConsumption"; id: any }>;
  } | null;
  ...
  delete_KPIEmissionByTransportation?: {
    ...
    returning: Array<{ __typename?: "KPIEmissionByTransportation"; id: any }>;
  } | null;
  ...
  delete_KPIEmissionByWasteGeneration?: {
    __typename?: "KPIEmissionByWasteGeneration_mutation_response";
    returning: Array<{ __typename?: "KPIEmissionByWasteGeneration"; id: any }>;
  } | null;
  insert_KPIEmissionByWasteGeneration?: {
    __typename?: "KPIEmissionByWasteGeneration_mutation_response";
    returning: Array<{ __typename?: "KPIEmissionByWasteGeneration"; id: any }>;
  } | null;
  delete_KPIEmissionByProducts?: {
    __typename?: "KPIEmissionByProducts_mutation_response";
    returning: Array<{ __typename?: "KPIEmissionByProducts"; id: any }>;
  } | null;
  ...
  delete_KPIEmissionByPowerConsumption_Vendors?: {
    __typename?: "KPIEmissionByPowerConsumption_Vendors_mutation_response";
    returning: Array<{
      __typename?: "KPIEmissionByPowerConsumption_Vendors";
      id: any;
    }>;
  } | null;
  ...
  delete_KPIEnergy?: {
    ...
    returning: Array<{ __typename?: "KPIEnergy"; id: any }>;
  } | null;
  insert_KPIEnergy?: {
    __typename?: "KPIEnergy_mutation_response";
    returning: Array<{ __typename?: "KPIEnergy"; id: any }>;
  } | null;
  delete_KPIWaterConsumption?: {
    __typename?: "KPIWaterConsumption_mutation_response";
    returning: Array<{ __typename?: "KPIWaterConsumption"; id: any }>;
  } | null;
  insert_KPIWaterConsumption?: {
    __typename?: "KPIWaterConsumption_mutation_response";
    returning: Array<{ __typename?: "KPIWaterConsumption"; id: any }>;
  } | null;
  delete_KPIFugitiveGases?: {
    __typename?: "KPIFugitiveGases_mutation_response";
    returning: Array<{ __typename?: "KPIFugitiveGases"; id: any }>;
  } | null;
  ...
  delete_KPIEmissionByCapitalGoods_Suppliers?: {
    __typename?: "KPIEmissionByCapitalGoods_Suppliers_mutation_response";
    returning: Array<{
      __typename?: "KPIEmissionByCapitalGoods_Suppliers";
      id: any;
    }>;
  } | null;
  ...
  delete_KPIEmissionByScope3?: {
    __typename?: "KPIEmissionByScope3_mutation_response";
    returning: Array<{ __typename?: "KPIEmissionByScope3"; id: any }>;
  } | null;
  ...
  delete_KPIEmissionLifetimeSoldProductCategory11?: {
    ...
    returning: Array<{
      __typename?: "KPIEmissionLifetimeSoldProductCategory11";
      id: any;
    }>;
  } | null;
  insert_KPIEmissionLifetimeSoldProductCategory11?: {
    ...
    returning: Array<{
      ...
      year: any;
      month: any;
      kpi_em_Scope3_Category11_Total: any;
    }>;
  } | null;
};
...
export const InsertkpiEmissionDashboardDataDocument = gql`
  mutation insertkpiEmissionDashboardData(
    $kpiemissionbyfuelconsumptiondata: [KPIEmissionByFuelConsumption_insert_input!]!
    $kpiemissionbymaterialconsumptiondata: [KPIEmissionByMaterialConsumption_insert_input!]!
    $kpiemissionbypowerconsumptiondata: [KPIEmissionByPowerConsumption_insert_input!]!
    $kpiemissionbytransportationdata: [KPIEmissionByTransportation_insert_input!]!
    $kpiemissionbywastegenerationdata: [KPIEmissionByWasteGeneration_insert_input!]!
    $kpiemissionbyproducts: [KPIEmissionByProducts_insert_input!]!
    $kpiemissionbymaterialconsumptionsuppliers: [KPIEmissionByMaterialConsumption_Suppliers_insert_input!]!
    $kpiemissionbypowerconsumptionvendors: [KPIEmissionByPowerConsumption_Vendors_insert_input!]!
    $kpiEnergy: [KPIEnergy_insert_input!]!
    $kpiWaterConsumption: [KPIWaterConsumption_insert_input!]!
    $kpiFugitiveData: [KPIFugitiveGases_insert_input!]!
    $kpiEmissionByCapitalGoodsSuppliers: [KPIEmissionByCapitalGoods_Suppliers_insert_input!]!
    $deletekpiemissionbyfuelconsumptiondata: KPIEmissionByFuelConsumption_bool_exp!
    $deletekpiemissionbymaterialconsumptiondata: KPIEmissionByMaterialConsumption_bool_exp!
    $deletekpiemissionbypowerconsumptiondata: KPIEmissionByPowerConsumption_bool_exp!
    $deletekpiemissionbytransportationdata: KPIEmissionByTransportation_bool_exp!
    $deletekpiemissionbywastegenerationdata: KPIEmissionByWasteGeneration_bool_exp!
    $deletekpiemissionbyproducts: KPIEmissionByProducts_bool_exp!
    $deletekpiemissionbymaterialconsumptionsuppliers: KPIEmissionByMaterialConsumption_Suppliers_bool_exp!
    $deletekpiemissionbypowerconsumptionvendors: KPIEmissionByPowerConsumption_Vendors_bool_exp!
    $kpiwastemanagementdetails: [KPIWasteManagement_insert_input!]!
    $deletekpiwastemanagementdetails: KPIWasteManagement_bool_exp!
    $deleteKpiEnergy: KPIEnergy_bool_exp!
    $deleteKpiWaterConsumption: KPIWaterConsumption_bool_exp!
    $deleteKpiFugitiveData: KPIFugitiveGases_bool_exp!
    $deleteKpiEmissionByCapitalGoodsSuppliers: KPIEmissionByCapitalGoods_Suppliers_bool_exp!
    ...
    insert_KPIEmissionByMaterialConsumption_Suppliers(
      ...
      on_conflict: {
        constraint: KPIEmissionByMaterialConsumption_Suppliers_pkey
      }
    ) {
      returning {
        id
    ...
    insert_KPIEmissionLifetimeSoldProductCategory11(
      ...
      on_conflict: {
        constraint: KPIEmissionLifetimeSoldProductCategory11_pkey
        update_columns: [
...
`;
export type InsertkpiEmissionDashboardDataMutationFn = Apollo.MutationFunction<
  InsertkpiEmissionDashboardDataMutation,
  InsertkpiEmissionDashboardDataMutationVariables
>;
 ...
 * });
 */
export function useInsertkpiEmissionDashboardDataMutation(
  ...
  return Apollo.useMutation<
    InsertkpiEmissionDashboardDataMutation,
    InsertkpiEmissionDashboardDataMutationVariables
  >(InsertkpiEmissionDashboardDataDocument, options);
}
export type InsertkpiEmissionDashboardDataMutationHookResult = ReturnType<
  typeof useInsertkpiEmissionDashboardDataMutation
>;
export type InsertkpiEmissionDashboardDataMutationResult =
  Apollo.MutationResult<InsertkpiEmissionDashboardDataMutation>;
export type InsertkpiEmissionDashboardDataMutationOptions =

...
export type DeleteAppUserMutation = {
  ...
  delete_AppUser?: {
    ...
    returning: Array<{ __typename?: "AppUser"; id: any }>;
  } | null;
};
...
`;
export type DeleteAppUserMutationFn = Apollo.MutationFunction<
  DeleteAppUserMutation,
  DeleteAppUserMutationVariables
>;
 ...
 * });
 */
export function useDeleteAppUserMutation(
  ...
  return Apollo.useMutation<
    DeleteAppUserMutation,
    DeleteAppUserMutationVariables
  >(DeleteAppUserDocument, options);
}
export type DeleteAppUserMutationHookResult = ReturnType<
  typeof useDeleteAppUserMutation
>;
export type DeleteAppUserMutationResult =
  Apollo.MutationResult<DeleteAppUserMutation>;
export type DeleteAppUserMutationOptions = Apollo.BaseMutationOptions<
  DeleteAppUserMutation,
  DeleteAppUserMutationVariables
>;

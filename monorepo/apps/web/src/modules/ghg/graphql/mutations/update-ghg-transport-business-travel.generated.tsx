...
export type UpdateGhgTransportBusinessTravelMutationVariables = Types.Exact<{
  GhgTransportBusinessTravel:
    | Array<Types.GhgTransport_BusinessTravel_Updates>
    | Types.GhgTransport_BusinessTravel_Updates;
}>;

export type UpdateGhgTransportBusinessTravelMutation = {
  __typename?: "mutation_root";
  update_GHGTransport_BusinessTravel_many?: Array<{
...
export const UpdateGhgTransportBusinessTravelDocument = gql`
  mutation updateGhgTransportBusinessTravel(
    $GhgTransportBusinessTravel: [GHGTransport_BusinessTravel_updates!]!
  ) {
    update_GHGTransport_BusinessTravel_many(
      updates: $GhgTransportBusinessTravel
    ) {
      returning {
        id
        task_request_id
...
`;
export type UpdateGhgTransportBusinessTravelMutationFn =
  Apollo.MutationFunction<
    UpdateGhgTransportBusinessTravelMutation,
    UpdateGhgTransportBusinessTravelMutationVariables
  >;
 ...
 * });
 */
export function useUpdateGhgTransportBusinessTravelMutation(
  ...
  return Apollo.useMutation<
    UpdateGhgTransportBusinessTravelMutation,
    UpdateGhgTransportBusinessTravelMutationVariables
  >(UpdateGhgTransportBusinessTravelDocument, options);
}
export type UpdateGhgTransportBusinessTravelMutationHookResult = ReturnType<
  typeof useUpdateGhgTransportBusinessTravelMutation
>;
export type UpdateGhgTransportBusinessTravelMutationResult =
  Apollo.MutationResult<UpdateGhgTransportBusinessTravelMutation>;
export type UpdateGhgTransportBusinessTravelMutationOptions =

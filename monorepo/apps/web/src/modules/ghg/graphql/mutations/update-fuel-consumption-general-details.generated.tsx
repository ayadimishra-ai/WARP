...
export const UpdateFuelConsumptionGeneralDetailsDocument = gql`
  mutation updateFuelConsumptionGeneralDetails(
    $id: uuid!
    $set: GHGEnergyConsumption_FuelPurchased_General_set_input!
  ) {
    update_GHGEnergyConsumption_FuelPurchased_General(
      where: { id: { _eq: $id } }
      _set: $set
...
`;
export type UpdateFuelConsumptionGeneralDetailsMutationFn =
  Apollo.MutationFunction<
    UpdateFuelConsumptionGeneralDetailsMutation,
    UpdateFuelConsumptionGeneralDetailsMutationVariables
  >;
 ...
 * });
 */
export function useUpdateFuelConsumptionGeneralDetailsMutation(
  ...
  return Apollo.useMutation<
    UpdateFuelConsumptionGeneralDetailsMutation,
    UpdateFuelConsumptionGeneralDetailsMutationVariables
  >(UpdateFuelConsumptionGeneralDetailsDocument, options);
}
export type UpdateFuelConsumptionGeneralDetailsMutationHookResult = ReturnType<
  typeof useUpdateFuelConsumptionGeneralDetailsMutation
>;
export type UpdateFuelConsumptionGeneralDetailsMutationResult =
  Apollo.MutationResult<UpdateFuelConsumptionGeneralDetailsMutation>;
export type UpdateFuelConsumptionGeneralDetailsMutationOptions =

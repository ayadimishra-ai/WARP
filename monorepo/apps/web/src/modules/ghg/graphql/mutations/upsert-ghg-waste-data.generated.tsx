...
export type UpsertGhgWasteActivityMutationVariables = Types.Exact<{
  ...
  ghgWasteData:
    | Array<Types.GhgWaste_Insert_Input>
    | Types.GhgWaste_Insert_Input;
}>;

export type UpsertGhgWasteActivityMutation = {
  __typename?: "mutation_root";
  delete_GHGWaste?: {
    __typename?: "GHGWaste_mutation_response";
    returning: Array<{
      __typename?: "GHGWaste";
      id: any;
...
export const UpsertGhgWasteActivityDocument = gql`
  mutation upsertGHGWasteActivity(
    $where: GHGWaste_bool_exp!
    $ghgWasteData: [GHGWaste_insert_input!]!
  ) {
...
`;
export type UpsertGhgWasteActivityMutationFn = Apollo.MutationFunction<
  UpsertGhgWasteActivityMutation,
  UpsertGhgWasteActivityMutationVariables
>;
 ...
 * });
 */
export function useUpsertGhgWasteActivityMutation(
  ...
  return Apollo.useMutation<
    UpsertGhgWasteActivityMutation,
    UpsertGhgWasteActivityMutationVariables
  >(UpsertGhgWasteActivityDocument, options);
}
export type UpsertGhgWasteActivityMutationHookResult = ReturnType<
  typeof useUpsertGhgWasteActivityMutation
>;
export type UpsertGhgWasteActivityMutationResult =
  Apollo.MutationResult<UpsertGhgWasteActivityMutation>;
export type UpsertGhgWasteActivityMutationOptions = Apollo.BaseMutationOptions<
  UpsertGhgWasteActivityMutation,
  UpsertGhgWasteActivityMutationVariables
>;

...
export type UpsertBuyerShareAttributionMutationVariables = Types.Exact<{
  ...
  buyerShareData:
    | Array<Types.GhgBuyer_Share_Insert_Input>
    | Types.GhgBuyer_Share_Insert_Input;
}>;

export type UpsertBuyerShareAttributionMutation = {
  __typename?: "mutation_root";
  delete_GHGBuyer_Share?: {
    __typename?: "GHGBuyer_Share_mutation_response";
    returning: Array<{
...
export const UpsertBuyerShareAttributionDocument = gql`
  mutation upsertBuyerShareAttribution(
    $where: GHGBuyer_Share_bool_exp!
    $buyerShareData: [GHGBuyer_Share_insert_input!]!
  ) {
...
`;
export type UpsertBuyerShareAttributionMutationFn = Apollo.MutationFunction<
  UpsertBuyerShareAttributionMutation,
  UpsertBuyerShareAttributionMutationVariables
>;
 ...
 * });
 */
export function useUpsertBuyerShareAttributionMutation(
  ...
  return Apollo.useMutation<
    UpsertBuyerShareAttributionMutation,
    UpsertBuyerShareAttributionMutationVariables
  >(UpsertBuyerShareAttributionDocument, options);
}
export type UpsertBuyerShareAttributionMutationHookResult = ReturnType<
  typeof useUpsertBuyerShareAttributionMutation
>;
export type UpsertBuyerShareAttributionMutationResult =
  Apollo.MutationResult<UpsertBuyerShareAttributionMutation>;
export type UpsertBuyerShareAttributionMutationOptions =

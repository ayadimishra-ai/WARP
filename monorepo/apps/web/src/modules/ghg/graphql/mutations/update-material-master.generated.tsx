...
export type UpdateMaterialMasterMutationVariables = Types.Exact<{
  updates:
    | Array<Types.OrgMaterialMaster_Updates>
    | Types.OrgMaterialMaster_Updates;
}>;

export type UpdateMaterialMasterMutation = {
  __typename?: "mutation_root";
  update_OrgMaterialMaster_many?: Array<{
...
`;
export type UpdateMaterialMasterMutationFn = Apollo.MutationFunction<
  UpdateMaterialMasterMutation,
  UpdateMaterialMasterMutationVariables
>;
 ...
 * });
 */
export function useUpdateMaterialMasterMutation(
  ...
  return Apollo.useMutation<
    UpdateMaterialMasterMutation,
    UpdateMaterialMasterMutationVariables
  >(UpdateMaterialMasterDocument, options);
}
export type UpdateMaterialMasterMutationHookResult = ReturnType<
  typeof useUpdateMaterialMasterMutation
>;
export type UpdateMaterialMasterMutationResult =
  Apollo.MutationResult<UpdateMaterialMasterMutation>;
export type UpdateMaterialMasterMutationOptions = Apollo.BaseMutationOptions<
  UpdateMaterialMasterMutation,
  UpdateMaterialMasterMutationVariables
>;

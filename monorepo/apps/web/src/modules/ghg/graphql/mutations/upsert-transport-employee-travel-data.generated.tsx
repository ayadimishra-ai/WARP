...
export type UpsertGhgTransport_EmployeeTravelActivityMutationVariables =
  Types.Exact<{
    where: Types.GhgTransport_EmployeeTravel_Bool_Exp;
    employeeTraveldata:
      | Array<Types.GhgTransport_EmployeeTravel_Insert_Input>
      | Types.GhgTransport_EmployeeTravel_Insert_Input;
  }>;
...
export const UpsertGhgTransport_EmployeeTravelActivityDocument = gql`
  mutation upsertGHGTransport_EmployeeTravelActivity(
    $where: GHGTransport_EmployeeTravel_bool_exp!
    $employeeTraveldata: [GHGTransport_EmployeeTravel_insert_input!]!
  ) {
...
`;
export type UpsertGhgTransport_EmployeeTravelActivityMutationFn =
  Apollo.MutationFunction<
    UpsertGhgTransport_EmployeeTravelActivityMutation,
    UpsertGhgTransport_EmployeeTravelActivityMutationVariables
  >;
 ...
 * });
 */
export function useUpsertGhgTransport_EmployeeTravelActivityMutation(
  ...
  return Apollo.useMutation<
    UpsertGhgTransport_EmployeeTravelActivityMutation,
    UpsertGhgTransport_EmployeeTravelActivityMutationVariables
  >(UpsertGhgTransport_EmployeeTravelActivityDocument, options);
}
export type UpsertGhgTransport_EmployeeTravelActivityMutationHookResult =
  ReturnType<typeof useUpsertGhgTransport_EmployeeTravelActivityMutation>;
export type UpsertGhgTransport_EmployeeTravelActivityMutationResult =
  Apollo.MutationResult<UpsertGhgTransport_EmployeeTravelActivityMutation>;
export type UpsertGhgTransport_EmployeeTravelActivityMutationOptions =

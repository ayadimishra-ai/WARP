...
export type SoftDeleteSupplierMaterialMappingMutation = {
...
`;
export type SoftDeleteSupplierMaterialMappingMutationFn =
  Apollo.MutationFunction<
    SoftDeleteSupplierMaterialMappingMutation,
    SoftDeleteSupplierMaterialMappingMutationVariables
  >;
 ...
 * });
 */
export function useSoftDeleteSupplierMaterialMappingMutation(
  ...
  return Apollo.useMutation<
    SoftDeleteSupplierMaterialMappingMutation,
    SoftDeleteSupplierMaterialMappingMutationVariables
  >(SoftDeleteSupplierMaterialMappingDocument, options);
}
export type SoftDeleteSupplierMaterialMappingMutationHookResult = ReturnType<
  typeof useSoftDeleteSupplierMaterialMappingMutation
>;
export type SoftDeleteSupplierMaterialMappingMutationResult =
  Apollo.MutationResult<SoftDeleteSupplierMaterialMappingMutation>;
export type SoftDeleteSupplierMaterialMappingMutationOptions =

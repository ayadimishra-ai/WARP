...
export type UpdateAppUserByIdMutation = {
...
`;
export type UpdateAppUserByIdMutationFn = Apollo.MutationFunction<
  UpdateAppUserByIdMutation,
  UpdateAppUserByIdMutationVariables
>;
 ...
 * });
 */
export function useUpdateAppUserByIdMutation(
  ...
  return Apollo.useMutation<
    UpdateAppUserByIdMutation,
    UpdateAppUserByIdMutationVariables
  >(UpdateAppUserByIdDocument, options);
}
export type UpdateAppUserByIdMutationHookResult = ReturnType<
  typeof useUpdateAppUserByIdMutation
>;
export type UpdateAppUserByIdMutationResult =
  Apollo.MutationResult<UpdateAppUserByIdMutation>;
export type UpdateAppUserByIdMutationOptions = Apollo.BaseMutationOptions<
  UpdateAppUserByIdMutation,
  UpdateAppUserByIdMutationVariables
>;

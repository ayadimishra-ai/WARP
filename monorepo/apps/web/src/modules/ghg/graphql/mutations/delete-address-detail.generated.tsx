...
export type DeleteOrganizationAddressByIdMutation = {
  __typename?: "mutation_root";
  update_OrganizationAddress?: {
    __typename?: "OrganizationAddress_mutation_response";
    affected_rows: number;
    returning: Array<{
...
`;
export type DeleteAddressByIdMutationFn = Apollo.MutationFunction<
  DeleteAddressByIdMutation,
  DeleteAddressByIdMutationVariables
>;
 ...
 * });
 */
export function useDeleteAddressByIdMutation(
  ...
  return Apollo.useMutation<
    DeleteAddressByIdMutation,
    DeleteAddressByIdMutationVariables
  >(DeleteAddressByIdDocument, options);
}
export type DeleteAddressByIdMutationHookResult = ReturnType<
  typeof useDeleteAddressByIdMutation
>;
export type DeleteAddressByIdMutationResult =
  Apollo.MutationResult<DeleteAddressByIdMutation>;
export type DeleteAddressByIdMutationOptions = Apollo.BaseMutationOptions<
  DeleteAddressByIdMutation,
  DeleteAddressByIdMutationVariables
>;
...
`;
export type DeleteOrganizationAddressByIdMutationFn = Apollo.MutationFunction<
  DeleteOrganizationAddressByIdMutation,
  DeleteOrganizationAddressByIdMutationVariables
>;
 ...
 * });
 */
export function useDeleteOrganizationAddressByIdMutation(
  baseOptions?: Apollo.MutationHookOptions<
    DeleteOrganizationAddressByIdMutation,
    DeleteOrganizationAddressByIdMutationVariables
  >
  ...
  return Apollo.useMutation<
    DeleteOrganizationAddressByIdMutation,
    DeleteOrganizationAddressByIdMutationVariables
  >(DeleteOrganizationAddressByIdDocument, options);
}
export type DeleteOrganizationAddressByIdMutationHookResult = ReturnType<
  typeof useDeleteOrganizationAddressByIdMutation
>;
export type DeleteOrganizationAddressByIdMutationResult =
  Apollo.MutationResult<DeleteOrganizationAddressByIdMutation>;
export type DeleteOrganizationAddressByIdMutationOptions =

...
export type UpdateBulkTravelDistanceMutationVariables = Types.Exact<{
  TravelDistanceUpdate:
    | Array<Types.TravelDistance_Updates>
    | Types.TravelDistance_Updates;
}>;

export type UpdateBulkTravelDistanceMutation = {
  __typename?: "mutation_root";
  update_TravelDistance_many?: Array<{
...
export const UpdateBulkTravelDistanceDocument = gql`
  mutation updateBulkTravelDistance(
...
`;
export type UpdateBulkTravelDistanceMutationFn = Apollo.MutationFunction<
  UpdateBulkTravelDistanceMutation,
  UpdateBulkTravelDistanceMutationVariables
>;
 ...
 * });
 */
export function useUpdateBulkTravelDistanceMutation(
  ...
  return Apollo.useMutation<
    UpdateBulkTravelDistanceMutation,
    UpdateBulkTravelDistanceMutationVariables
  >(UpdateBulkTravelDistanceDocument, options);
}
export type UpdateBulkTravelDistanceMutationHookResult = ReturnType<
  typeof useUpdateBulkTravelDistanceMutation
>;
export type UpdateBulkTravelDistanceMutationResult =
  Apollo.MutationResult<UpdateBulkTravelDistanceMutation>;
export type UpdateBulkTravelDistanceMutationOptions =

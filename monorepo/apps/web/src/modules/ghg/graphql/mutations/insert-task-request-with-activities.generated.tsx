...
export const InsertTaskRequestWithActivitiesDocument = gql`
  mutation insertTaskRequestWithActivities(
    $organizationAddressId: uuid!
    $month: String!
    $year: Int!
    $activityTaskRequests: ActivityTaskRequest_arr_rel_insert_input
    $userId: uuid!
  ) {
    insert_TaskRequest_one(
      object: {
        ...
        month: $month
        year: $year
        ActivityTaskRequests: $activityTaskRequests
        created_by: $userId
        updated_by: $userId
      }
    ) {
...
`;
export type InsertTaskRequestWithActivitiesMutationFn = Apollo.MutationFunction<
  InsertTaskRequestWithActivitiesMutation,
  InsertTaskRequestWithActivitiesMutationVariables
>;
 ...
 * });
 */
export function useInsertTaskRequestWithActivitiesMutation(
  ...
  return Apollo.useMutation<
    InsertTaskRequestWithActivitiesMutation,
    InsertTaskRequestWithActivitiesMutationVariables
  >(InsertTaskRequestWithActivitiesDocument, options);
}
export type InsertTaskRequestWithActivitiesMutationHookResult = ReturnType<
  typeof useInsertTaskRequestWithActivitiesMutation
>;
export type InsertTaskRequestWithActivitiesMutationResult =
  Apollo.MutationResult<InsertTaskRequestWithActivitiesMutation>;
export type InsertTaskRequestWithActivitiesMutationOptions =

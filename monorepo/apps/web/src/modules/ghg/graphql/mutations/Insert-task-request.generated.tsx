...
export type InsertTaskRequestMutation = {
  __typename?: "mutation_root";
  insert_TaskRequest?: {
    __typename?: "TaskRequest_mutation_response";
    returning: Array<{
...
`;
export type InsertTaskRequestMutationFn = Apollo.MutationFunction<
  InsertTaskRequestMutation,
  InsertTaskRequestMutationVariables
>;
 ...
 * });
 */
export function useInsertTaskRequestMutation(
  ...
  return Apollo.useMutation<
    InsertTaskRequestMutation,
    InsertTaskRequestMutationVariables
  >(InsertTaskRequestDocument, options);
}
export type InsertTaskRequestMutationHookResult = ReturnType<
  typeof useInsertTaskRequestMutation
>;
export type InsertTaskRequestMutationResult =
  Apollo.MutationResult<InsertTaskRequestMutation>;
export type InsertTaskRequestMutationOptions = Apollo.BaseMutationOptions<
  InsertTaskRequestMutation,
  InsertTaskRequestMutationVariables
>;

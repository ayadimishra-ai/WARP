...
export type InsertOrgSupplierMasterMutation = {
...
export const InsertOrgSupplierMasterDocument = gql`
  mutation insertOrgSupplierMaster(
...
`;
export type InsertOrgSupplierMasterMutationFn = Apollo.MutationFunction<
  InsertOrgSupplierMasterMutation,
  InsertOrgSupplierMasterMutationVariables
>;
 ...
 * });
 */
export function useInsertOrgSupplierMasterMutation(
  ...
  return Apollo.useMutation<
    InsertOrgSupplierMasterMutation,
    InsertOrgSupplierMasterMutationVariables
  >(InsertOrgSupplierMasterDocument, options);
}
export type InsertOrgSupplierMasterMutationHookResult = ReturnType<
  typeof useInsertOrgSupplierMasterMutation
>;
export type InsertOrgSupplierMasterMutationResult =
  Apollo.MutationResult<InsertOrgSupplierMasterMutation>;
export type InsertOrgSupplierMasterMutationOptions = Apollo.BaseMutationOptions<
  InsertOrgSupplierMasterMutation,
  InsertOrgSupplierMasterMutationVariables
>;

...
export type UpsertUseOfSoldProductsElectricityMutation = {
...
export const UpsertUseOfSoldProductsElectricityDocument = gql`
  mutation upsertUseOfSoldProductsElectricity(
    $where: GHGUseOfSoldProducts_Electricity_bool_exp!
    $electricityData: [GHGUseOfSoldProducts_Electricity_insert_input!]!
    $electricityUpdate: [GHGUseOfSoldProducts_Electricity_updates!]!
  ) {
...
`;
export type UpsertUseOfSoldProductsElectricityMutationFn =
  Apollo.MutationFunction<
    UpsertUseOfSoldProductsElectricityMutation,
    UpsertUseOfSoldProductsElectricityMutationVariables
  >;
 ...
 * });
 */
export function useUpsertUseOfSoldProductsElectricityMutation(
  ...
  return Apollo.useMutation<
    UpsertUseOfSoldProductsElectricityMutation,
    UpsertUseOfSoldProductsElectricityMutationVariables
  >(UpsertUseOfSoldProductsElectricityDocument, options);
}
export type UpsertUseOfSoldProductsElectricityMutationHookResult = ReturnType<
  typeof useUpsertUseOfSoldProductsElectricityMutation
>;
export type UpsertUseOfSoldProductsElectricityMutationResult =
  Apollo.MutationResult<UpsertUseOfSoldProductsElectricityMutation>;
export type UpsertUseOfSoldProductsElectricityMutationOptions =

...
export type InsertUseOfSoldProductsRefrigerantMutation = {
...
`;
export type InsertUseOfSoldProductsRefrigerantMutationFn =
  Apollo.MutationFunction<
    InsertUseOfSoldProductsRefrigerantMutation,
    InsertUseOfSoldProductsRefrigerantMutationVariables
  >;
 ...
 * });
 */
export function useInsertUseOfSoldProductsRefrigerantMutation(
  ...
  return Apollo.useMutation<
    InsertUseOfSoldProductsRefrigerantMutation,
    InsertUseOfSoldProductsRefrigerantMutationVariables
  >(InsertUseOfSoldProductsRefrigerantDocument, options);
}
export type InsertUseOfSoldProductsRefrigerantMutationHookResult = ReturnType<
  typeof useInsertUseOfSoldProductsRefrigerantMutation
>;
export type InsertUseOfSoldProductsRefrigerantMutationResult =
  Apollo.MutationResult<InsertUseOfSoldProductsRefrigerantMutation>;
export type InsertUseOfSoldProductsRefrigerantMutationOptions =

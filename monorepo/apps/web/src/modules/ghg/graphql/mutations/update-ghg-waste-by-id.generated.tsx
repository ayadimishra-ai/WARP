...
export type UpdateGhgWasteByIdMutation = {
  __typename?: "mutation_root";
  update_GHGWaste_many?: Array<{
...
`;
export type UpdateGhgWasteByIdMutationFn = Apollo.MutationFunction<
  UpdateGhgWasteByIdMutation,
 ...
 * });
 */
export function useUpdateGhgWasteByIdMutation(
  ...
  return Apollo.useMutation<
    UpdateGhgWasteByIdMutation,
    UpdateGhgWasteByIdMutationVariables
  >(UpdateGhgWasteByIdDocument, options);
}
export type UpdateGhgWasteByIdMutationHookResult = ReturnType<
  typeof useUpdateGhgWasteByIdMutation
>;
export type UpdateGhgWasteByIdMutationResult =
  Apollo.MutationResult<UpdateGhgWasteByIdMutation>;
export type UpdateGhgWasteByIdMutationOptions = Apollo.BaseMutationOptions<
  UpdateGhgWasteByIdMutation,
  UpdateGhgWasteByIdMutationVariables
>;

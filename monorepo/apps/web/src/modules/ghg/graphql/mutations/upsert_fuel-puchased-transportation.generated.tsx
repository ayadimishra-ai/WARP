...
export type UpsertGhgFuelPurchasedTransportation_ActivityMutationVariables =
  Types.Exact<{
    where: Types.GhgEnergyConsumption_FuelPurchased_Transportation_Bool_Exp;
    fuelpurchasedtransportation:
      | Array<Types.GhgEnergyConsumption_FuelPurchased_Transportation_Insert_Input>
      | Types.GhgEnergyConsumption_FuelPurchased_Transportation_Insert_Input;
  }>;
...
export const UpsertGhgFuelPurchasedTransportation_ActivityDocument = gql`
  mutation upsertGHGFuelPurchasedTransportation_Activity(
    $where: GHGEnergyConsumption_FuelPurchased_Transportation_bool_exp!
    $fuelpurchasedtransportation: [GHGEnergyConsumption_FuelPurchased_Transportation_insert_input!]!
  ) {
    ...
    insert_GHGEnergyConsumption_FuelPurchased_Transportation(
      ...
      on_conflict: {
        constraint: GHGEnergyConsumption_FuelPurchased_Transportation_pkey
      }
    ) {
      returning {
        id
...
`;
export type UpsertGhgFuelPurchasedTransportation_ActivityMutationFn =
  Apollo.MutationFunction<
    UpsertGhgFuelPurchasedTransportation_ActivityMutation,
    UpsertGhgFuelPurchasedTransportation_ActivityMutationVariables
  >;
 ...
 * });
 */
export function useUpsertGhgFuelPurchasedTransportation_ActivityMutation(
  ...
  return Apollo.useMutation<
    UpsertGhgFuelPurchasedTransportation_ActivityMutation,
    UpsertGhgFuelPurchasedTransportation_ActivityMutationVariables
  >(UpsertGhgFuelPurchasedTransportation_ActivityDocument, options);
}
export type UpsertGhgFuelPurchasedTransportation_ActivityMutationHookResult =
  ReturnType<typeof useUpsertGhgFuelPurchasedTransportation_ActivityMutation>;
export type UpsertGhgFuelPurchasedTransportation_ActivityMutationResult =
  Apollo.MutationResult<UpsertGhgFuelPurchasedTransportation_ActivityMutation>;
export type UpsertGhgFuelPurchasedTransportation_ActivityMutationOptions =

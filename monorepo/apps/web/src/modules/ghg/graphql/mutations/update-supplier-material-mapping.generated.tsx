...
`;
export type UpdateSupplierMaterialMappingMutationFn = Apollo.MutationFunction<
  UpdateSupplierMaterialMappingMutation,
  UpdateSupplierMaterialMappingMutationVariables
>;
 ...
 * });
 */
export function useUpdateSupplierMaterialMappingMutation(
  ...
  return Apollo.useMutation<
    UpdateSupplierMaterialMappingMutation,
    UpdateSupplierMaterialMappingMutationVariables
  >(UpdateSupplierMaterialMappingDocument, options);
}
export type UpdateSupplierMaterialMappingMutationHookResult = ReturnType<
  typeof useUpdateSupplierMaterialMappingMutation
>;
export type UpdateSupplierMaterialMappingMutationResult =
  Apollo.MutationResult<UpdateSupplierMaterialMappingMutation>;
export type UpdateSupplierMaterialMappingMutationOptions =

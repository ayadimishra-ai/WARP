...
export type InsertUseOfSoldProductsFuelMutation = {
...
`;
export type InsertUseOfSoldProductsFuelMutationFn = Apollo.MutationFunction<
  InsertUseOfSoldProductsFuelMutation,
  InsertUseOfSoldProductsFuelMutationVariables
>;
 ...
 * });
 */
export function useInsertUseOfSoldProductsFuelMutation(
  ...
  return Apollo.useMutation<
    InsertUseOfSoldProductsFuelMutation,
    InsertUseOfSoldProductsFuelMutationVariables
  >(InsertUseOfSoldProductsFuelDocument, options);
}
export type InsertUseOfSoldProductsFuelMutationHookResult = ReturnType<
  typeof useInsertUseOfSoldProductsFuelMutation
>;
export type InsertUseOfSoldProductsFuelMutationResult =
  Apollo.MutationResult<InsertUseOfSoldProductsFuelMutation>;
export type InsertUseOfSoldProductsFuelMutationOptions =

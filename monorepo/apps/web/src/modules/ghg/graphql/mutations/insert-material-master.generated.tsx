...
export type InsertMaterialMasterMutation = {
...
`;
export type InsertMaterialMasterMutationFn = Apollo.MutationFunction<
  InsertMaterialMasterMutation,
  InsertMaterialMasterMutationVariables
>;
 ...
 * });
 */
export function useInsertMaterialMasterMutation(
  ...
  return Apollo.useMutation<
    InsertMaterialMasterMutation,
    InsertMaterialMasterMutationVariables
  >(InsertMaterialMasterDocument, options);
}
export type InsertMaterialMasterMutationHookResult = ReturnType<
  typeof useInsertMaterialMasterMutation
>;
export type InsertMaterialMasterMutationResult =
  Apollo.MutationResult<InsertMaterialMasterMutation>;
export type InsertMaterialMasterMutationOptions = Apollo.BaseMutationOptions<
  InsertMaterialMasterMutation,
  InsertMaterialMasterMutationVariables
>;

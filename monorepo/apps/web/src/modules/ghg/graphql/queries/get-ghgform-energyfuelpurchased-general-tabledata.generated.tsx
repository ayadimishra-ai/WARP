...
export type GetGhgEnergyFuelPurchasedGeneralQuery = {
...
export const GetGhgEnergyFuelPurchasedGeneralDocument = gql`
  query getGHGEnergyFuelPurchasedGeneral(
    $activityFilter: GHGEnergyConsumption_FuelPurchased_General_bool_exp
    $start: Int
    $size: Int
    $orderBy: [GHGEnergyConsumption_FuelPurchased_General_order_by!]
  ) {
 ...
 * });
 */
export function useGetGhgEnergyFuelPurchasedGeneralQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetGhgEnergyFuelPurchasedGeneralQuery,
    GetGhgEnergyFuelPurchasedGeneralQueryVariables
  >
) {
  ...
  return Apollo.useQuery<
    GetGhgEnergyFuelPurchasedGeneralQuery,
    GetGhgEnergyFuelPurchasedGeneralQueryVariables
  >(GetGhgEnergyFuelPurchasedGeneralDocument, options);
}
export function useGetGhgEnergyFuelPurchasedGeneralLazyQuery(
...
// @ts-ignore
export function useGetGhgEnergyFuelPurchasedGeneralSuspenseQuery(
...
export function useGetGhgEnergyFuelPurchasedGeneralSuspenseQuery(
  ...
  GetGhgEnergyFuelPurchasedGeneralQuery | undefined,
  GetGhgEnergyFuelPurchasedGeneralQueryVariables
>;
export function useGetGhgEnergyFuelPurchasedGeneralSuspenseQuery(
  baseOptions?:
...
export type GetGhgEnergyFuelPurchasedGeneralQueryHookResult = ReturnType<
  typeof useGetGhgEnergyFuelPurchasedGeneralQuery
>;
export type GetGhgEnergyFuelPurchasedGeneralLazyQueryHookResult = ReturnType<
  typeof useGetGhgEnergyFuelPurchasedGeneralLazyQuery
>;
export type GetGhgEnergyFuelPurchasedGeneralSuspenseQueryHookResult =
  ReturnType<typeof useGetGhgEnergyFuelPurchasedGeneralSuspenseQuery>;
export type GetGhgEnergyFuelPurchasedGeneralQueryResult = Apollo.QueryResult<
  GetGhgEnergyFuelPurchasedGeneralQuery,
  GetGhgEnergyFuelPurchasedGeneralQueryVariables
>;

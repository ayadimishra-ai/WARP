 ...
 * });
 */
export function useGetValidationDataForDownstreamExcelQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetValidationDataForDownstreamExcelQuery,
    GetValidationDataForDownstreamExcelQueryVariables
  > &
    (
      | {
          variables: GetValidationDataForDownstreamExcelQueryVariables;
          skip?: boolean;
        }
      | { skip: boolean }
    )
  ...
  return Apollo.useQuery<
    GetValidationDataForDownstreamExcelQuery,
    GetValidationDataForDownstreamExcelQueryVariables
  >(GetValidationDataForDownstreamExcelDocument, options);
}
export function useGetValidationDataForDownstreamExcelLazyQuery(
...
// @ts-ignore
export function useGetValidationDataForDownstreamExcelSuspenseQuery(
...
export function useGetValidationDataForDownstreamExcelSuspenseQuery(
  ...
  GetValidationDataForDownstreamExcelQuery | undefined,
  GetValidationDataForDownstreamExcelQueryVariables
>;
export function useGetValidationDataForDownstreamExcelSuspenseQuery(
  baseOptions?:
...
export type GetValidationDataForDownstreamExcelQueryHookResult = ReturnType<
  typeof useGetValidationDataForDownstreamExcelQuery
>;
export type GetValidationDataForDownstreamExcelLazyQueryHookResult = ReturnType<
  typeof useGetValidationDataForDownstreamExcelLazyQuery
>;
export type GetValidationDataForDownstreamExcelSuspenseQueryHookResult =
  ReturnType<typeof useGetValidationDataForDownstreamExcelSuspenseQuery>;
export type GetValidationDataForDownstreamExcelQueryResult = Apollo.QueryResult<
  GetValidationDataForDownstreamExcelQuery,
  GetValidationDataForDownstreamExcelQueryVariables
>;

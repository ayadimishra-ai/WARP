...
export type GetAiFiledatabydateQuery = {
  ...
  AIFileData: Array<{
    ...
    AIFileUpload: {
      ...
      status?: string | null;
      is_deleted: boolean;
      AIFileActivityTaskRequestMappings: Array<{
 ...
 * });
 */
export function useGetAiFiledatabydateQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetAiFiledatabydateQuery,
    GetAiFiledatabydateQueryVariables
  > &
    (
      | { variables: GetAiFiledatabydateQueryVariables; skip?: boolean }
      | { skip: boolean }
    )
) {
  ...
  return Apollo.useQuery<
    GetAiFiledatabydateQuery,
    GetAiFiledatabydateQueryVariables
  >(GetAiFiledatabydateDocument, options);
}
export function useGetAiFiledatabydateLazyQuery(
...
// @ts-ignore
export function useGetAiFiledatabydateSuspenseQuery(
...
export function useGetAiFiledatabydateSuspenseQuery(
  ...
  GetAiFiledatabydateQuery | undefined,
  GetAiFiledatabydateQueryVariables
>;
export function useGetAiFiledatabydateSuspenseQuery(
  baseOptions?:
...
export type GetAiFiledatabydateQueryHookResult = ReturnType<
  typeof useGetAiFiledatabydateQuery
>;
export type GetAiFiledatabydateLazyQueryHookResult = ReturnType<
  typeof useGetAiFiledatabydateLazyQuery
>;
export type GetAiFiledatabydateSuspenseQueryHookResult = ReturnType<
  typeof useGetAiFiledatabydateSuspenseQuery
>;
export type GetAiFiledatabydateQueryResult = Apollo.QueryResult<
  GetAiFiledatabydateQuery,
  GetAiFiledatabydateQueryVariables
>;

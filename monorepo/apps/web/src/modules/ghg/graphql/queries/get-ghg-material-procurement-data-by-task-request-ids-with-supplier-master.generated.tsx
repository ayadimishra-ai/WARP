...
export type GetGhgMaterialProcurementDataByTaskRequestIdsOrgWithSupplierMasterDataQueryVariables =
  Types.Exact<{
...
export const GetGhgMaterialProcurementDataByTaskRequestIdsOrgWithSupplierMasterDataDocument = gql`
  query getGHGMaterialProcurementDataByTaskRequestIdsOrgWithSupplierMasterData(
    $whereYearMonths: TaskRequest_bool_exp!
    $supplierName: String!
  ) {
...
export function useGetGhgMaterialProcurementDataByTaskRequestIdsOrgWithSupplierMasterDataQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetGhgMaterialProcurementDataByTaskRequestIdsOrgWithSupplierMasterDataQuery,
  ...
  return Apollo.useQuery<
    ...
    GetGhgMaterialProcurementDataByTaskRequestIdsOrgWithSupplierMasterDataQueryVariables
  >(
    GetGhgMaterialProcurementDataByTaskRequestIdsOrgWithSupplierMasterDataDocument,
    options
  );
}
export function useGetGhgMaterialProcurementDataByTaskRequestIdsOrgWithSupplierMasterDataLazyQuery(
...
export type GetGhgMaterialProcurementDataByTaskRequestIdsOrgWithSupplierMasterDataQueryHookResult =
  ReturnType<
    typeof useGetGhgMaterialProcurementDataByTaskRequestIdsOrgWithSupplierMasterDataQuery
  >;
export type GetGhgMaterialProcurementDataByTaskRequestIdsOrgWithSupplierMasterDataLazyQueryHookResult =
  ReturnType<
    typeof useGetGhgMaterialProcurementDataByTaskRequestIdsOrgWithSupplierMasterDataLazyQuery
  >;
export type GetGhgMaterialProcurementDataByTaskRequestIdsOrgWithSupplierMasterDataSuspenseQueryHookResult =
  ReturnType<
    typeof useGetGhgMaterialProcurementDataByTaskRequestIdsOrgWithSupplierMasterDataSuspenseQuery
  >;
export type GetGhgMaterialProcurementDataByTaskRequestIdsOrgWithSupplierMasterDataQueryResult =
  Apollo.QueryResult<
    GetGhgMaterialProcurementDataByTaskRequestIdsOrgWithSupplierMasterDataQuery,
    GetGhgMaterialProcurementDataByTaskRequestIdsOrgWithSupplierMasterDataQueryVariables
  >;

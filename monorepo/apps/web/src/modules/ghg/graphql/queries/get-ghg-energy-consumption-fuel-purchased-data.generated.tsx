...
export type GetGhgEnergyConsumptionFuelPurchasedDataQueryVariables =
  Types.Exact<{
    where: Types.GhgEnergyConsumption_FuelPurchased_Bool_Exp;
  }>;

export type GetGhgEnergyConsumptionFuelPurchasedDataQuery = {
...
export const GetGhgEnergyConsumptionFuelPurchasedDataDocument = gql`
  query getGHGEnergyConsumptionFuelPurchasedData(
    $where: GHGEnergyConsumption_FuelPurchased_bool_exp!
  ) {
 ...
 * });
 */
export function useGetGhgEnergyConsumptionFuelPurchasedDataQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetGhgEnergyConsumptionFuelPurchasedDataQuery,
    GetGhgEnergyConsumptionFuelPurchasedDataQueryVariables
  > &
    (
      | {
          variables: GetGhgEnergyConsumptionFuelPurchasedDataQueryVariables;
          skip?: boolean;
        }
      | { skip: boolean }
    )
  ...
  return Apollo.useQuery<
    GetGhgEnergyConsumptionFuelPurchasedDataQuery,
    GetGhgEnergyConsumptionFuelPurchasedDataQueryVariables
  >(GetGhgEnergyConsumptionFuelPurchasedDataDocument, options);
}
export function useGetGhgEnergyConsumptionFuelPurchasedDataLazyQuery(
...
// @ts-ignore
export function useGetGhgEnergyConsumptionFuelPurchasedDataSuspenseQuery(
...
export function useGetGhgEnergyConsumptionFuelPurchasedDataSuspenseQuery(
  ...
  GetGhgEnergyConsumptionFuelPurchasedDataQuery | undefined,
  GetGhgEnergyConsumptionFuelPurchasedDataQueryVariables
>;
export function useGetGhgEnergyConsumptionFuelPurchasedDataSuspenseQuery(
  baseOptions?:
...
export type GetGhgEnergyConsumptionFuelPurchasedDataQueryHookResult =
  ReturnType<typeof useGetGhgEnergyConsumptionFuelPurchasedDataQuery>;
export type GetGhgEnergyConsumptionFuelPurchasedDataLazyQueryHookResult =
  ReturnType<typeof useGetGhgEnergyConsumptionFuelPurchasedDataLazyQuery>;
export type GetGhgEnergyConsumptionFuelPurchasedDataSuspenseQueryHookResult =
  ReturnType<typeof useGetGhgEnergyConsumptionFuelPurchasedDataSuspenseQuery>;
export type GetGhgEnergyConsumptionFuelPurchasedDataQueryResult =
  Apollo.QueryResult<
    GetGhgEnergyConsumptionFuelPurchasedDataQuery,
    GetGhgEnergyConsumptionFuelPurchasedDataQueryVariables
  >;

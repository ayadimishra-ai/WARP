...
export type GetghgtransportUpstreamQueryVariables = Types.Exact<{
  [key: string]: never;
}>;

export type GetghgtransportUpstreamQuery = {
 ...
 * });
 */
export function useGetghgtransportUpstreamQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetghgtransportUpstreamQuery,
    GetghgtransportUpstreamQueryVariables
  >
) {
  ...
  return Apollo.useQuery<
    GetghgtransportUpstreamQuery,
    GetghgtransportUpstreamQueryVariables
  >(GetghgtransportUpstreamDocument, options);
}
export function useGetghgtransportUpstreamLazyQuery(
...
export function useGetghgtransportUpstreamSuspenseQuery(
...
export type GetghgtransportUpstreamQueryHookResult = ReturnType<
  typeof useGetghgtransportUpstreamQuery
>;
export type GetghgtransportUpstreamLazyQueryHookResult = ReturnType<
  typeof useGetghgtransportUpstreamLazyQuery
>;
export type GetghgtransportUpstreamSuspenseQueryHookResult = ReturnType<
  typeof useGetghgtransportUpstreamSuspenseQuery
>;
export type GetghgtransportUpstreamQueryResult = Apollo.QueryResult<
  GetghgtransportUpstreamQuery,
  GetghgtransportUpstreamQueryVariables
>;

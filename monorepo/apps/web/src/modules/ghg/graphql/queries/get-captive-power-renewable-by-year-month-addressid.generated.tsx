...
export type GetCaptivePowerRenewableByYearMonthOrgAddressIdQueryVariables =
  Types.Exact<{
...
export type GetCaptivePowerRenewableByYearMonthOrgAddressIdQuery = {
...
export const GetCaptivePowerRenewableByYearMonthOrgAddressIdDocument = gql`
  query getCaptivePowerRenewableByYearMonthOrgAddressId(
    $orgAddressId: uuid!
    $month: String!
    $year: Int!
  ) {
 ...
 * });
 */
export function useGetCaptivePowerRenewableByYearMonthOrgAddressIdQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetCaptivePowerRenewableByYearMonthOrgAddressIdQuery,
    GetCaptivePowerRenewableByYearMonthOrgAddressIdQueryVariables
  > &
    (
      | {
          variables: GetCaptivePowerRenewableByYearMonthOrgAddressIdQueryVariables;
          skip?: boolean;
        }
      | { skip: boolean }
    )
  ...
  return Apollo.useQuery<
    GetCaptivePowerRenewableByYearMonthOrgAddressIdQuery,
    GetCaptivePowerRenewableByYearMonthOrgAddressIdQueryVariables
  >(GetCaptivePowerRenewableByYearMonthOrgAddressIdDocument, options);
}
export function useGetCaptivePowerRenewableByYearMonthOrgAddressIdLazyQuery(
...
// @ts-ignore
export function useGetCaptivePowerRenewableByYearMonthOrgAddressIdSuspenseQuery(
...
export function useGetCaptivePowerRenewableByYearMonthOrgAddressIdSuspenseQuery(
  ...
  GetCaptivePowerRenewableByYearMonthOrgAddressIdQuery | undefined,
  GetCaptivePowerRenewableByYearMonthOrgAddressIdQueryVariables
>;
export function useGetCaptivePowerRenewableByYearMonthOrgAddressIdSuspenseQuery(
  baseOptions?:
...
export type GetCaptivePowerRenewableByYearMonthOrgAddressIdQueryHookResult =
  ReturnType<typeof useGetCaptivePowerRenewableByYearMonthOrgAddressIdQuery>;
export type GetCaptivePowerRenewableByYearMonthOrgAddressIdLazyQueryHookResult =
  ReturnType<
    typeof useGetCaptivePowerRenewableByYearMonthOrgAddressIdLazyQuery
  >;
export type GetCaptivePowerRenewableByYearMonthOrgAddressIdSuspenseQueryHookResult =
  ReturnType<
    typeof useGetCaptivePowerRenewableByYearMonthOrgAddressIdSuspenseQuery
  >;
export type GetCaptivePowerRenewableByYearMonthOrgAddressIdQueryResult =
  Apollo.QueryResult<
    GetCaptivePowerRenewableByYearMonthOrgAddressIdQuery,
    GetCaptivePowerRenewableByYearMonthOrgAddressIdQueryVariables
  >;

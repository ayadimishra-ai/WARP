...
export type GettransportupstreamlocationdataQuery = {
 ...
 * });
 */
export function useGettransportupstreamlocationdataQuery(
  baseOptions: Apollo.QueryHookOptions<
    GettransportupstreamlocationdataQuery,
    GettransportupstreamlocationdataQueryVariables
  > &
    (
      | {
          variables: GettransportupstreamlocationdataQueryVariables;
          skip?: boolean;
        }
      | { skip: boolean }
    )
  ...
  return Apollo.useQuery<
    GettransportupstreamlocationdataQuery,
    GettransportupstreamlocationdataQueryVariables
  >(GettransportupstreamlocationdataDocument, options);
}
export function useGettransportupstreamlocationdataLazyQuery(
...
// @ts-ignore
export function useGettransportupstreamlocationdataSuspenseQuery(
...
export function useGettransportupstreamlocationdataSuspenseQuery(
  ...
  GettransportupstreamlocationdataQuery | undefined,
  GettransportupstreamlocationdataQueryVariables
>;
export function useGettransportupstreamlocationdataSuspenseQuery(
  baseOptions?:
...
export type GettransportupstreamlocationdataQueryHookResult = ReturnType<
  typeof useGettransportupstreamlocationdataQuery
>;
export type GettransportupstreamlocationdataLazyQueryHookResult = ReturnType<
  typeof useGettransportupstreamlocationdataLazyQuery
>;
export type GettransportupstreamlocationdataSuspenseQueryHookResult =
  ReturnType<typeof useGettransportupstreamlocationdataSuspenseQuery>;
export type GettransportupstreamlocationdataQueryResult = Apollo.QueryResult<
  GettransportupstreamlocationdataQuery,
  GettransportupstreamlocationdataQueryVariables
>;

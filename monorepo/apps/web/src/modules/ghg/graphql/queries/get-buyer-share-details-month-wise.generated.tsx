...
export type GetbuyerShareDetailsQuery = {
  __typename?: "query_root";
  Organization: Array<{ __typename?: "Organization"; metadata?: any | null }>;
  TaskRequest: Array<{
 ...
 * });
 */
export function useGetbuyerShareDetailsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetbuyerShareDetailsQuery,
    GetbuyerShareDetailsQueryVariables
  >
) {
  ...
  return Apollo.useQuery<
    GetbuyerShareDetailsQuery,
    GetbuyerShareDetailsQueryVariables
  >(GetbuyerShareDetailsDocument, options);
}
export function useGetbuyerShareDetailsLazyQuery(
...
// @ts-ignore
export function useGetbuyerShareDetailsSuspenseQuery(
...
export function useGetbuyerShareDetailsSuspenseQuery(
  ...
  GetbuyerShareDetailsQuery | undefined,
  GetbuyerShareDetailsQueryVariables
>;
export function useGetbuyerShareDetailsSuspenseQuery(
  baseOptions?:
...
export type GetbuyerShareDetailsQueryHookResult = ReturnType<
  typeof useGetbuyerShareDetailsQuery
>;
export type GetbuyerShareDetailsLazyQueryHookResult = ReturnType<
  typeof useGetbuyerShareDetailsLazyQuery
>;
export type GetbuyerShareDetailsSuspenseQueryHookResult = ReturnType<
  typeof useGetbuyerShareDetailsSuspenseQuery
>;
export type GetbuyerShareDetailsQueryResult = Apollo.QueryResult<
  GetbuyerShareDetailsQuery,
  GetbuyerShareDetailsQueryVariables
>;

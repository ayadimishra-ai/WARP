...
export type GetUpstreamDataByOrgIdQuery = {
 ...
 * });
 */
export function useGetUpstreamDataByOrgIdQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetUpstreamDataByOrgIdQuery,
    GetUpstreamDataByOrgIdQueryVariables
  > &
    (
      | { variables: GetUpstreamDataByOrgIdQueryVariables; skip?: boolean }
      | { skip: boolean }
    )
) {
  ...
  return Apollo.useQuery<
    GetUpstreamDataByOrgIdQuery,
    GetUpstreamDataByOrgIdQueryVariables
  >(GetUpstreamDataByOrgIdDocument, options);
}
export function useGetUpstreamDataByOrgIdLazyQuery(
...
// @ts-ignore
export function useGetUpstreamDataByOrgIdSuspenseQuery(
...
export function useGetUpstreamDataByOrgIdSuspenseQuery(
  ...
  GetUpstreamDataByOrgIdQuery | undefined,
  GetUpstreamDataByOrgIdQueryVariables
>;
export function useGetUpstreamDataByOrgIdSuspenseQuery(
  baseOptions?:
...
export type GetUpstreamDataByOrgIdQueryHookResult = ReturnType<
  typeof useGetUpstreamDataByOrgIdQuery
>;
export type GetUpstreamDataByOrgIdLazyQueryHookResult = ReturnType<
  typeof useGetUpstreamDataByOrgIdLazyQuery
>;
export type GetUpstreamDataByOrgIdSuspenseQueryHookResult = ReturnType<
  typeof useGetUpstreamDataByOrgIdSuspenseQuery
>;
export type GetUpstreamDataByOrgIdQueryResult = Apollo.QueryResult<
  GetUpstreamDataByOrgIdQuery,
  GetUpstreamDataByOrgIdQueryVariables
>;

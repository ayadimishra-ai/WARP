...
export type GetActivityDataEnergyFuelConsumptionGeneralPaginatedQueryVariables =
  Types.Exact<{
    ...
    order_by?: Types.InputMaybe<
      | Array<Types.GhgEnergyConsumption_FuelPurchased_General_Order_By>
      | Types.GhgEnergyConsumption_FuelPurchased_General_Order_By
    >;
...
export type GetActivityDataEnergyFuelConsumptionGeneralPaginatedQuery = {
  ...
  GHGEnergyConsumption_FuelPurchased_General: Array<{
...
export const GetActivityDataEnergyFuelConsumptionGeneralPaginatedDocument = gql`
  query getActivityDataEnergyFuelConsumptionGeneralPaginated(
    $organization_address_ids: [uuid!]!
    $limit: Int
    $offset: Int
    $order_by: [GHGEnergyConsumption_FuelPurchased_General_order_by!]
    $activityFilter: GHGEnergyConsumption_FuelPurchased_General_bool_exp = {}
 ...
 * });
 */
export function useGetActivityDataEnergyFuelConsumptionGeneralPaginatedQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetActivityDataEnergyFuelConsumptionGeneralPaginatedQuery,
    GetActivityDataEnergyFuelConsumptionGeneralPaginatedQueryVariables
  > &
    (
      | {
  ...
  return Apollo.useQuery<
    GetActivityDataEnergyFuelConsumptionGeneralPaginatedQuery,
    GetActivityDataEnergyFuelConsumptionGeneralPaginatedQueryVariables
  >(GetActivityDataEnergyFuelConsumptionGeneralPaginatedDocument, options);
}
export function useGetActivityDataEnergyFuelConsumptionGeneralPaginatedLazyQuery(
...
// @ts-ignore
export function useGetActivityDataEnergyFuelConsumptionGeneralPaginatedSuspenseQuery(
...
export function useGetActivityDataEnergyFuelConsumptionGeneralPaginatedSuspenseQuery(
  ...
  GetActivityDataEnergyFuelConsumptionGeneralPaginatedQuery | undefined,
  GetActivityDataEnergyFuelConsumptionGeneralPaginatedQueryVariables
>;
export function useGetActivityDataEnergyFuelConsumptionGeneralPaginatedSuspenseQuery(
  baseOptions?:
...
export type GetActivityDataEnergyFuelConsumptionGeneralPaginatedQueryHookResult =
  ReturnType<
    typeof useGetActivityDataEnergyFuelConsumptionGeneralPaginatedQuery
  >;
export type GetActivityDataEnergyFuelConsumptionGeneralPaginatedLazyQueryHookResult =
  ReturnType<
    typeof useGetActivityDataEnergyFuelConsumptionGeneralPaginatedLazyQuery
  >;
export type GetActivityDataEnergyFuelConsumptionGeneralPaginatedSuspenseQueryHookResult =
  ReturnType<
    typeof useGetActivityDataEnergyFuelConsumptionGeneralPaginatedSuspenseQuery
  >;
export type GetActivityDataEnergyFuelConsumptionGeneralPaginatedQueryResult =
  Apollo.QueryResult<
    GetActivityDataEnergyFuelConsumptionGeneralPaginatedQuery,
    GetActivityDataEnergyFuelConsumptionGeneralPaginatedQueryVariables
  >;

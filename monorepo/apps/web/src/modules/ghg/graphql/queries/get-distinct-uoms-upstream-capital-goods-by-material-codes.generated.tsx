...
export type GetDistinctUoMsUpstreamCapitalGoodsByMaterialCodesQueryVariables =
  Types.Exact<{
...
export const GetDistinctUoMsUpstreamCapitalGoodsByMaterialCodesDocument = gql`
  query getDistinctUOMsUpstreamCapitalGoodsByMaterialCodes(
    $whereUpstream: GHGTransport_Upstream_bool_exp!
    $whereCapitalGoods: GHGCapital_Goods_bool_exp!
    $whereMaterialMaster: OrgMaterialMaster_bool_exp!
  ) {
...
export function useGetDistinctUoMsUpstreamCapitalGoodsByMaterialCodesQuery(
  ...
  > &
    (
      | {
          variables: GetDistinctUoMsUpstreamCapitalGoodsByMaterialCodesQueryVariables;
          skip?: boolean;
        }
      | { skip: boolean }
    )
  ...
  return Apollo.useQuery<
    GetDistinctUoMsUpstreamCapitalGoodsByMaterialCodesQuery,
    GetDistinctUoMsUpstreamCapitalGoodsByMaterialCodesQueryVariables
  >(GetDistinctUoMsUpstreamCapitalGoodsByMaterialCodesDocument, options);
}
export function useGetDistinctUoMsUpstreamCapitalGoodsByMaterialCodesLazyQuery(
...
// @ts-ignore
export function useGetDistinctUoMsUpstreamCapitalGoodsByMaterialCodesSuspenseQuery(
...
export function useGetDistinctUoMsUpstreamCapitalGoodsByMaterialCodesSuspenseQuery(
  ...
  GetDistinctUoMsUpstreamCapitalGoodsByMaterialCodesQuery | undefined,
  GetDistinctUoMsUpstreamCapitalGoodsByMaterialCodesQueryVariables
>;
export function useGetDistinctUoMsUpstreamCapitalGoodsByMaterialCodesSuspenseQuery(
  baseOptions?:
...
export type GetDistinctUoMsUpstreamCapitalGoodsByMaterialCodesQueryHookResult =
  ReturnType<typeof useGetDistinctUoMsUpstreamCapitalGoodsByMaterialCodesQuery>;
export type GetDistinctUoMsUpstreamCapitalGoodsByMaterialCodesLazyQueryHookResult =
  ReturnType<
    typeof useGetDistinctUoMsUpstreamCapitalGoodsByMaterialCodesLazyQuery
  >;
export type GetDistinctUoMsUpstreamCapitalGoodsByMaterialCodesSuspenseQueryHookResult =
  ReturnType<
    typeof useGetDistinctUoMsUpstreamCapitalGoodsByMaterialCodesSuspenseQuery
  >;
export type GetDistinctUoMsUpstreamCapitalGoodsByMaterialCodesQueryResult =
  Apollo.QueryResult<
    GetDistinctUoMsUpstreamCapitalGoodsByMaterialCodesQuery,
    GetDistinctUoMsUpstreamCapitalGoodsByMaterialCodesQueryVariables
  >;

...
export type GetActivityMasterDataForDefaultRowsQueryVariables = Types.Exact<{
  ...
  organizationAddressIds?: Types.InputMaybe<
...
export type GetActivityMasterDataForDefaultRowsQuery = {
 ...
 * });
 */
export function useGetActivityMasterDataForDefaultRowsQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetActivityMasterDataForDefaultRowsQuery,
    GetActivityMasterDataForDefaultRowsQueryVariables
  > &
    (
      | {
          variables: GetActivityMasterDataForDefaultRowsQueryVariables;
          skip?: boolean;
        }
      | { skip: boolean }
    )
  ...
  return Apollo.useQuery<
    GetActivityMasterDataForDefaultRowsQuery,
    GetActivityMasterDataForDefaultRowsQueryVariables
  >(GetActivityMasterDataForDefaultRowsDocument, options);
}
export function useGetActivityMasterDataForDefaultRowsLazyQuery(
...
// @ts-ignore
export function useGetActivityMasterDataForDefaultRowsSuspenseQuery(
...
export function useGetActivityMasterDataForDefaultRowsSuspenseQuery(
  ...
  GetActivityMasterDataForDefaultRowsQuery | undefined,
  GetActivityMasterDataForDefaultRowsQueryVariables
>;
export function useGetActivityMasterDataForDefaultRowsSuspenseQuery(
  baseOptions?:
...
export type GetActivityMasterDataForDefaultRowsQueryHookResult = ReturnType<
  typeof useGetActivityMasterDataForDefaultRowsQuery
>;
export type GetActivityMasterDataForDefaultRowsLazyQueryHookResult = ReturnType<
  typeof useGetActivityMasterDataForDefaultRowsLazyQuery
>;
export type GetActivityMasterDataForDefaultRowsSuspenseQueryHookResult =
  ReturnType<typeof useGetActivityMasterDataForDefaultRowsSuspenseQuery>;
export type GetActivityMasterDataForDefaultRowsQueryResult = Apollo.QueryResult<
  GetActivityMasterDataForDefaultRowsQuery,
  GetActivityMasterDataForDefaultRowsQueryVariables
>;

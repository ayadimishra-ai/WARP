...
export type GetGhgEnergyGridPowerDetailsQuery = {
  ...
  totalCount: {
    __typename?: "GHGEnergyConsumption_GridPower_aggregate";
    aggregate?: {
      __typename?: "GHGEnergyConsumption_GridPower_aggregate_fields";
      count: number;
    } | null;
  };
};
...
export const GetGhgEnergyGridPowerDetailsDocument = gql`
  query getGHGEnergyGridPowerDetails(
    $activityFilter: GHGEnergyConsumption_GridPower_bool_exp
    $start: Int
    $size: Int
    $orderBy: [GHGEnergyConsumption_GridPower_order_by!]
  ) {
    ...
    totalCount: GHGEnergyConsumption_GridPower_aggregate(
      where: $activityFilter
    ) {
      aggregate {
        count
 ...
 * });
 */
export function useGetGhgEnergyGridPowerDetailsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetGhgEnergyGridPowerDetailsQuery,
    GetGhgEnergyGridPowerDetailsQueryVariables
  >
) {
  ...
  return Apollo.useQuery<
    GetGhgEnergyGridPowerDetailsQuery,
    GetGhgEnergyGridPowerDetailsQueryVariables
  >(GetGhgEnergyGridPowerDetailsDocument, options);
}
export function useGetGhgEnergyGridPowerDetailsLazyQuery(
...
// @ts-ignore
export function useGetGhgEnergyGridPowerDetailsSuspenseQuery(
...
export function useGetGhgEnergyGridPowerDetailsSuspenseQuery(
  ...
  GetGhgEnergyGridPowerDetailsQuery | undefined,
  GetGhgEnergyGridPowerDetailsQueryVariables
>;
export function useGetGhgEnergyGridPowerDetailsSuspenseQuery(
  baseOptions?:
...
export type GetGhgEnergyGridPowerDetailsQueryHookResult = ReturnType<
  typeof useGetGhgEnergyGridPowerDetailsQuery
>;
export type GetGhgEnergyGridPowerDetailsLazyQueryHookResult = ReturnType<
  typeof useGetGhgEnergyGridPowerDetailsLazyQuery
>;
export type GetGhgEnergyGridPowerDetailsSuspenseQueryHookResult = ReturnType<
  typeof useGetGhgEnergyGridPowerDetailsSuspenseQuery
>;
export type GetGhgEnergyGridPowerDetailsQueryResult = Apollo.QueryResult<
  GetGhgEnergyGridPowerDetailsQuery,
  GetGhgEnergyGridPowerDetailsQueryVariables
>;

 ...
 * });
 */
export function useGetLocationsAndAddressesQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetLocationsAndAddressesQuery,
    GetLocationsAndAddressesQueryVariables
  > &
    (
      | { variables: GetLocationsAndAddressesQueryVariables; skip?: boolean }
      | { skip: boolean }
    )
) {
  ...
  return Apollo.useQuery<
    GetLocationsAndAddressesQuery,
    GetLocationsAndAddressesQueryVariables
  >(GetLocationsAndAddressesDocument, options);
}
export function useGetLocationsAndAddressesLazyQuery(
...
// @ts-ignore
export function useGetLocationsAndAddressesSuspenseQuery(
...
export function useGetLocationsAndAddressesSuspenseQuery(
  ...
  GetLocationsAndAddressesQuery | undefined,
  GetLocationsAndAddressesQueryVariables
>;
export function useGetLocationsAndAddressesSuspenseQuery(
  baseOptions?:
...
export type GetLocationsAndAddressesQueryHookResult = ReturnType<
  typeof useGetLocationsAndAddressesQuery
>;
export type GetLocationsAndAddressesLazyQueryHookResult = ReturnType<
  typeof useGetLocationsAndAddressesLazyQuery
>;
export type GetLocationsAndAddressesSuspenseQueryHookResult = ReturnType<
  typeof useGetLocationsAndAddressesSuspenseQuery
>;
export type GetLocationsAndAddressesQueryResult = Apollo.QueryResult<
  GetLocationsAndAddressesQuery,
  GetLocationsAndAddressesQueryVariables
>;

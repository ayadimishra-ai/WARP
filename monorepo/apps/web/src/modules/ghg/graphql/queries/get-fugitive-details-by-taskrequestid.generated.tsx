...
export type GetFugitiveDataByTaskRequestIdsQuery = {
  ...
  GHGRefrigerantAndACSystems: Array<{
  ...
  GHGIndustrialGas: Array<{
    __typename?: "GHGIndustrialGas";
    id: any;
    task_request_id: any;
    organization_address_id: any;
    type_of_industrial_gas_used?: string | null;
    quantity_of_industrial_gas_filled?: any | null;
    uom_industrial_gas?: string | null;
    TaskRequest: {
      __typename?: "TaskRequest";
      year?: number | null;
      month: string;
 ...
 * });
 */
export function useGetFugitiveDataByTaskRequestIdsQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetFugitiveDataByTaskRequestIdsQuery,
    GetFugitiveDataByTaskRequestIdsQueryVariables
  > &
    (
      | {
          variables: GetFugitiveDataByTaskRequestIdsQueryVariables;
          skip?: boolean;
        }
      | { skip: boolean }
    )
  ...
  return Apollo.useQuery<
    GetFugitiveDataByTaskRequestIdsQuery,
    GetFugitiveDataByTaskRequestIdsQueryVariables
  >(GetFugitiveDataByTaskRequestIdsDocument, options);
}
export function useGetFugitiveDataByTaskRequestIdsLazyQuery(
...
// @ts-ignore
export function useGetFugitiveDataByTaskRequestIdsSuspenseQuery(
...
export function useGetFugitiveDataByTaskRequestIdsSuspenseQuery(
  ...
  GetFugitiveDataByTaskRequestIdsQuery | undefined,
  GetFugitiveDataByTaskRequestIdsQueryVariables
>;
export function useGetFugitiveDataByTaskRequestIdsSuspenseQuery(
  baseOptions?:
...
export type GetFugitiveDataByTaskRequestIdsQueryHookResult = ReturnType<
  typeof useGetFugitiveDataByTaskRequestIdsQuery
>;
export type GetFugitiveDataByTaskRequestIdsLazyQueryHookResult = ReturnType<
  typeof useGetFugitiveDataByTaskRequestIdsLazyQuery
>;
export type GetFugitiveDataByTaskRequestIdsSuspenseQueryHookResult = ReturnType<
  typeof useGetFugitiveDataByTaskRequestIdsSuspenseQuery
>;
export type GetFugitiveDataByTaskRequestIdsQueryResult = Apollo.QueryResult<
  GetFugitiveDataByTaskRequestIdsQuery,
  GetFugitiveDataByTaskRequestIdsQueryVariables
>;

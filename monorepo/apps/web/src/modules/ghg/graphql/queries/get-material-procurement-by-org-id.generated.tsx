 ...
 * });
 */
export function useGetMaterialProcurementDataByOrgIdQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetMaterialProcurementDataByOrgIdQuery,
    GetMaterialProcurementDataByOrgIdQueryVariables
  > &
    (
      | {
          variables: GetMaterialProcurementDataByOrgIdQueryVariables;
          skip?: boolean;
        }
      | { skip: boolean }
    )
  ...
  return Apollo.useQuery<
    GetMaterialProcurementDataByOrgIdQuery,
    GetMaterialProcurementDataByOrgIdQueryVariables
  >(GetMaterialProcurementDataByOrgIdDocument, options);
}
export function useGetMaterialProcurementDataByOrgIdLazyQuery(
...
// @ts-ignore
export function useGetMaterialProcurementDataByOrgIdSuspenseQuery(
...
export function useGetMaterialProcurementDataByOrgIdSuspenseQuery(
  ...
  GetMaterialProcurementDataByOrgIdQuery | undefined,
  GetMaterialProcurementDataByOrgIdQueryVariables
>;
export function useGetMaterialProcurementDataByOrgIdSuspenseQuery(
  baseOptions?:
...
export type GetMaterialProcurementDataByOrgIdQueryHookResult = ReturnType<
  typeof useGetMaterialProcurementDataByOrgIdQuery
>;
export type GetMaterialProcurementDataByOrgIdLazyQueryHookResult = ReturnType<
  typeof useGetMaterialProcurementDataByOrgIdLazyQuery
>;
export type GetMaterialProcurementDataByOrgIdSuspenseQueryHookResult =
  ReturnType<typeof useGetMaterialProcurementDataByOrgIdSuspenseQuery>;
export type GetMaterialProcurementDataByOrgIdQueryResult = Apollo.QueryResult<
  GetMaterialProcurementDataByOrgIdQuery,
  GetMaterialProcurementDataByOrgIdQueryVariables
>;

...
export type GetFuelConsumptionGeneralByIdQuery = {
 ...
 * });
 */
export function useGetFuelConsumptionGeneralByIdQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetFuelConsumptionGeneralByIdQuery,
    GetFuelConsumptionGeneralByIdQueryVariables
  > &
    (
      | {
          variables: GetFuelConsumptionGeneralByIdQueryVariables;
          skip?: boolean;
        }
      | { skip: boolean }
    )
  ...
  return Apollo.useQuery<
    GetFuelConsumptionGeneralByIdQuery,
    GetFuelConsumptionGeneralByIdQueryVariables
  >(GetFuelConsumptionGeneralByIdDocument, options);
}
export function useGetFuelConsumptionGeneralByIdLazyQuery(
...
// @ts-ignore
export function useGetFuelConsumptionGeneralByIdSuspenseQuery(
...
export function useGetFuelConsumptionGeneralByIdSuspenseQuery(
  ...
  GetFuelConsumptionGeneralByIdQuery | undefined,
  GetFuelConsumptionGeneralByIdQueryVariables
>;
export function useGetFuelConsumptionGeneralByIdSuspenseQuery(
  baseOptions?:
...
export type GetFuelConsumptionGeneralByIdQueryHookResult = ReturnType<
  typeof useGetFuelConsumptionGeneralByIdQuery
>;
export type GetFuelConsumptionGeneralByIdLazyQueryHookResult = ReturnType<
  typeof useGetFuelConsumptionGeneralByIdLazyQuery
>;
export type GetFuelConsumptionGeneralByIdSuspenseQueryHookResult = ReturnType<
  typeof useGetFuelConsumptionGeneralByIdSuspenseQuery
>;
export type GetFuelConsumptionGeneralByIdQueryResult = Apollo.QueryResult<
  GetFuelConsumptionGeneralByIdQuery,
  GetFuelConsumptionGeneralByIdQueryVariables
>;

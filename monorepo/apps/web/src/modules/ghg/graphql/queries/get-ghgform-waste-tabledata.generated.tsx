...
export type GetGhgWasteQuery = {
  ...
  totalCount: {
    __typename?: "GHGWaste_aggregate";
    aggregate?: {
      __typename?: "GHGWaste_aggregate_fields";
      count: number;
    } | null;
  };
};
 ...
 * });
 */
export function useGetGhgWasteQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetGhgWasteQuery,
    GetGhgWasteQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetGhgWasteQuery, GetGhgWasteQueryVariables>(
    GetGhgWasteDocument,
    options
  );
}
export function useGetGhgWasteLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetGhgWasteQuery, GetGhgWasteQueryVariables>(
    GetGhgWasteDocument,
    options
  );
}
// @ts-ignore
export function useGetGhgWasteSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<
    GetGhgWasteQuery,
    GetGhgWasteQueryVariables
  >
): Apollo.UseSuspenseQueryResult<GetGhgWasteQuery, GetGhgWasteQueryVariables>;
export function useGetGhgWasteSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
...
export function useGetGhgWasteSuspenseQuery(
  ...
  return Apollo.useSuspenseQuery<GetGhgWasteQuery, GetGhgWasteQueryVariables>(
    GetGhgWasteDocument,
    options
  );
}
export type GetGhgWasteQueryHookResult = ReturnType<typeof useGetGhgWasteQuery>;
export type GetGhgWasteLazyQueryHookResult = ReturnType<
  typeof useGetGhgWasteLazyQuery
>;
export type GetGhgWasteSuspenseQueryHookResult = ReturnType<
  typeof useGetGhgWasteSuspenseQuery
>;
export type GetGhgWasteQueryResult = Apollo.QueryResult<
  GetGhgWasteQuery,
  GetGhgWasteQueryVariables
>;

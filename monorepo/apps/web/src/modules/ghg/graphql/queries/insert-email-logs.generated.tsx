...
export type InsertEmailLogMutation = {
  __typename?: "mutation_root";
  insert_EmailLogs?: {
    __typename?: "EmailLogs_mutation_response";
    returning: Array<{
...
`;
export type InsertEmailLogMutationFn = Apollo.MutationFunction<
  InsertEmailLogMutation,
  InsertEmailLogMutationVariables
>;
 ...
 * });
 */
export function useInsertEmailLogMutation(
  ...
  return Apollo.useMutation<
    InsertEmailLogMutation,
    InsertEmailLogMutationVariables
  >(InsertEmailLogDocument, options);
}
export type InsertEmailLogMutationHookResult = ReturnType<
  typeof useInsertEmailLogMutation
>;
export type InsertEmailLogMutationResult =
  Apollo.MutationResult<InsertEmailLogMutation>;
export type InsertEmailLogMutationOptions = Apollo.BaseMutationOptions<
  InsertEmailLogMutation,
  InsertEmailLogMutationVariables
>;

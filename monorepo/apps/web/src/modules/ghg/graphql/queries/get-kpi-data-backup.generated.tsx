...
export type GetKpiDataBackupQuery = {
  ...
  currentYearKPIMain: Array<{
    ...
    month: any;
    kpi_em_uom: string;
    kpi_em_Total_Emission: any;
    kpi_em_Total_Emission_Scope1: any;
    kpi_em_Total_Emission_Scope2: any;
    kpi_em_Total_Emission_Scope3: any;
    kpi_em_TopEmission_Category: any;
    kpi_em_TopEmission_Product: any;
    kpi_em_CurrentEmissionIntensity_PerTonProduction: any;
    kpi_em_CurrentEmissionIntensity_PerEmployee: any;
    kpi_em_CurrentEmissionIntensity_PerProduct: any;
    kpi_em_Cont_TotalEmission_StreamOfWork_Upstream: any;
    kpi_em_Cont_TotalEmission_StreamOfWork_Operations: any;
    kpi_em_Cont_TotalEmission_StreamOfWork_Downstream: any;
    kpi_em_Cont_TotalEmission_Categories_Energy: any;
    kpi_em_Cont_TotalEmission_Categories_Waste: any;
    kpi_em_Cont_TotalEmission_Categories_Transport: any;
    kpi_em_Cont_TotalEmission_Categories_Material: any;
    timestamp: any;
  ...
  baselineCurrentYearKPIMain: Array<{
    __typename?: "KPIMain";
    organization_id: any;
    region_id: any;
    address_id: any;
  ...
  organizationLevelKPIMain: Array<{
    __typename?: "KPIMain";
    organization_id: any;
    region_id: any;
    address_id: any;
  ...
  previousYearOrganisationLevelKPIMain: Array<{
    __typename?: "KPIMain";
    organization_id: any;
    region_id: any;
    address_id: any;
  ...
  currentYearKPIEmissionByPowerConsumption: Array<{
    ...
    year: any;
    month: any;
    kpi_em_PowerPurchased_RenewableSources: any;
    kpi_em_PowerPurchased_NonRenewableSources: any;
    kpi_em_TotalPowerPurchased: any;
    kpi_em_Emission_PowerPurchased_PPA_Renewable: any;
    kpi_em_PowerPurchased_PPA_NonRenewable: any;
    kpi_em_Emission_PowerPurchased_REC: any;
    kpi_em_Renewable_CaptivePower: any;
    kpi_em_NonRenewable_CaptivePower: any;
    kpi_em_CaptivePower: any;
    kpi_em_PowerConsumption_Scope2: any;
    kpi_em_PowerConsumption_Scope1: any;
    kpi_CaptivePower_GeneratedUnits?: any | null;
    kpi_TotalPowerPurchased_GeneratedUnits?: any | null;
  }>;
  previousYearKPIEmissionByPowerConsumption: Array<{
    __typename?: "KPIEmissionByPowerConsumption";
    organization_id: any;
    region_id: any;
    address_id: any;
  ...
  currentYearKPIEmissionByFuelConsumption: Array<{
    ...
    year: any;
    month: any;
    kpi_em_Diesel_Consumption?: any | null;
    kpi_em_Gasoline_Consumption?: any | null;
    kpi_em_Biodiesel_Consumption?: any | null;
    kpi_em_Ethanol_Consumption?: any | null;
    kpi_em_LPG_Consumption?: any | null;
    kpi_em_CNG_Consumption?: any | null;
    kpi_em_GaseousNitrogen_Consumption?: any | null;
    kpi_em_GaseousOxygen_Consumption?: any | null;
    kpi_em_LiquidNitrogen_Consumption?: any | null;
    kpi_em_CompressedAir_Consumption?: any | null;
    kpi_em_Electric_Consumption?: any | null;
    kpi_em_JetFuel_Consumption?: any | null;
    kpi_em_SAF_Consumption?: any | null;
    kpi_em_TotalEmission_FuelConsumption?: any | null;
    kpi_em_FuelConsumption_Scope1?: any | null;
  }>;
  previousYearKPIEmissionByFuelConsumption: Array<{
    __typename?: "KPIEmissionByFuelConsumption";
    organization_id: any;
    region_id: any;
    address_id: any;
  ...
  currentYearKPIEmissionByTransportation: Array<{
    ...
    kpi_em_UpstreamTransport_Scope1: any;
    kpi_em_UpstreamTransport_Scope3: any;
    kpi_em_DownstreamTransport_Scope1: any;
    kpi_em_DownstreamTransport_Scope3: any;
    kpi_em_DownstreamTransport: any;
    kpi_em_EmployeeTravel: any;
    kpi_em_EmployeeTravel_Scope1: any;
    kpi_em_EmployeeTravel_Scope3: any;
    kpi_em_BusinessTravel: any;
    kpi_em_BusinessTravel_Scope3: any;
    kpi_em_Transport_WasteManagement: any;
    kpi_em_Transport_WasteManagement_Scope1: any;
    kpi_em_Transport_WasteManagement_Scope3: any;
    kpi_em_TotalEmission_Transport: any;
    kpi_em_Transport_Scope1: any;
    kpi_em_Transport_Scope3: any;
  }>;
  previousYearKPIEmissionByTransportation: Array<{
    __typename?: "KPIEmissionByTransportation";
    organization_id: any;
    region_id: any;
    address_id: any;
  ...
  currentYearKPIEmissionByMaterialConsumption: Array<{
    ...
    kpi_em_MaterialProcurement_Scope1: any;
    kpi_em_MaterialProcurement_Scope3: any;
  }>;
  previousYearKPIEmissionByMaterialConsumption: Array<{
    __typename?: "KPIEmissionByMaterialConsumption";
    organization_id: any;
    region_id: any;
    address_id: any;
  ...
  currentYearKPIEmissionByWasteGeneration: Array<{
    ...
    kpi_em_WasteGeneration_Scope1: any;
    kpi_em_WasteGeneration_Scope3: any;
  }>;
  previousYearKPIEmissionByWasteGeneration: Array<{
    __typename?: "KPIEmissionByWasteGeneration";
    organization_id: any;
    region_id: any;
    address_id: any;
  ...
  currentYearKPIEmissionByMaterialConsumptionSuppliers: Array<{
  ...
  previousYearKPIEmissionByMaterialConsumptionSuppliers: Array<{
    __typename?: "KPIEmissionByMaterialConsumption_Suppliers";
    organization_id: any;
    year: any;
    month: any;
  ...
  currentYearKPIEmissionByPowerConsumption_Vendors: Array<{
  ...
  previousYearKPIEmissionByPowerConsumption_Vendors: Array<{
    __typename?: "KPIEmissionByPowerConsumption_Vendors";
    organization_id: any;
    year: any;
    month: any;
  ...
  currentYearKPIEmissionByProducts: Array<{
    __typename?: "KPIEmissionByProducts";
    organization_id: any;
    year: any;
    month: any;
    product_id: string;
  ...
  previousYearKPIEmissionByProducts: Array<{
    __typename?: "KPIEmissionByProducts";
    organization_id: any;
    year: any;
    month: any;
...
export const GetKpiDataBackupDocument = gql`
  query GetKPIDataBackup(
    ...
    $from_month: numeric!
    $to_month: numeric!
    $previous_from_year: numeric!
    $previous_to_year: numeric!
    $previous_from_month: numeric!
    $previous_to_month: numeric!
    $baseline_from_year: numeric!
    $baseline_to_year: numeric!
    $baseline_from_month: numeric!
    $baseline_to_month: numeric!
    $baseline_from_year_current: numeric!
    $baseline_to_year_current: numeric!
    $baseline_from_month_current: numeric!
    $baseline_to_month_current: numeric!
  ) {
    currentYearKPIMain: KPIMain(
      where: {
        organization_id: { _eq: $organization_id }
        address_id: { _in: $address_id }
        region_id: { _in: $region_id }
        _and: [
          {
            _or: [
              {
        ...
        _and: [
          {
            _or: [
              {
                _and: [
                  { year: { _eq: $previous_from_year } }
                  { month: { _gte: $previous_from_month } }
                ]
              }
              { year: { _gt: $previous_from_year } }
            ]
          }
          {
            _or: [
              {
                _and: [
                  { year: { _eq: $previous_to_year } }
                  { month: { _lte: $previous_to_month } }
                ]
              }
              { year: { _lt: $previous_to_year } }
            ]
          }
        ]
      }
        ...
        _and: [
          {
            _or: [
              {
                _and: [
                  { year: { _eq: $baseline_from_year } }
                  { month: { _gte: $baseline_from_month } }
                ]
              }
              { year: { _gt: $baseline_from_year } }
            ]
          }
          {
            _or: [
              {
                _and: [
                  { year: { _eq: $baseline_to_year } }
                  { month: { _lte: $baseline_to_month } }
                ]
              }
              { year: { _lt: $baseline_to_year } }
            ]
          }
        ]
      }
        ...
        _and: [
          {
            _or: [
              {
                _and: [
                  { year: { _eq: $baseline_from_year_current } }
                  { month: { _gte: $baseline_from_month_current } }
                ]
              }
              { year: { _gt: $baseline_from_year_current } }
            ]
          }
          {
            _or: [
              {
                _and: [
                  { year: { _eq: $baseline_to_year_current } }
                  { month: { _lte: $baseline_to_month_current } }
                ]
              }
              { year: { _lt: $baseline_to_year_current } }
            ]
          }
        ]
      }
 ...
 * });
 */
export function useGetKpiDataBackupQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetKpiDataBackupQuery,
    GetKpiDataBackupQueryVariables
  > &
    (
      | { variables: GetKpiDataBackupQueryVariables; skip?: boolean }
      | { skip: boolean }
    )
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetKpiDataBackupQuery, GetKpiDataBackupQueryVariables>(
    GetKpiDataBackupDocument,
    options
  );
}
export function useGetKpiDataBackupLazyQuery(
  ...
  return Apollo.useLazyQuery<
    GetKpiDataBackupQuery,
    GetKpiDataBackupQueryVariables
  >(GetKpiDataBackupDocument, options);
}
// @ts-ignore
export function useGetKpiDataBackupSuspenseQuery(
...
export function useGetKpiDataBackupSuspenseQuery(
  ...
  GetKpiDataBackupQuery | undefined,
  GetKpiDataBackupQueryVariables
>;
export function useGetKpiDataBackupSuspenseQuery(
  baseOptions?:
...
export type GetKpiDataBackupQueryHookResult = ReturnType<
  typeof useGetKpiDataBackupQuery
>;
export type GetKpiDataBackupLazyQueryHookResult = ReturnType<
  typeof useGetKpiDataBackupLazyQuery
>;
export type GetKpiDataBackupSuspenseQueryHookResult = ReturnType<
  typeof useGetKpiDataBackupSuspenseQuery
>;
export type GetKpiDataBackupQueryResult = Apollo.QueryResult<
  GetKpiDataBackupQuery,
  GetKpiDataBackupQueryVariables
>;

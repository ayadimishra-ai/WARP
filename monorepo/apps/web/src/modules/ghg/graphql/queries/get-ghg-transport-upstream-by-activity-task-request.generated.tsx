...
export type GetghgTransportUpstreamByActivityTaskRequestQueryVariables =
  Types.Exact<{
    task_request_id:
...
export type GetghgTransportUpstreamByActivityTaskRequestQuery = {
...
export const GetghgTransportUpstreamByActivityTaskRequestDocument = gql`
  query getghgTransportUpstreamByActivityTaskRequest(
 ...
 * });
 */
export function useGetghgTransportUpstreamByActivityTaskRequestQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetghgTransportUpstreamByActivityTaskRequestQuery,
    GetghgTransportUpstreamByActivityTaskRequestQueryVariables
  > &
    (
      | {
          variables: GetghgTransportUpstreamByActivityTaskRequestQueryVariables;
          skip?: boolean;
        }
      | { skip: boolean }
    )
  ...
  return Apollo.useQuery<
    GetghgTransportUpstreamByActivityTaskRequestQuery,
    GetghgTransportUpstreamByActivityTaskRequestQueryVariables
  >(GetghgTransportUpstreamByActivityTaskRequestDocument, options);
}
export function useGetghgTransportUpstreamByActivityTaskRequestLazyQuery(
...
// @ts-ignore
export function useGetghgTransportUpstreamByActivityTaskRequestSuspenseQuery(
...
export function useGetghgTransportUpstreamByActivityTaskRequestSuspenseQuery(
  ...
  GetghgTransportUpstreamByActivityTaskRequestQuery | undefined,
  GetghgTransportUpstreamByActivityTaskRequestQueryVariables
>;
export function useGetghgTransportUpstreamByActivityTaskRequestSuspenseQuery(
  baseOptions?:
...
export type GetghgTransportUpstreamByActivityTaskRequestQueryHookResult =
  ReturnType<typeof useGetghgTransportUpstreamByActivityTaskRequestQuery>;
export type GetghgTransportUpstreamByActivityTaskRequestLazyQueryHookResult =
  ReturnType<typeof useGetghgTransportUpstreamByActivityTaskRequestLazyQuery>;
export type GetghgTransportUpstreamByActivityTaskRequestSuspenseQueryHookResult =
  ReturnType<
    typeof useGetghgTransportUpstreamByActivityTaskRequestSuspenseQuery
  >;
export type GetghgTransportUpstreamByActivityTaskRequestQueryResult =
  Apollo.QueryResult<
    GetghgTransportUpstreamByActivityTaskRequestQuery,
    GetghgTransportUpstreamByActivityTaskRequestQueryVariables
  >;

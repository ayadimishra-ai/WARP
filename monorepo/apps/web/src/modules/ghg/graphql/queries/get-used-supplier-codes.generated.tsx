...
export const GetUsedSupplierCodesDocument = gql`
  query getUsedSupplierCodes(
    $capitalGoodsWhere: GHGCapital_Goods_bool_exp!
    $materialProcurementWhere: GHGMaterialProcurement_bool_exp!
    $transportUpstreamWhere: GHGTransport_Upstream_bool_exp!
  ) {
 ...
 * });
 */
export function useGetUsedSupplierCodesQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetUsedSupplierCodesQuery,
    GetUsedSupplierCodesQueryVariables
  > &
    (
      | { variables: GetUsedSupplierCodesQueryVariables; skip?: boolean }
      | { skip: boolean }
    )
) {
  ...
  return Apollo.useQuery<
    GetUsedSupplierCodesQuery,
    GetUsedSupplierCodesQueryVariables
  >(GetUsedSupplierCodesDocument, options);
}
export function useGetUsedSupplierCodesLazyQuery(
...
// @ts-ignore
export function useGetUsedSupplierCodesSuspenseQuery(
...
export function useGetUsedSupplierCodesSuspenseQuery(
  ...
  GetUsedSupplierCodesQuery | undefined,
  GetUsedSupplierCodesQueryVariables
>;
export function useGetUsedSupplierCodesSuspenseQuery(
  baseOptions?:
...
export type GetUsedSupplierCodesQueryHookResult = ReturnType<
  typeof useGetUsedSupplierCodesQuery
>;
export type GetUsedSupplierCodesLazyQueryHookResult = ReturnType<
  typeof useGetUsedSupplierCodesLazyQuery
>;
export type GetUsedSupplierCodesSuspenseQueryHookResult = ReturnType<
  typeof useGetUsedSupplierCodesSuspenseQuery
>;
export type GetUsedSupplierCodesQueryResult = Apollo.QueryResult<
  GetUsedSupplierCodesQuery,
  GetUsedSupplierCodesQueryVariables
>;

...
export type GetemissionfactorQuery = {
  __typename?: "query_root";
  Region: Array<{
    __typename?: "Region";
    CO2EmissionFactorMasters: Array<{
 ...
 * });
 */
export function useGetemissionfactorQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetemissionfactorQuery,
    GetemissionfactorQueryVariables
  >
) {
  ...
  return Apollo.useQuery<
    GetemissionfactorQuery,
    GetemissionfactorQueryVariables
  >(GetemissionfactorDocument, options);
}
export function useGetemissionfactorLazyQuery(
...
// @ts-ignore
export function useGetemissionfactorSuspenseQuery(
...
export function useGetemissionfactorSuspenseQuery(
  ...
  GetemissionfactorQuery | undefined,
  GetemissionfactorQueryVariables
>;
export function useGetemissionfactorSuspenseQuery(
  baseOptions?:
...
export type GetemissionfactorQueryHookResult = ReturnType<
  typeof useGetemissionfactorQuery
>;
export type GetemissionfactorLazyQueryHookResult = ReturnType<
  typeof useGetemissionfactorLazyQuery
>;
export type GetemissionfactorSuspenseQueryHookResult = ReturnType<
  typeof useGetemissionfactorSuspenseQuery
>;
export type GetemissionfactorQueryResult = Apollo.QueryResult<
  GetemissionfactorQuery,
  GetemissionfactorQueryVariables
>;

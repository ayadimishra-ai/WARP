 ...
 * });
 */
export function useGetAddressDetailQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetAddressDetailQuery,
    GetAddressDetailQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetAddressDetailQuery, GetAddressDetailQueryVariables>(
    GetAddressDetailDocument,
    options
  );
}
export function useGetAddressDetailLazyQuery(
  ...
  return Apollo.useLazyQuery<
    GetAddressDetailQuery,
    GetAddressDetailQueryVariables
  >(GetAddressDetailDocument, options);
}
// @ts-ignore
export function useGetAddressDetailSuspenseQuery(
...
export function useGetAddressDetailSuspenseQuery(
  ...
  GetAddressDetailQuery | undefined,
  GetAddressDetailQueryVariables
>;
export function useGetAddressDetailSuspenseQuery(
  baseOptions?:
...
export type GetAddressDetailQueryHookResult = ReturnType<
  typeof useGetAddressDetailQuery
>;
export type GetAddressDetailLazyQueryHookResult = ReturnType<
  typeof useGetAddressDetailLazyQuery
>;
export type GetAddressDetailSuspenseQueryHookResult = ReturnType<
  typeof useGetAddressDetailSuspenseQuery
>;
export type GetAddressDetailQueryResult = Apollo.QueryResult<
  GetAddressDetailQuery,
  GetAddressDetailQueryVariables
>;

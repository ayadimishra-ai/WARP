 ...
 * });
 */
export function useGetGhgWasteByTaskRequestIdsQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetGhgWasteByTaskRequestIdsQuery,
    GetGhgWasteByTaskRequestIdsQueryVariables
  > &
    (
      | { variables: GetGhgWasteByTaskRequestIdsQueryVariables; skip?: boolean }
      | { skip: boolean }
    )
) {
  ...
  return Apollo.useQuery<
    GetGhgWasteByTaskRequestIdsQuery,
    GetGhgWasteByTaskRequestIdsQueryVariables
  >(GetGhgWasteByTaskRequestIdsDocument, options);
}
export function useGetGhgWasteByTaskRequestIdsLazyQuery(
...
// @ts-ignore
export function useGetGhgWasteByTaskRequestIdsSuspenseQuery(
...
export function useGetGhgWasteByTaskRequestIdsSuspenseQuery(
  ...
  GetGhgWasteByTaskRequestIdsQuery | undefined,
  GetGhgWasteByTaskRequestIdsQueryVariables
>;
export function useGetGhgWasteByTaskRequestIdsSuspenseQuery(
  baseOptions?:
...
export type GetGhgWasteByTaskRequestIdsQueryHookResult = ReturnType<
  typeof useGetGhgWasteByTaskRequestIdsQuery
>;
export type GetGhgWasteByTaskRequestIdsLazyQueryHookResult = ReturnType<
  typeof useGetGhgWasteByTaskRequestIdsLazyQuery
>;
export type GetGhgWasteByTaskRequestIdsSuspenseQueryHookResult = ReturnType<
  typeof useGetGhgWasteByTaskRequestIdsSuspenseQuery
>;
export type GetGhgWasteByTaskRequestIdsQueryResult = Apollo.QueryResult<
  GetGhgWasteByTaskRequestIdsQuery,
  GetGhgWasteByTaskRequestIdsQueryVariables
>;

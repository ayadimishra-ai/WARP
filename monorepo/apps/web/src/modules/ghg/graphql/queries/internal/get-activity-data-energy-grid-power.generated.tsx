...
export type GetActivityDataEnergyGridPowerQuery = {
  __typename?: "query_root";
  TaskRequest: Array<{
    __typename?: "TaskRequest";
    month: string;
    year?: number | null;
    energy_grid_power: Array<{
 ...
 * });
 */
export function useGetActivityDataEnergyGridPowerQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetActivityDataEnergyGridPowerQuery,
    GetActivityDataEnergyGridPowerQueryVariables
  > &
    (
      | {
          variables: GetActivityDataEnergyGridPowerQueryVariables;
          skip?: boolean;
        }
      | { skip: boolean }
    )
  ...
  return Apollo.useQuery<
    GetActivityDataEnergyGridPowerQuery,
    GetActivityDataEnergyGridPowerQueryVariables
  >(GetActivityDataEnergyGridPowerDocument, options);
}
export function useGetActivityDataEnergyGridPowerLazyQuery(
...
// @ts-ignore
export function useGetActivityDataEnergyGridPowerSuspenseQuery(
...
export function useGetActivityDataEnergyGridPowerSuspenseQuery(
  ...
  GetActivityDataEnergyGridPowerQuery | undefined,
  GetActivityDataEnergyGridPowerQueryVariables
>;
export function useGetActivityDataEnergyGridPowerSuspenseQuery(
  baseOptions?:
...
export type GetActivityDataEnergyGridPowerQueryHookResult = ReturnType<
  typeof useGetActivityDataEnergyGridPowerQuery
>;
export type GetActivityDataEnergyGridPowerLazyQueryHookResult = ReturnType<
  typeof useGetActivityDataEnergyGridPowerLazyQuery
>;
export type GetActivityDataEnergyGridPowerSuspenseQueryHookResult = ReturnType<
  typeof useGetActivityDataEnergyGridPowerSuspenseQuery
>;
export type GetActivityDataEnergyGridPowerQueryResult = Apollo.QueryResult<
  GetActivityDataEnergyGridPowerQuery,
  GetActivityDataEnergyGridPowerQueryVariables
>;

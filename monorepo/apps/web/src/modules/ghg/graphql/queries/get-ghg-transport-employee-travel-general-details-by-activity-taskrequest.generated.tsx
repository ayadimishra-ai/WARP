...
export type GetGhgEmployeeTravelGeneralDetailsByActivityTaskRequestQueryVariables =
  Types.Exact<{
    task_request_id:
...
export type GetGhgEmployeeTravelGeneralDetailsByActivityTaskRequestQuery = {
  ...
  GHGTransport_EmployeeTravel: Array<{
...
export const GetGhgEmployeeTravelGeneralDetailsByActivityTaskRequestDocument = gql`
  query getGHGEmployeeTravelGeneralDetailsByActivityTaskRequest(
 ...
 * });
 */
export function useGetGhgEmployeeTravelGeneralDetailsByActivityTaskRequestQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetGhgEmployeeTravelGeneralDetailsByActivityTaskRequestQuery,
    GetGhgEmployeeTravelGeneralDetailsByActivityTaskRequestQueryVariables
  > &
    (
      | {
          variables: GetGhgEmployeeTravelGeneralDetailsByActivityTaskRequestQueryVariables;
          skip?: boolean;
        }
      | { skip: boolean }
    )
  ...
  return Apollo.useQuery<
    GetGhgEmployeeTravelGeneralDetailsByActivityTaskRequestQuery,
    GetGhgEmployeeTravelGeneralDetailsByActivityTaskRequestQueryVariables
  >(GetGhgEmployeeTravelGeneralDetailsByActivityTaskRequestDocument, options);
}
export function useGetGhgEmployeeTravelGeneralDetailsByActivityTaskRequestLazyQuery(
...
// @ts-ignore
export function useGetGhgEmployeeTravelGeneralDetailsByActivityTaskRequestSuspenseQuery(
...
export function useGetGhgEmployeeTravelGeneralDetailsByActivityTaskRequestSuspenseQuery(
  ...
  GetGhgEmployeeTravelGeneralDetailsByActivityTaskRequestQuery | undefined,
  GetGhgEmployeeTravelGeneralDetailsByActivityTaskRequestQueryVariables
>;
export function useGetGhgEmployeeTravelGeneralDetailsByActivityTaskRequestSuspenseQuery(
  baseOptions?:
...
export type GetGhgEmployeeTravelGeneralDetailsByActivityTaskRequestQueryHookResult =
  ReturnType<
    typeof useGetGhgEmployeeTravelGeneralDetailsByActivityTaskRequestQuery
  >;
export type GetGhgEmployeeTravelGeneralDetailsByActivityTaskRequestLazyQueryHookResult =
  ReturnType<
    typeof useGetGhgEmployeeTravelGeneralDetailsByActivityTaskRequestLazyQuery
  >;
export type GetGhgEmployeeTravelGeneralDetailsByActivityTaskRequestSuspenseQueryHookResult =
  ReturnType<
    typeof useGetGhgEmployeeTravelGeneralDetailsByActivityTaskRequestSuspenseQuery
  >;
export type GetGhgEmployeeTravelGeneralDetailsByActivityTaskRequestQueryResult =
  Apollo.QueryResult<
    GetGhgEmployeeTravelGeneralDetailsByActivityTaskRequestQuery,
    GetGhgEmployeeTravelGeneralDetailsByActivityTaskRequestQueryVariables
  >;

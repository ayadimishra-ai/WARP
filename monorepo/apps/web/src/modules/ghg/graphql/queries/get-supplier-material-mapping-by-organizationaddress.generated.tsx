...
export type GetSupplierMaterialMappingsByOrganizationAddressQueryVariables =
  Types.Exact<{
...
export const GetSupplierMaterialMappingsByOrganizationAddressDocument = gql`
  query getSupplierMaterialMappingsByOrganizationAddress(
    $organizationAddressId: uuid!
  ) {
    SupplierMaterialMapping(
      where: {
        SupplierAddressMapping: {
          supplier_organization_address_id: { _eq: $organizationAddressId }
        }
      }
    ) {
 ...
 * });
 */
export function useGetSupplierMaterialMappingsByOrganizationAddressQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetSupplierMaterialMappingsByOrganizationAddressQuery,
  ...
  return Apollo.useQuery<
    GetSupplierMaterialMappingsByOrganizationAddressQuery,
    GetSupplierMaterialMappingsByOrganizationAddressQueryVariables
  >(GetSupplierMaterialMappingsByOrganizationAddressDocument, options);
}
export function useGetSupplierMaterialMappingsByOrganizationAddressLazyQuery(
...
// @ts-ignore
export function useGetSupplierMaterialMappingsByOrganizationAddressSuspenseQuery(
...
export function useGetSupplierMaterialMappingsByOrganizationAddressSuspenseQuery(
  ...
  GetSupplierMaterialMappingsByOrganizationAddressQuery | undefined,
  GetSupplierMaterialMappingsByOrganizationAddressQueryVariables
>;
export function useGetSupplierMaterialMappingsByOrganizationAddressSuspenseQuery(
  baseOptions?:
...
export type GetSupplierMaterialMappingsByOrganizationAddressQueryHookResult =
  ReturnType<typeof useGetSupplierMaterialMappingsByOrganizationAddressQuery>;
export type GetSupplierMaterialMappingsByOrganizationAddressLazyQueryHookResult =
  ReturnType<
    typeof useGetSupplierMaterialMappingsByOrganizationAddressLazyQuery
  >;
export type GetSupplierMaterialMappingsByOrganizationAddressSuspenseQueryHookResult =
  ReturnType<
    typeof useGetSupplierMaterialMappingsByOrganizationAddressSuspenseQuery
  >;
export type GetSupplierMaterialMappingsByOrganizationAddressQueryResult =
  Apollo.QueryResult<
    GetSupplierMaterialMappingsByOrganizationAddressQuery,
    GetSupplierMaterialMappingsByOrganizationAddressQueryVariables
  >;

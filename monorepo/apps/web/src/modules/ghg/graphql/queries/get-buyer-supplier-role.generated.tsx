 ...
 * });
 */
export function useGetBuyerSupplierRoleQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetBuyerSupplierRoleQuery,
    GetBuyerSupplierRoleQueryVariables
  >
) {
  ...
  return Apollo.useQuery<
    GetBuyerSupplierRoleQuery,
    GetBuyerSupplierRoleQueryVariables
  >(GetBuyerSupplierRoleDocument, options);
}
export function useGetBuyerSupplierRoleLazyQuery(
...
// @ts-ignore
export function useGetBuyerSupplierRoleSuspenseQuery(
...
export function useGetBuyerSupplierRoleSuspenseQuery(
  ...
  GetBuyerSupplierRoleQuery | undefined,
  GetBuyerSupplierRoleQueryVariables
>;
export function useGetBuyerSupplierRoleSuspenseQuery(
  baseOptions?:
...
export type GetBuyerSupplierRoleQueryHookResult = ReturnType<
  typeof useGetBuyerSupplierRoleQuery
>;
export type GetBuyerSupplierRoleLazyQueryHookResult = ReturnType<
  typeof useGetBuyerSupplierRoleLazyQuery
>;
export type GetBuyerSupplierRoleSuspenseQueryHookResult = ReturnType<
  typeof useGetBuyerSupplierRoleSuspenseQuery
>;
export type GetBuyerSupplierRoleQueryResult = Apollo.QueryResult<
  GetBuyerSupplierRoleQuery,
  GetBuyerSupplierRoleQueryVariables
>;

...
export type GetLocationTransportDownstreamQuery = {
 ...
 * });
 */
export function useGetLocationTransportDownstreamQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetLocationTransportDownstreamQuery,
    GetLocationTransportDownstreamQueryVariables
  > &
    (
      | {
          variables: GetLocationTransportDownstreamQueryVariables;
          skip?: boolean;
        }
      | { skip: boolean }
    )
  ...
  return Apollo.useQuery<
    GetLocationTransportDownstreamQuery,
    GetLocationTransportDownstreamQueryVariables
  >(GetLocationTransportDownstreamDocument, options);
}
export function useGetLocationTransportDownstreamLazyQuery(
...
// @ts-ignore
export function useGetLocationTransportDownstreamSuspenseQuery(
...
export function useGetLocationTransportDownstreamSuspenseQuery(
  ...
  GetLocationTransportDownstreamQuery | undefined,
  GetLocationTransportDownstreamQueryVariables
>;
export function useGetLocationTransportDownstreamSuspenseQuery(
  baseOptions?:
...
export type GetLocationTransportDownstreamQueryHookResult = ReturnType<
  typeof useGetLocationTransportDownstreamQuery
>;
export type GetLocationTransportDownstreamLazyQueryHookResult = ReturnType<
  typeof useGetLocationTransportDownstreamLazyQuery
>;
export type GetLocationTransportDownstreamSuspenseQueryHookResult = ReturnType<
  typeof useGetLocationTransportDownstreamSuspenseQuery
>;
export type GetLocationTransportDownstreamQueryResult = Apollo.QueryResult<
  GetLocationTransportDownstreamQuery,
  GetLocationTransportDownstreamQueryVariables
>;

...
export type GetFuelConsumptionGeneralByTaskRequestIdsQueryVariables =
  Types.Exact<{
    taskRequestIds:
...
export type GetFuelConsumptionGeneralByTaskRequestIdsQuery = {
 ...
 * });
 */
export function useGetFuelConsumptionGeneralByTaskRequestIdsQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetFuelConsumptionGeneralByTaskRequestIdsQuery,
    GetFuelConsumptionGeneralByTaskRequestIdsQueryVariables
  > &
    (
      | {
          variables: GetFuelConsumptionGeneralByTaskRequestIdsQueryVariables;
          skip?: boolean;
        }
      | { skip: boolean }
    )
  ...
  return Apollo.useQuery<
    GetFuelConsumptionGeneralByTaskRequestIdsQuery,
    GetFuelConsumptionGeneralByTaskRequestIdsQueryVariables
  >(GetFuelConsumptionGeneralByTaskRequestIdsDocument, options);
}
export function useGetFuelConsumptionGeneralByTaskRequestIdsLazyQuery(
...
// @ts-ignore
export function useGetFuelConsumptionGeneralByTaskRequestIdsSuspenseQuery(
...
export function useGetFuelConsumptionGeneralByTaskRequestIdsSuspenseQuery(
  ...
  GetFuelConsumptionGeneralByTaskRequestIdsQuery | undefined,
  GetFuelConsumptionGeneralByTaskRequestIdsQueryVariables
>;
export function useGetFuelConsumptionGeneralByTaskRequestIdsSuspenseQuery(
  baseOptions?:
...
export type GetFuelConsumptionGeneralByTaskRequestIdsQueryHookResult =
  ReturnType<typeof useGetFuelConsumptionGeneralByTaskRequestIdsQuery>;
export type GetFuelConsumptionGeneralByTaskRequestIdsLazyQueryHookResult =
  ReturnType<typeof useGetFuelConsumptionGeneralByTaskRequestIdsLazyQuery>;
export type GetFuelConsumptionGeneralByTaskRequestIdsSuspenseQueryHookResult =
  ReturnType<typeof useGetFuelConsumptionGeneralByTaskRequestIdsSuspenseQuery>;
export type GetFuelConsumptionGeneralByTaskRequestIdsQueryResult =
  Apollo.QueryResult<
    GetFuelConsumptionGeneralByTaskRequestIdsQuery,
    GetFuelConsumptionGeneralByTaskRequestIdsQueryVariables
  >;

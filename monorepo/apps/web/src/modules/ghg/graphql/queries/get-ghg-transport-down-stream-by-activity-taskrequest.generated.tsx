...
export type GetghgTransportDownStreamByActivityTaskRequestQueryVariables =
  Types.Exact<{
    task_request_id:
...
export const GetghgTransportDownStreamByActivityTaskRequestDocument = gql`
  query getghgTransportDownStreamByActivityTaskRequest(
...
export function useGetghgTransportDownStreamByActivityTaskRequestQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetghgTransportDownStreamByActivityTaskRequestQuery,
    GetghgTransportDownStreamByActivityTaskRequestQueryVariables
  > &
    (
      | {
          variables: GetghgTransportDownStreamByActivityTaskRequestQueryVariables;
          skip?: boolean;
        }
      | { skip: boolean }
    )
  ...
  return Apollo.useQuery<
    GetghgTransportDownStreamByActivityTaskRequestQuery,
    GetghgTransportDownStreamByActivityTaskRequestQueryVariables
  >(GetghgTransportDownStreamByActivityTaskRequestDocument, options);
}
export function useGetghgTransportDownStreamByActivityTaskRequestLazyQuery(
...
// @ts-ignore
export function useGetghgTransportDownStreamByActivityTaskRequestSuspenseQuery(
...
export function useGetghgTransportDownStreamByActivityTaskRequestSuspenseQuery(
  ...
  GetghgTransportDownStreamByActivityTaskRequestQuery | undefined,
  GetghgTransportDownStreamByActivityTaskRequestQueryVariables
>;
export function useGetghgTransportDownStreamByActivityTaskRequestSuspenseQuery(
  baseOptions?:
...
export type GetghgTransportDownStreamByActivityTaskRequestQueryHookResult =
  ReturnType<typeof useGetghgTransportDownStreamByActivityTaskRequestQuery>;
export type GetghgTransportDownStreamByActivityTaskRequestLazyQueryHookResult =
  ReturnType<typeof useGetghgTransportDownStreamByActivityTaskRequestLazyQuery>;
export type GetghgTransportDownStreamByActivityTaskRequestSuspenseQueryHookResult =
  ReturnType<
    typeof useGetghgTransportDownStreamByActivityTaskRequestSuspenseQuery
  >;
export type GetghgTransportDownStreamByActivityTaskRequestQueryResult =
  Apollo.QueryResult<
    GetghgTransportDownStreamByActivityTaskRequestQuery,
    GetghgTransportDownStreamByActivityTaskRequestQueryVariables
  >;

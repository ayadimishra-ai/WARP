...
export type GetKpiDataQuery = {
  ...
  kpiMain: Array<{
    ...
    kpi_em_Scope3_Cont_Upstream?: any | null;
    kpi_em_Scope3_Cont_Downstream?: any | null;
    timestamp: any;
  ...
  kpiEmissionByFuelConsumption: Array<{
    ...
    kpi_em_Coal_Consumption?: any | null;
    kpi_em_Petcoke_Consumption?: any | null;
    kpi_em_NaturalGas_Consumption?: any | null;
    kpi_em_Biomass_Consumption?: any | null;
    kpi_em_Bagasse_Consumption?: any | null;
    kpi_em_TotalEmission_FuelConsumption?: any | null;
    kpi_em_FuelConsumption_Scope1?: any | null;
    kpi_em_Kerosene_Consumption?: any | null;
  }>;
  kpiEmissionByTransportation: Array<{
    ...
    kpi_em_Modes_and_Fuel_Types?: any | null;
  }>;
  ...
  kpiEmissionByMaterialConsumptionSuppliers: Array<{
    ...
    kpi_em_MaterialProcurement_Scope3: any;
    kpi_em_TansportUpstreamEmission?: any | null;
  }>;
  kpiEmissionByPowerConsumptionVendors: Array<{
  ...
  productionDetail: Array<{
    ...
    OrganizationAddress: { __typename?: "OrganizationAddress"; id: any };
  }>;
};
 ...
 * });
 */
export function useGetKpiDataQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetKpiDataQuery,
    GetKpiDataQueryVariables
  > &
    (
      | { variables: GetKpiDataQueryVariables; skip?: boolean }
      | { skip: boolean }
    )
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetKpiDataQuery, GetKpiDataQueryVariables>(
    GetKpiDataDocument,
    options
  );
}
export function useGetKpiDataLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetKpiDataQuery, GetKpiDataQueryVariables>(
    GetKpiDataDocument,
    options
  );
}
// @ts-ignore
export function useGetKpiDataSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<
    GetKpiDataQuery,
    GetKpiDataQueryVariables
  >
): Apollo.UseSuspenseQueryResult<GetKpiDataQuery, GetKpiDataQueryVariables>;
export function useGetKpiDataSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<GetKpiDataQuery, GetKpiDataQueryVariables>
): Apollo.UseSuspenseQueryResult<
  GetKpiDataQuery | undefined,
  GetKpiDataQueryVariables
>;
export function useGetKpiDataSuspenseQuery(
  baseOptions?:
  ...
  return Apollo.useSuspenseQuery<GetKpiDataQuery, GetKpiDataQueryVariables>(
    GetKpiDataDocument,
    options
  );
}
export type GetKpiDataQueryHookResult = ReturnType<typeof useGetKpiDataQuery>;
export type GetKpiDataLazyQueryHookResult = ReturnType<
  typeof useGetKpiDataLazyQuery
>;
export type GetKpiDataSuspenseQueryHookResult = ReturnType<
  typeof useGetKpiDataSuspenseQuery
>;
export type GetKpiDataQueryResult = Apollo.QueryResult<
  GetKpiDataQuery,
  GetKpiDataQueryVariables
>;

...
export type GetTaskRequestV2Query = {
  ...
  TaskRequest: Array<{
    ...
    ActivityTaskRequests: Array<{
      ...
      activity_id: any;
      status?: string | null;
      Activity: { __typename?: "Activity"; code: string };
    }>;
    OrganizationAddress: {
 ...
 * });
 */
export function useGetTaskRequestV2Query(
  baseOptions: Apollo.QueryHookOptions<
    GetTaskRequestV2Query,
    GetTaskRequestV2QueryVariables
  > &
    (
      | { variables: GetTaskRequestV2QueryVariables; skip?: boolean }
      | { skip: boolean }
    )
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetTaskRequestV2Query, GetTaskRequestV2QueryVariables>(
    GetTaskRequestV2Document,
    options
  );
}
export function useGetTaskRequestV2LazyQuery(
  ...
  return Apollo.useLazyQuery<
    GetTaskRequestV2Query,
    GetTaskRequestV2QueryVariables
  >(GetTaskRequestV2Document, options);
}
// @ts-ignore
export function useGetTaskRequestV2SuspenseQuery(
...
export function useGetTaskRequestV2SuspenseQuery(
  ...
  GetTaskRequestV2Query | undefined,
  GetTaskRequestV2QueryVariables
>;
export function useGetTaskRequestV2SuspenseQuery(
  baseOptions?:
...
export type GetTaskRequestV2QueryHookResult = ReturnType<
  typeof useGetTaskRequestV2Query
>;
export type GetTaskRequestV2LazyQueryHookResult = ReturnType<
  typeof useGetTaskRequestV2LazyQuery
>;
export type GetTaskRequestV2SuspenseQueryHookResult = ReturnType<
  typeof useGetTaskRequestV2SuspenseQuery
>;
export type GetTaskRequestV2QueryResult = Apollo.QueryResult<
  GetTaskRequestV2Query,
  GetTaskRequestV2QueryVariables
>;

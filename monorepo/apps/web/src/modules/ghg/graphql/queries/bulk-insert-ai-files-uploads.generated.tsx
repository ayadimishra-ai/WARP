...
export type InsertAiFileUploadsMutationVariables = Types.Exact<{
  objects:
    | Array<Types.AiFileUploads_Insert_Input>
    | Types.AiFileUploads_Insert_Input;
}>;

export type InsertAiFileUploadsMutation = {
  __typename?: "mutation_root";
  insert_AIFileUploads?: {
...
`;
export type InsertAiFileUploadsMutationFn = Apollo.MutationFunction<
  InsertAiFileUploadsMutation,
  InsertAiFileUploadsMutationVariables
>;
 ...
 * });
 */
export function useInsertAiFileUploadsMutation(
  ...
  return Apollo.useMutation<
    InsertAiFileUploadsMutation,
    InsertAiFileUploadsMutationVariables
  >(InsertAiFileUploadsDocument, options);
}
export type InsertAiFileUploadsMutationHookResult = ReturnType<
  typeof useInsertAiFileUploadsMutation
>;
export type InsertAiFileUploadsMutationResult =
  Apollo.MutationResult<InsertAiFileUploadsMutation>;
export type InsertAiFileUploadsMutationOptions = Apollo.BaseMutationOptions<
  InsertAiFileUploadsMutation,
  InsertAiFileUploadsMutationVariables
>;

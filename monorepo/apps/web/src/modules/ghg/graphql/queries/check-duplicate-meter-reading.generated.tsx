...
export type CheckDuplicateMeterReadingQuery = {
 ...
 * });
 */
export function useCheckDuplicateMeterReadingQuery(
  baseOptions: Apollo.QueryHookOptions<
    CheckDuplicateMeterReadingQuery,
    CheckDuplicateMeterReadingQueryVariables
  > &
    (
      | { variables: CheckDuplicateMeterReadingQueryVariables; skip?: boolean }
      | { skip: boolean }
    )
) {
  ...
  return Apollo.useQuery<
    CheckDuplicateMeterReadingQuery,
    CheckDuplicateMeterReadingQueryVariables
  >(CheckDuplicateMeterReadingDocument, options);
}
export function useCheckDuplicateMeterReadingLazyQuery(
...
// @ts-ignore
export function useCheckDuplicateMeterReadingSuspenseQuery(
...
export function useCheckDuplicateMeterReadingSuspenseQuery(
  ...
  CheckDuplicateMeterReadingQuery | undefined,
  CheckDuplicateMeterReadingQueryVariables
>;
export function useCheckDuplicateMeterReadingSuspenseQuery(
  baseOptions?:
...
export type CheckDuplicateMeterReadingQueryHookResult = ReturnType<
  typeof useCheckDuplicateMeterReadingQuery
>;
export type CheckDuplicateMeterReadingLazyQueryHookResult = ReturnType<
  typeof useCheckDuplicateMeterReadingLazyQuery
>;
export type CheckDuplicateMeterReadingSuspenseQueryHookResult = ReturnType<
  typeof useCheckDuplicateMeterReadingSuspenseQuery
>;
export type CheckDuplicateMeterReadingQueryResult = Apollo.QueryResult<
  CheckDuplicateMeterReadingQuery,
  CheckDuplicateMeterReadingQueryVariables
>;

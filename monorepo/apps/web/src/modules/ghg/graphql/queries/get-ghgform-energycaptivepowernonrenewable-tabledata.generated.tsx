...
export type GetGhgEnergyCaptivePowerNonRenewableQuery = {
...
export const GetGhgEnergyCaptivePowerNonRenewableDocument = gql`
  query getGHGEnergyCaptivePowerNonRenewable(
    $activityFilter: GHGEnergy_CaptivePower_NonRenewable_bool_exp
    $start: Int
    $size: Int
    $orderBy: [GHGEnergy_CaptivePower_NonRenewable_order_by!]
  ) {
 ...
 * });
 */
export function useGetGhgEnergyCaptivePowerNonRenewableQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetGhgEnergyCaptivePowerNonRenewableQuery,
    GetGhgEnergyCaptivePowerNonRenewableQueryVariables
  >
) {
  ...
  return Apollo.useQuery<
    GetGhgEnergyCaptivePowerNonRenewableQuery,
    GetGhgEnergyCaptivePowerNonRenewableQueryVariables
  >(GetGhgEnergyCaptivePowerNonRenewableDocument, options);
}
export function useGetGhgEnergyCaptivePowerNonRenewableLazyQuery(
...
// @ts-ignore
export function useGetGhgEnergyCaptivePowerNonRenewableSuspenseQuery(
...
export function useGetGhgEnergyCaptivePowerNonRenewableSuspenseQuery(
  ...
  GetGhgEnergyCaptivePowerNonRenewableQuery | undefined,
  GetGhgEnergyCaptivePowerNonRenewableQueryVariables
>;
export function useGetGhgEnergyCaptivePowerNonRenewableSuspenseQuery(
  baseOptions?:
...
export type GetGhgEnergyCaptivePowerNonRenewableQueryHookResult = ReturnType<
  typeof useGetGhgEnergyCaptivePowerNonRenewableQuery
>;
export type GetGhgEnergyCaptivePowerNonRenewableLazyQueryHookResult =
  ReturnType<typeof useGetGhgEnergyCaptivePowerNonRenewableLazyQuery>;
export type GetGhgEnergyCaptivePowerNonRenewableSuspenseQueryHookResult =
  ReturnType<typeof useGetGhgEnergyCaptivePowerNonRenewableSuspenseQuery>;
export type GetGhgEnergyCaptivePowerNonRenewableQueryResult =
  Apollo.QueryResult<
    GetGhgEnergyCaptivePowerNonRenewableQuery,
    GetGhgEnergyCaptivePowerNonRenewableQueryVariables
  >;

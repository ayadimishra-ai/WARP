...
export type GetCaptivePowerNonRenewableFuelByIdQuery = {
  ...
  GHGEnergy_CaptivePower_NonRenewable: Array<{
    ...
    GHGEnergy_CaptivePower: {
      ...
      Do_You_Generate_Captive_Power_for_Own_Use?: string | null;
      TaskRequest: {
 ...
 * });
 */
export function useGetCaptivePowerNonRenewableFuelByIdQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetCaptivePowerNonRenewableFuelByIdQuery,
    GetCaptivePowerNonRenewableFuelByIdQueryVariables
  > &
    (
      | {
          variables: GetCaptivePowerNonRenewableFuelByIdQueryVariables;
          skip?: boolean;
        }
      | { skip: boolean }
    )
  ...
  return Apollo.useQuery<
    GetCaptivePowerNonRenewableFuelByIdQuery,
    GetCaptivePowerNonRenewableFuelByIdQueryVariables
  >(GetCaptivePowerNonRenewableFuelByIdDocument, options);
}
export function useGetCaptivePowerNonRenewableFuelByIdLazyQuery(
...
// @ts-ignore
export function useGetCaptivePowerNonRenewableFuelByIdSuspenseQuery(
...
export function useGetCaptivePowerNonRenewableFuelByIdSuspenseQuery(
  ...
  GetCaptivePowerNonRenewableFuelByIdQuery | undefined,
  GetCaptivePowerNonRenewableFuelByIdQueryVariables
>;
export function useGetCaptivePowerNonRenewableFuelByIdSuspenseQuery(
  baseOptions?:
...
export type GetCaptivePowerNonRenewableFuelByIdQueryHookResult = ReturnType<
  typeof useGetCaptivePowerNonRenewableFuelByIdQuery
>;
export type GetCaptivePowerNonRenewableFuelByIdLazyQueryHookResult = ReturnType<
  typeof useGetCaptivePowerNonRenewableFuelByIdLazyQuery
>;
export type GetCaptivePowerNonRenewableFuelByIdSuspenseQueryHookResult =
  ReturnType<typeof useGetCaptivePowerNonRenewableFuelByIdSuspenseQuery>;
export type GetCaptivePowerNonRenewableFuelByIdQueryResult = Apollo.QueryResult<
  GetCaptivePowerNonRenewableFuelByIdQuery,
  GetCaptivePowerNonRenewableFuelByIdQueryVariables
>;

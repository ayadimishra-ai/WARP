...
export type GetPowerConsumptionDetailsForAiQuery = {
...
export const GetPowerConsumptionDetailsForAiDocument = gql`
  query getPowerConsumptionDetailsForAI(
 ...
 * });
 */
export function useGetPowerConsumptionDetailsForAiQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetPowerConsumptionDetailsForAiQuery,
    GetPowerConsumptionDetailsForAiQueryVariables
  > &
    (
      | {
          variables: GetPowerConsumptionDetailsForAiQueryVariables;
          skip?: boolean;
        }
      | { skip: boolean }
    )
  ...
  return Apollo.useQuery<
    GetPowerConsumptionDetailsForAiQuery,
    GetPowerConsumptionDetailsForAiQueryVariables
  >(GetPowerConsumptionDetailsForAiDocument, options);
}
export function useGetPowerConsumptionDetailsForAiLazyQuery(
...
// @ts-ignore
export function useGetPowerConsumptionDetailsForAiSuspenseQuery(
...
export function useGetPowerConsumptionDetailsForAiSuspenseQuery(
  ...
  GetPowerConsumptionDetailsForAiQuery | undefined,
  GetPowerConsumptionDetailsForAiQueryVariables
>;
export function useGetPowerConsumptionDetailsForAiSuspenseQuery(
  baseOptions?:
...
export type GetPowerConsumptionDetailsForAiQueryHookResult = ReturnType<
  typeof useGetPowerConsumptionDetailsForAiQuery
>;
export type GetPowerConsumptionDetailsForAiLazyQueryHookResult = ReturnType<
  typeof useGetPowerConsumptionDetailsForAiLazyQuery
>;
export type GetPowerConsumptionDetailsForAiSuspenseQueryHookResult = ReturnType<
  typeof useGetPowerConsumptionDetailsForAiSuspenseQuery
>;
export type GetPowerConsumptionDetailsForAiQueryResult = Apollo.QueryResult<
  GetPowerConsumptionDetailsForAiQuery,
  GetPowerConsumptionDetailsForAiQueryVariables
>;

...
import { GhgTransport_EmployeeTravel_Insert_Input } from "@/modules/ghg/graphql/shared/types";
...
import { TTransportEmployeeTravelActivitySheetNames } from "@/modules/ghg/shared/constants/activity.constant";

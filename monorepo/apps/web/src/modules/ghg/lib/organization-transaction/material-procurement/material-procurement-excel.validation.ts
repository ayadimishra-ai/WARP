...
import { GetDistinctUoMsMaterialProcurementByMaterialCodesQuery } from "@/modules/ghg/graphql/shared/types";
import {
  ApiHitType,
...
import { validateCrossTemplateForBatch } from "@/modules/ghg/lib/cross-template-validation";
import {
  getUoMCategory,
    ...
    if (
      ...
      if (materialHasWeight) {
        ...
        const compatResult = validateUoMCategoryCompatibility(
          currentUoMCategory,
          masterUoMCategory,
          masterUoMCategory // Pass master category as reference for compatibility rules
        );

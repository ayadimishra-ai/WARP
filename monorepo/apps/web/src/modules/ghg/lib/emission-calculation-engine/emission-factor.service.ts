...
import { factorUOMNeedToConvertToTonne } from "@/modules/ghg/shared/constants/input.constant";
...
const EmissionFactorKeys = {
  ...
  power_purchased_through_captive_non_renewable:
    "power_purchased_through_captive_non_renewable",
  power_purchased_through_captive_non_renewable_fuel:    // ← ADD THIS
  "power_purchased_through_captive_non_renewable_fuel",
power_purchased_through_captive_renewable_fuel:        // ← ADD THIS

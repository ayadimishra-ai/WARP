...
import DocumentViewer from "@/modules/ghg/components/ai-modules/DocumentViewer";
import ExtractedDataTable from "@/modules/ghg/components/ai-modules/ExtractedDataTable";
import CheckedStarIcon from "@/modules/ghg/components/icons/CheckedStarIcon";
import { useGetFileForVerificationOrEditQuery } from "@/modules/ghg/graphql/queries/get-files-for-verify-or-edit.generated";
import { AiFileData } from "@/modules/ghg/graphql/shared/types";
import { AIFileUploadStatus } from "@/modules/ghg/shared/constants/ai-constant";
import { type AIFileDataRecord } from "@/modules/ghg/shared/types/ai-types";
import { handleDownload } from "@/modules/ghg/utils/common-functions";
import {
...
const VerifyExtractedData = () => {
  ...
  const fetchData = useCallback(
    async (verifiedFileId?: string) => {
      ...
      try {
        ...
        let verifiedFile: AIFileDataRecord | null = null;
        ...
        if (verifiedFile && !records.some((r) => r.id === verifiedFileId)) {
  ...
  useEffect(() => {
    if (allAIFileDataRecords && allAIFileDataRecords[currentBillIndex] && searchParams) {

...
import { saveGHGMaterialProcurement } from "@/modules/ghg/lib/auditlog/auditlog.service";
...
} from "@/modules/ghg/lib/organization-transaction/material-procurement/material-procurement-excel.service";
import {
    validateExcelTemplate,
    validateExcelTemplateData,
} from "@/modules/ghg/lib/organization-transaction/material-procurement/material-procurement-excel.validation";
import { calculatePCFEmission } from "@/modules/ghg/lib/pcf-emission/pcf-emission.service";
...
import { MaterialProcurementActivityConstant } from "@/modules/ghg/shared/constants/activity.constant";
...
async function postHandler(req: NextRequest, userSession: TUserSession) {
  ...
  if (!!saveResponse) {
    ...
    upsertCacheForActivity({
      ...
      organizationAddressId: input.organizationAddressId,
      activityCode: "material_procurement",

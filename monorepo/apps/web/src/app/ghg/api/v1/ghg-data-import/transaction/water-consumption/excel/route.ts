...
import { saveEmissionDashboard } from "@/modules/ghg/lib/emission-calculation-engine/emisison-calculation.service";
import {
    ExcelApiBodySchema,
    TExcelSheet,
...
import { insertWaterTemplateData } from "@/modules/ghg/lib/organization-transaction/water-consumption/water-consumption.service";
import {
    validateWaterExcelTemplate,
    validateWaterExcelTemplateData,
} from "@/modules/ghg/lib/organization-transaction/water-consumption/water-consumption.validation";
...
import { WaterConsumptionActivityConstant } from "@/modules/ghg/shared/constants/activity.constant";
...
async function postHandler(req: NextRequest, userSession: TUserSession) {
  ...
  if (!!saveresponse) {
    ...
    upsertCacheForActivity({
      ...
      organizationAddressId: input.organizationAddressId,
      activityCode: "water_consumption",

...
import { saveGridPoweDetailsSheetEntries } from "@/modules/ghg/lib/organization-transaction/energy/energy-grid-power.service";
import {
    validateExcelTemplate,
    validateExcelTemplateData,
} from "@/modules/ghg/lib/organization-transaction/energy/energy-grid-power.validation";

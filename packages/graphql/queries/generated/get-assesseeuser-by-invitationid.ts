 ...
 * });
 */
export function useGetassesseeuserbyinvitationIdQuery(baseOptions: Apollo.QueryHookOptions<Types.GetassesseeuserbyinvitationIdQuery, Types.GetassesseeuserbyinvitationIdQueryVariables>) {

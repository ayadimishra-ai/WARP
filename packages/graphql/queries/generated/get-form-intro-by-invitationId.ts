 ...
 * });
 */
export function useGetFormIntroByInvitationIdQuery(baseOptions: Apollo.QueryHookOptions<Types.GetFormIntroByInvitationIdQuery, Types.GetFormIntroByInvitationIdQueryVariables>) {

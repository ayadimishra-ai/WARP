 ...
 * });
 */
export function useGetQuestionnaireListQuery(baseOptions: Apollo.QueryHookOptions<Types.GetQuestionnaireListQuery, Types.GetQuestionnaireListQueryVariables>) {

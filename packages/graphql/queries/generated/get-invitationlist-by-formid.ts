 ...
 * });
 */
export function useGetInvitationListByFormIdQuery(baseOptions: Apollo.QueryHookOptions<Types.GetInvitationListByFormIdQuery, Types.GetInvitationListByFormIdQueryVariables>) {

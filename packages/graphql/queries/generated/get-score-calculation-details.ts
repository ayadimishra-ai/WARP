 ...
 * });
 */
export function useGetScoreCalculationDetailsQuery(baseOptions: Apollo.QueryHookOptions<Types.GetScoreCalculationDetailsQuery, Types.GetScoreCalculationDetailsQueryVariables>) {

 ...
 * });
 */
export function useGetCompanyDetailByparentcompanyidQuery(baseOptions: Apollo.QueryHookOptions<Types.GetCompanyDetailByparentcompanyidQuery, Types.GetCompanyDetailByparentcompanyidQueryVariables>) {

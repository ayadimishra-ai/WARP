 ...
 * });
 */
export function useGetFormInvitationbyStatusQuery(baseOptions: Apollo.QueryHookOptions<Types.GetFormInvitationbyStatusQuery, Types.GetFormInvitationbyStatusQueryVariables>) {

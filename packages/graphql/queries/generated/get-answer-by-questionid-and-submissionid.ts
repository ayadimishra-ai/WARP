 ...
 * });
 */
export function useGetAnswerByQuestionIdAndSubmissionIdQuery(baseOptions: Apollo.QueryHookOptions<Types.GetAnswerByQuestionIdAndSubmissionIdQuery, Types.GetAnswerByQuestionIdAndSubmissionIdQueryVariables>) {

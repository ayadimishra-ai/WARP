 ...
 * });
 */
export function useGetAiChatUsageBySubscriptionIdQuery(baseOptions: Apollo.QueryHookOptions<Types.GetAiChatUsageBySubscriptionIdQuery, Types.GetAiChatUsageBySubscriptionIdQueryVariables>) {

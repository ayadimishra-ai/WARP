 ...
 * });
 */
export function useGetQuestionnaireDetailsForDeletionQuery(baseOptions: Apollo.QueryHookOptions<Types.GetQuestionnaireDetailsForDeletionQuery, Types.GetQuestionnaireDetailsForDeletionQueryVariables>) {

 ...
 * });
 */
export function useGetinvitationSkipStatusQuery(baseOptions: Apollo.QueryHookOptions<Types.GetinvitationSkipStatusQuery, Types.GetinvitationSkipStatusQueryVariables>) {

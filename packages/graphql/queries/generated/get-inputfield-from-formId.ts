 ...
 * });
 */
export function useGetInputFieldFromFormIdQuery(baseOptions: Apollo.QueryHookOptions<Types.GetInputFieldFromFormIdQuery, Types.GetInputFieldFromFormIdQueryVariables>) {

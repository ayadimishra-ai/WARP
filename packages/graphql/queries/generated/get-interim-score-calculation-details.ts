 ...
 * });
 */
export function useGetInterimScoreCalculationDetailsQuery(baseOptions: Apollo.QueryHookOptions<Types.GetInterimScoreCalculationDetailsQuery, Types.GetInterimScoreCalculationDetailsQueryVariables>) {

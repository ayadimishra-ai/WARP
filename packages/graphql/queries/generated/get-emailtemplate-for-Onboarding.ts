 ...
 * });
 */
export function useGetEmailtemplateForOnboardingQuery(baseOptions: Apollo.QueryHookOptions<Types.GetEmailtemplateForOnboardingQuery, Types.GetEmailtemplateForOnboardingQueryVariables>) {

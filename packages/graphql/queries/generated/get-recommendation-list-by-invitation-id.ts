 ...
 * });
 */
export function useGetRecommendationListByInvitationIdQuery(baseOptions: Apollo.QueryHookOptions<Types.GetRecommendationListByInvitationIdQuery, Types.GetRecommendationListByInvitationIdQueryVariables>) {

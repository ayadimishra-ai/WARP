 ...
 * });
 */
export function useGetRenderFormDetailsQuery(baseOptions: Apollo.QueryHookOptions<Types.GetRenderFormDetailsQuery, Types.GetRenderFormDetailsQueryVariables>) {

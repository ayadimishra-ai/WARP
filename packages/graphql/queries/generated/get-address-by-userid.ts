 ...
 * });
 */
export function useGetaddressesbyuser_IdQuery(baseOptions: Apollo.QueryHookOptions<Types.Getaddressesbyuser_IdQuery, Types.Getaddressesbyuser_IdQueryVariables>) {

 ...
 * });
 */
export function useGetConversationMessagesQuery(baseOptions: Apollo.QueryHookOptions<Types.GetConversationMessagesQuery, Types.GetConversationMessagesQueryVariables>) {

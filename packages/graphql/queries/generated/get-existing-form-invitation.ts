 ...
 * });
 */
export function useGetExistingFormInvitationQuery(baseOptions: Apollo.QueryHookOptions<Types.GetExistingFormInvitationQuery, Types.GetExistingFormInvitationQueryVariables>) {

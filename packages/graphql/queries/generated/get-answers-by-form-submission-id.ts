 ...
 * });
 */
export function useGetAnswersByFormSubmissionIdQuery(baseOptions: Apollo.QueryHookOptions<Types.GetAnswersByFormSubmissionIdQuery, Types.GetAnswersByFormSubmissionIdQueryVariables>) {

 ...
 * });
 */
export function useGetformFieldsbyInvitationIdQuery(baseOptions: Apollo.QueryHookOptions<Types.GetformFieldsbyInvitationIdQuery, Types.GetformFieldsbyInvitationIdQueryVariables>) {

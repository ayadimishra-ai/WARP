 ...
 * });
 */
export function useGetInvitaionListByFormIdandDateQuery(baseOptions: Apollo.QueryHookOptions<Types.GetInvitaionListByFormIdandDateQuery, Types.GetInvitaionListByFormIdandDateQueryVariables>) {

 ...
 * });
 */
export function useGetAssessmentListForDownloadQuery(baseOptions: Apollo.QueryHookOptions<Types.GetAssessmentListForDownloadQuery, Types.GetAssessmentListForDownloadQueryVariables>) {

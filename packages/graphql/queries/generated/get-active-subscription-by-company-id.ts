 ...
 * });
 */
export function useGetActiveSubscriptionByCompanyIdQuery(baseOptions: Apollo.QueryHookOptions<Types.GetActiveSubscriptionByCompanyIdQuery, Types.GetActiveSubscriptionByCompanyIdQueryVariables>) {

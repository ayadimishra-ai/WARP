 ...
 * });
 */
export function useGetWarninginterimdataByFormIdQuery(baseOptions: Apollo.QueryHookOptions<Types.GetWarninginterimdataByFormIdQuery, Types.GetWarninginterimdataByFormIdQueryVariables>) {

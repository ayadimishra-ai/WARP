 ...
 * });
 */
export function useGetLastInvitationAnswerDetailsQuery(baseOptions: Apollo.QueryHookOptions<Types.GetLastInvitationAnswerDetailsQuery, Types.GetLastInvitationAnswerDetailsQueryVariables>) {

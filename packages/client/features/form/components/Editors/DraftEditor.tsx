...
const DraftEditor: React.FC<EditorProps> = ({
  ...
  // Disabled state hooks — always called unconditionally (React rules of hooks)
  const enableQuestionFieldResult = useEnableQuestionField(formField as any);
  const EnableQuestionField = formField ? enableQuestionFieldResult : true;
    ...
    <div style={{ width: "100%" }} data-formfieldid={formField?.id}>
      ...
      <div
        ...
        style={{
          ...
          backgroundColor: isDisabled ? "#E4E9EE" : "#fff",
          color: isDisabled ? "#9FA8B0" : "#666",

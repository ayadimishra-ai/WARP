...
import { IconChevronLeft, IconClock, IconSearch } from "@tabler/icons";
import { useAssessmentGlobalVariable } from "@warp/client/hooks/use-assessment-global-variable";
import { useRequestAssessment } from "@warp/client/hooks/use-request-assessment";
import { useGetFormWithDetailsQuery } from "@warp/graphql/queries/generated/get-form-with-details";
...
const AssesmentCardsList = ({
  ...
  return (
    <Stack>
      ...
      <Stack spacing={"sm"}>{assessmentCards}</Stack>

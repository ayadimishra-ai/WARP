...
import FilesIcon from "@warp/client/components/svgIcons/FilesIcon";
import { isUserAllowedAIFeature, postParentMessage } from "@warp/client/features/form/common-functions";
import {
  navigateToListingPage,
  startInvitationMessage
} from "@warp/client/services/platform-window-message.service";
import { useGetProcessingDataByInvitationIdQuery } from "@warp/graphql/queries/generated/get-processingData-by-invitationId";
import {
  FORM_TYPE_UI_LABELS,
...
const FileProcessing = () => {
  ...
  return hasTriggeredCurations ? (
    ...
    >
      ...
      <Text c="#122F47" fw={300} fz={30} align="center">
        {dynamicTexts.header}
      </Text>
      <Paper
        p={20}
      ...
      <Text c="#444444" fw={300} fz={24} align="center">

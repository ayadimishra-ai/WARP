...
import { useGetExistingFormInvitationByUserAndAddressIdLazyQuery } from "@warp/graphql/queries/generated/get-existing-form-invitation-user";
import { useGetFormInvitationByFormIdAndEmailIdLazyQuery } from "@warp/graphql/queries/generated/get-form-invitation-by-form-id-and-email-id";
...
import { useGetLastInvitationAnswerDetailsForCompanyByUserIdLazyQuery } from "@warp/graphql/queries/generated/get-last-invitation-answer-details-for-company-by-user-id";
import { useGetLastInvitationAnswerDetailsForUserByUserIdLazyQuery } from "@warp/graphql/queries/generated/get-last-invitation-answer-details-for-user-by-user-id";
import { useGetParentCompanyByUserAndAddressIdLazyQuery } from "@warp/graphql/queries/generated/get-parentcompany-by-user and address-id";
import { useGetParentCompanyMappingByAddressIdLazyQuery } from "@warp/graphql/queries/generated/get-user-email-by-ids";
...
} from "@warp/shared/validation/send-invitation-select-existing-user.schema";
...
const UpdateExistingUserFields = ({}) => {
  ...
  const {
    ...
    resolver: yupResolver(SendInvitationSelectExistingUserSchema),
    defaultValues,
    mode: "onSubmit",
  });
          ...
          if (isError === false) {
            ...
            if (
              ...
              if (
                ...
                await fetch("/api/carry-forward-assessment-data-userwise", {
                  method: "POST",

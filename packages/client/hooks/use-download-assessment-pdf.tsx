...
import { getNextauthUrl } from "@warp/configs/nextauth.config";
import { FormField, Question, Section } from "@warp/graphql/generated/types";
...
export const generatePdfDocument = async (
  ...
  const sectionSummaryTable = (
    <View style={styles.summaryTable}>
      ...
      <View style={styles.summaryTableChild}>
        <Image src="/images/assessment_illustration.png" />
      </View>
    </View>
  );
